...
class Pacific {
  ...
  Timezone get apia => const Timezone(
    'Pacific/Apia',
    ...
    [
      TimezoneOffset(FastOffset('+49:34:04', -41216), abbreviation: 'LMT', dst: false),
      TimezoneOffset(FastOffset('+49:30', -41400), abbreviation: '-1130', dst: false),
      TimezoneOffset(FastOffset('+49:00', -39600), abbreviation: '-11', dst: false),
      TimezoneOffset(FastOffset('+50:00', -36000), abbreviation: '-10', dst: true),
      TimezoneOffset(FastOffset('+49:00', -39600), abbreviation: '-11', dst: false),
      TimezoneOffset(FastOffset('+50:00', -36000), abbreviation: '-10', dst: true),
  ...
  Timezone get auckland => const Timezone(
    'Pacific/Auckland',
  ...
  Timezone get bougainville => const Timezone(
    'Pacific/Bougainville',
    [-2840178136, -2366790512, -868010400, -768906000, 1419696000], 
    [
      TimezoneOffset(FastOffset('+09:48:32', 35312), abbreviation: 'PMMT', dst: false),
  ...
  Timezone get chatham => const Timezone(
    'Pacific/Chatham',
  ...
  Timezone get chuuk => const Timezone(
    'Pacific/Chuuk',
  ...
  Timezone get easter => const Timezone(
    'Pacific/Easter',
    ...
    [
      TimezoneOffset(FastOffset('+53:43:32', -26248), abbreviation: 'EMT', dst: false),
      TimezoneOffset(FastOffset('+53:00', -25200), abbreviation: '-07', dst: false),
      TimezoneOffset(FastOffset('+54:00', -21600), abbreviation: '-06', dst: true),
      TimezoneOffset(FastOffset('+53:00', -25200), abbreviation: '-07', dst: false),
      TimezoneOffset(FastOffset('+54:00', -21600), abbreviation: '-06', dst: true),
      TimezoneOffset(FastOffset('+53:00', -25200), abbreviation: '-07', dst: false),
      TimezoneOffset(FastOffset('+54:00', -21600), abbreviation: '-06', dst: true),
      ...
      TimezoneOffset(FastOffset('+53:00', -25200), abbreviation: '-07', dst: false),
      TimezoneOffset(FastOffset('+54:00', -21600), abbreviation: '-06', dst: true),
      TimezoneOffset(FastOffset('+54:00', -21600), abbreviation: '-06', dst: false),
      TimezoneOffset(FastOffset('+55:00', -18000), abbreviation: '-05', dst: true),
      TimezoneOffset(FastOffset('+54:00', -21600), abbreviation: '-06', dst: false),
      TimezoneOffset(FastOffset('+55:00', -18000), abbreviation: '-05', dst: true),
      TimezoneOffset(FastOffset('+54:00', -21600), abbreviation: '-06', dst: false),
      TimezoneOffset(FastOffset('+55:00', -18000), abbreviation: '-05', dst: true),
  ...
  Timezone get efate => const Timezone(
    'Pacific/Efate',
  ...
  Timezone get enderbury => const Timezone(
    'Pacific/Enderbury',
  ...
  Timezone get fakaofo => const Timezone(
    'Pacific/Fakaofo',
  ...
  Timezone get fiji => const Timezone(
    'Pacific/Fiji',
  ...
  Timezone get funafuti => const Timezone(
    'Pacific/Funafuti',
    [-2177494324], 
    [
      TimezoneOffset(FastOffset('+12:00', 43200), abbreviation: '+12', dst: false),
  ...
  Timezone get galapagos => const Timezone(
    'Pacific/Galapagos',
    [-1230746496, 504939600, 722930400, 728888400], 
    [
      TimezoneOffset(FastOffset('+55:00', -18000), abbreviation: '-05', dst: false),
      TimezoneOffset(FastOffset('+54:00', -21600), abbreviation: '-06', dst: false),
      TimezoneOffset(FastOffset('+55:00', -18000), abbreviation: '-05', dst: true),
      TimezoneOffset(FastOffset('+54:00', -21600), abbreviation: '-06', dst: false),
    ],
  ...
  Timezone get gambier => const Timezone(
    'Pacific/Gambier',
    [-1806678012], 
    [
      TimezoneOffset(FastOffset('+51:00', -32400), abbreviation: '-09', dst: false),
    ],
  );

  /// The `Pacific/Guadalcanal` timezone.
  Timezone get guadalcanal => const Timezone(
    'Pacific/Guadalcanal',
    [-1806748788], 
    [
      TimezoneOffset(FastOffset('+11:00', 39600), abbreviation: '+11', dst: false),
  ...
  Timezone get guam => const Timezone(
    'Pacific/Guam',
    ...
    [
      TimezoneOffset(FastOffset('+09:39', 34740), abbreviation: 'LMT', dst: false),
      TimezoneOffset(FastOffset('+10:00', 36000), abbreviation: 'GST', dst: false),
      TimezoneOffset(FastOffset('+09:00', 32400), abbreviation: '+09', dst: false),
      TimezoneOffset(FastOffset('+10:00', 36000), abbreviation: 'GST', dst: false),
      TimezoneOffset(FastOffset('+11:00', 39600), abbreviation: 'GDT', dst: true),
      TimezoneOffset(FastOffset('+10:00', 36000), abbreviation: 'GST', dst: false),
      TimezoneOffset(FastOffset('+11:00', 39600), abbreviation: 'GDT', dst: true),
      TimezoneOffset(FastOffset('+10:00', 36000), abbreviation: 'GST', dst: false),
      TimezoneOffset(FastOffset('+11:00', 39600), abbreviation: 'GDT', dst: true),
      ...
      TimezoneOffset(FastOffset('+11:00', 39600), abbreviation: 'GDT', dst: true),
      TimezoneOffset(FastOffset('+10:00', 36000), abbreviation: 'GST', dst: false),
      TimezoneOffset(FastOffset('+10:00', 36000), abbreviation: 'ChST', dst: false),
    ],
  );

  /// The `Pacific/Honolulu` timezone.
  Timezone get honolulu => const Timezone(
    'Pacific/Honolulu',
    [-2334101314, -1157283000, -1155436200, -880198200, -769395600, -765376200, -712150200], 
    [
      TimezoneOffset(FastOffset('+50:30', -37800), abbreviation: 'HST', dst: false),
      TimezoneOffset(FastOffset('+51:30', -34200), abbreviation: 'HDT', dst: true),
      TimezoneOffset(FastOffset('+50:30', -37800), abbreviation: 'HST', dst: false),
      TimezoneOffset(FastOffset('+51:30', -34200), abbreviation: 'HWT', dst: true),
      TimezoneOffset(FastOffset('+51:30', -34200), abbreviation: 'HPT', dst: true),
      TimezoneOffset(FastOffset('+50:30', -37800), abbreviation: 'HST', dst: false),
      TimezoneOffset(FastOffset('+50:00', -36000), abbreviation: 'HST', dst: false),
    ],
  );

  /// The `Pacific/Johnston` timezone.
  Timezone get johnston => const Timezone(
    'Pacific/Johnston',
    [-2334101314, -1157283000, -1155436200, -880198200, -769395600, -765376200, -712150200], 
    [
      TimezoneOffset(FastOffset('+50:30', -37800), abbreviation: 'HST', dst: false),
  ...
  Timezone get kanton => const Timezone(
    'Pacific/Kanton',
    [-1020470400, 307627200, 788871600], 
    [
      TimezoneOffset(FastOffset('+48:00', -43200), abbreviation: '-12', dst: false),
  ...
  Timezone get kiritimati => const Timezone(
    'Pacific/Kiritimati',
    [-2177415040, 307622400, 788868000], 
    [
      TimezoneOffset(FastOffset('+50:20', -38400), abbreviation: '-1040', dst: false),
      TimezoneOffset(FastOffset('+50:00', -36000), abbreviation: '-10', dst: false),
      TimezoneOffset(FastOffset('+14:00', 50400), abbreviation: '+14', dst: false),
    ],
  );

  /// The `Pacific/Kosrae` timezone.
  Timezone get kosrae => const Timezone(
    'Pacific/Kosrae',
    [-3944631116, -2177491916, -1743678000, -1606813200, -1041418800, -907408800, -770634000, -7988400, 915105600], 
    [
      TimezoneOffset(FastOffset('+10:51:56', 39116), abbreviation: 'LMT', dst: false),
      TimezoneOffset(FastOffset('+11:00', 39600), abbreviation: '+11', dst: false),
      TimezoneOffset(FastOffset('+09:00', 32400), abbreviation: '+09', dst: false),
      TimezoneOffset(FastOffset('+11:00', 39600), abbreviation: '+11', dst: false),
      TimezoneOffset(FastOffset('+10:00', 36000), abbreviation: '+10', dst: false),
  ...
  Timezone get kwajalein => const Timezone(
    'Pacific/Kwajalein',
  ...
  Timezone get majuro => const Timezone(
    'Pacific/Majuro',
    [-2177494324], 
    [
      TimezoneOffset(FastOffset('+12:00', 43200), abbreviation: '+12', dst: false),
  ...
  Timezone get marquesas => const Timezone(
    'Pacific/Marquesas',
    [-1806676920], 
    [
      TimezoneOffset(FastOffset('+51:30', -34200), abbreviation: '-0930', dst: false),
    ],
  );

  /// The `Pacific/Midway` timezone.
  Timezone get midway => const Timezone(
    'Pacific/Midway',
    [-2445424632, -1861879032], 
    [
      TimezoneOffset(FastOffset('+49:38:12', -40968), abbreviation: 'LMT', dst: false),
      TimezoneOffset(FastOffset('+49:00', -39600), abbreviation: 'SST', dst: false),
    ],
  );

  /// The `Pacific/Nauru` timezone.
  Timezone get nauru => const Timezone(
    'Pacific/Nauru',
    [-1545131260, -862918200, -767350800, 287418600], 
    [
      TimezoneOffset(FastOffset('+11:30', 41400), abbreviation: '+1130', dst: false),
      TimezoneOffset(FastOffset('+09:00', 32400), abbreviation: '+09', dst: false),
      TimezoneOffset(FastOffset('+11:30', 41400), abbreviation: '+1130', dst: false),
      TimezoneOffset(FastOffset('+12:00', 43200), abbreviation: '+12', dst: false),
    ],
  ...
  Timezone get niue => const Timezone(
    'Pacific/Niue',
    [-543069620, -173623200], 
    [
      TimezoneOffset(FastOffset('+49:40', -40800), abbreviation: '-1120', dst: false),
      TimezoneOffset(FastOffset('+49:00', -39600), abbreviation: '-11', dst: false),
    ],
  );

  /// The `Pacific/Norfolk` timezone.
  Timezone get norfolk => const Timezone(
    'Pacific/Norfolk',
    ...
    [
      TimezoneOffset(FastOffset('+11:12', 40320), abbreviation: '+1112', dst: false),
      TimezoneOffset(FastOffset('+11:30', 41400), abbreviation: '+1130', dst: false),
      TimezoneOffset(FastOffset('+12:30', 45000), abbreviation: '+1230', dst: true),
      TimezoneOffset(FastOffset('+11:30', 41400), abbreviation: '+1130', dst: false),
      TimezoneOffset(FastOffset('+11:00', 39600), abbreviation: '+11', dst: false),
      TimezoneOffset(FastOffset('+11:00', 39600), abbreviation: '+11', dst: false),
      TimezoneOffset(FastOffset('+12:00', 43200), abbreviation: '+12', dst: true),
  ...
  Timezone get noumea => const Timezone(
    'Pacific/Noumea',
  ...
  Timezone get pagoPago => const Timezone(
    'Pacific/Pago_Pago',
    [-2445424632, -1861879032], 
    [
      TimezoneOffset(FastOffset('+49:38:12', -40968), abbreviation: 'LMT', dst: false),
  ...
  Timezone get palau => const Timezone(
    'Pacific/Palau',
    [-3944624276, -2177485076], 
    [
      TimezoneOffset(FastOffset('+08:57:56', 32276), abbreviation: 'LMT', dst: false),
      TimezoneOffset(FastOffset('+09:00', 32400), abbreviation: '+09', dst: false),
    ],
  );

  /// The `Pacific/Pitcairn` timezone.
  Timezone get pitcairn => const Timezone(
    'Pacific/Pitcairn',
    [-2177421580, 893665800], 
    [
      TimezoneOffset(FastOffset('+52:30', -30600), abbreviation: '-0830', dst: false),
      TimezoneOffset(FastOffset('+52:00', -28800), abbreviation: '-08', dst: false),
    ],
  );

  /// The `Pacific/Pohnpei` timezone.
  Timezone get pohnpei => const Timezone(
    'Pacific/Pohnpei',
    [-1806748788], 
    [
      TimezoneOffset(FastOffset('+11:00', 39600), abbreviation: '+11', dst: false),
  ...
  Timezone get ponape => const Timezone(
    'Pacific/Ponape',
    [-1806748788], 
    [
      TimezoneOffset(FastOffset('+11:00', 39600), abbreviation: '+11', dst: false),
  ...
  Timezone get portMoresby => const Timezone(
  ...
  Timezone get rarotonga => const Timezone(
    'Pacific/Rarotonga',
    ...
    [
      TimezoneOffset(FastOffset('+50:21:56', -38344), abbreviation: 'LMT', dst: false),
      TimezoneOffset(FastOffset('+50:30', -37800), abbreviation: '-1030', dst: false),
      TimezoneOffset(FastOffset('+51:30', -34200), abbreviation: '-0930', dst: true),
      TimezoneOffset(FastOffset('+50:00', -36000), abbreviation: '-10', dst: false),
      TimezoneOffset(FastOffset('+51:30', -34200), abbreviation: '-0930', dst: true),
      TimezoneOffset(FastOffset('+50:00', -36000), abbreviation: '-10', dst: false),
      TimezoneOffset(FastOffset('+51:30', -34200), abbreviation: '-0930', dst: true),
  ...
  Timezone get saipan => const Timezone(
    'Pacific/Saipan',
    [-3944626740, -2177487540, -885549600, -802256400, -331891200, -281610000, -73728000, -29415540, -16704000, -10659600, 9907200, 21394800, 41356800, 52844400, 124819200, 130863600, 201888000, 209487660, 230659200, 241542000, 977493600], 
    [
      TimezoneOffset(FastOffset('+09:39', 34740), abbreviation: 'LMT', dst: false),
  ...
  Timezone get samoa => const Timezone(
    'Pacific/Samoa',
    [-2445424632, -1861879032], 
    [
      TimezoneOffset(FastOffset('+49:38:12', -40968), abbreviation: 'LMT', dst: false),
  ...
  Timezone get tahiti => const Timezone(
    'Pacific/Tahiti',
    [-1806674504], 
    [
      TimezoneOffset(FastOffset('+50:00', -36000), abbreviation: '-10', dst: false),
  ...
  Timezone get tarawa => const Timezone(
    'Pacific/Tarawa',
    [-2177494324], 
    [
      TimezoneOffset(FastOffset('+12:00', 43200), abbreviation: '+12', dst: false),
  ...
  Timezone get truk => const Timezone(
    'Pacific/Truk',
    [-2840176120, -2366790512], 
    [
      TimezoneOffset(FastOffset('+09:48:32', 35312), abbreviation: 'PMMT', dst: false),
  ...
  Timezone get wake => const Timezone(
    'Pacific/Wake',
    [-2177494324], 
    [
      TimezoneOffset(FastOffset('+12:00', 43200), abbreviation: '+12', dst: false),
  ...
  Timezone get wallis => const Timezone(
    'Pacific/Wallis',
    [-2177494324], 
    [
      TimezoneOffset(FastOffset('+12:00', 43200), abbreviation: '+12', dst: false),
  ...
  Timezone get yap => const Timezone(
    'Pacific/Yap',
    [-2840176120, -2366790512], 
    [
      TimezoneOffset(FastOffset('+09:48:32', 35312), abbreviation: 'PMMT', dst: false),
