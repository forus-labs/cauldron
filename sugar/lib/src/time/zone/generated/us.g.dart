...
class Us {
  ...
  /// The `US/Alaska` location.
  Location get alaska => Location(
    'US/Alaska',
    ...
    const [
      Timezone(FastOffset('-09:59:36', -35976), abbreviation: 'LMT', dst: false),
      Timezone(FastOffset('-10:00', -36000), abbreviation: 'AST', dst: false),
      Timezone(FastOffset('-09:00', -32400), abbreviation: 'AWT', dst: true),
      Timezone(FastOffset('-09:00', -32400), abbreviation: 'APT', dst: true),
      Timezone(FastOffset('-10:00', -36000), abbreviation: 'AST', dst: false),
      Timezone(FastOffset('-10:00', -36000), abbreviation: 'AHST', dst: false),
      Timezone(FastOffset('-09:00', -32400), abbreviation: 'AHDT', dst: true),
      Timezone(FastOffset('-10:00', -36000), abbreviation: 'AHST', dst: false),
      Timezone(FastOffset('-09:00', -32400), abbreviation: 'AHDT', dst: true),
      Timezone(FastOffset('-10:00', -36000), abbreviation: 'AHST', dst: false),
      Timezone(FastOffset('-09:00', -32400), abbreviation: 'AHDT', dst: true),
      ...
      Timezone(FastOffset('-10:00', -36000), abbreviation: 'AHST', dst: false),
      Timezone(FastOffset('-09:00', -32400), abbreviation: 'AHDT', dst: true),
      Timezone(FastOffset('-09:00', -32400), abbreviation: 'YST', dst: false),
      Timezone(FastOffset('-09:00', -32400), abbreviation: 'AKST', dst: false),
      Timezone(FastOffset('-08:00', -28800), abbreviation: 'AKDT', dst: true),
      Timezone(FastOffset('-09:00', -32400), abbreviation: 'AKST', dst: false),
      Timezone(FastOffset('-08:00', -28800), abbreviation: 'AKDT', dst: true),
      Timezone(FastOffset('-09:00', -32400), abbreviation: 'AKST', dst: false),
      Timezone(FastOffset('-08:00', -28800), abbreviation: 'AKDT', dst: true),
  ...
  /// The `US/Aleutian` location.
  Location get aleutian => Location(
    'US/Aleutian',
    ...
    const [
      Timezone(FastOffset('-11:46:38', -42398), abbreviation: 'LMT', dst: false),
      Timezone(FastOffset('-11:00', -39600), abbreviation: 'NST', dst: false),
      Timezone(FastOffset('-10:00', -36000), abbreviation: 'NWT', dst: true),
      Timezone(FastOffset('-10:00', -36000), abbreviation: 'NPT', dst: true),
      Timezone(FastOffset('-11:00', -39600), abbreviation: 'NST', dst: false),
      Timezone(FastOffset('-11:00', -39600), abbreviation: 'BST', dst: false),
      Timezone(FastOffset('-10:00', -36000), abbreviation: 'BDT', dst: true),
      Timezone(FastOffset('-11:00', -39600), abbreviation: 'BST', dst: false),
      Timezone(FastOffset('-10:00', -36000), abbreviation: 'BDT', dst: true),
      Timezone(FastOffset('-11:00', -39600), abbreviation: 'BST', dst: false),
      Timezone(FastOffset('-10:00', -36000), abbreviation: 'BDT', dst: true),
      ...
      Timezone(FastOffset('-09:00', -32400), abbreviation: 'HDT', dst: true),
      Timezone(FastOffset('-10:00', -36000), abbreviation: 'HST', dst: false),
      Timezone(FastOffset('-09:00', -32400), abbreviation: 'HDT', dst: true),
      Timezone(FastOffset('-10:00', -36000), abbreviation: 'HST', dst: false),
      Timezone(FastOffset('-09:00', -32400), abbreviation: 'HDT', dst: true),
  ...
  /// The `US/Arizona` location.
  Location get arizona => Location(
    'US/Arizona',
  ...
  /// The `US/Central` location.
  Location get central => Location(
    'US/Central',
  ...
  /// The `US/East-Indiana` location.
  Location get eastIndiana => Location(
    'US/East-Indiana',
  ...
  /// The `US/Eastern` location.
  Location get eastern => Location(
    'US/Eastern',
  ...
  /// The `US/Hawaii` location.
  Location get hawaii => Location(
    'US/Hawaii',
  ...
  /// The `US/Indiana-Starke` location.
  Location get indianaStarke => Location(
    'US/Indiana-Starke',
  ...
  /// The `US/Michigan` location.
  Location get michigan => Location(
    'US/Michigan',
  ...
  /// The `US/Mountain` location.
  Location get mountain => Location(
    'US/Mountain',
  ...
  /// The `US/Pacific` location.
  Location get pacific => Location(
    'US/Pacific',
