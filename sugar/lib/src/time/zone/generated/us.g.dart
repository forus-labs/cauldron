...
class Us {
  ...
  Timezone get alaska => const Timezone(
    'US/Alaska',
    ...
    [
      TimezoneOffset(FastOffset('+51:01:24', -35976), abbreviation: 'LMT', dst: false),
      TimezoneOffset(FastOffset('+50:00', -36000), abbreviation: 'AST', dst: false),
      TimezoneOffset(FastOffset('+51:00', -32400), abbreviation: 'AWT', dst: true),
      TimezoneOffset(FastOffset('+51:00', -32400), abbreviation: 'APT', dst: true),
      TimezoneOffset(FastOffset('+50:00', -36000), abbreviation: 'AST', dst: false),
      TimezoneOffset(FastOffset('+50:00', -36000), abbreviation: 'AHST', dst: false),
      TimezoneOffset(FastOffset('+51:00', -32400), abbreviation: 'AHDT', dst: true),
      TimezoneOffset(FastOffset('+50:00', -36000), abbreviation: 'AHST', dst: false),
      TimezoneOffset(FastOffset('+51:00', -32400), abbreviation: 'AHDT', dst: true),
      TimezoneOffset(FastOffset('+50:00', -36000), abbreviation: 'AHST', dst: false),
      TimezoneOffset(FastOffset('+51:00', -32400), abbreviation: 'AHDT', dst: true),
      ...
      TimezoneOffset(FastOffset('+50:00', -36000), abbreviation: 'AHST', dst: false),
      TimezoneOffset(FastOffset('+51:00', -32400), abbreviation: 'AHDT', dst: true),
      TimezoneOffset(FastOffset('+51:00', -32400), abbreviation: 'YST', dst: false),
      TimezoneOffset(FastOffset('+51:00', -32400), abbreviation: 'AKST', dst: false),
      TimezoneOffset(FastOffset('+52:00', -28800), abbreviation: 'AKDT', dst: true),
      TimezoneOffset(FastOffset('+51:00', -32400), abbreviation: 'AKST', dst: false),
      TimezoneOffset(FastOffset('+52:00', -28800), abbreviation: 'AKDT', dst: true),
      TimezoneOffset(FastOffset('+51:00', -32400), abbreviation: 'AKST', dst: false),
      TimezoneOffset(FastOffset('+52:00', -28800), abbreviation: 'AKDT', dst: true),
  ...
  Timezone get aleutian => const Timezone(
    'US/Aleutian',
    ...
    [
      TimezoneOffset(FastOffset('+49:14:22', -42398), abbreviation: 'LMT', dst: false),
      TimezoneOffset(FastOffset('+49:00', -39600), abbreviation: 'NST', dst: false),
      TimezoneOffset(FastOffset('+50:00', -36000), abbreviation: 'NWT', dst: true),
      TimezoneOffset(FastOffset('+50:00', -36000), abbreviation: 'NPT', dst: true),
      TimezoneOffset(FastOffset('+49:00', -39600), abbreviation: 'NST', dst: false),
      TimezoneOffset(FastOffset('+49:00', -39600), abbreviation: 'BST', dst: false),
      TimezoneOffset(FastOffset('+50:00', -36000), abbreviation: 'BDT', dst: true),
      TimezoneOffset(FastOffset('+49:00', -39600), abbreviation: 'BST', dst: false),
      TimezoneOffset(FastOffset('+50:00', -36000), abbreviation: 'BDT', dst: true),
      TimezoneOffset(FastOffset('+49:00', -39600), abbreviation: 'BST', dst: false),
      TimezoneOffset(FastOffset('+50:00', -36000), abbreviation: 'BDT', dst: true),
      ...
      TimezoneOffset(FastOffset('+51:00', -32400), abbreviation: 'HDT', dst: true),
      TimezoneOffset(FastOffset('+50:00', -36000), abbreviation: 'HST', dst: false),
      TimezoneOffset(FastOffset('+51:00', -32400), abbreviation: 'HDT', dst: true),
      TimezoneOffset(FastOffset('+50:00', -36000), abbreviation: 'HST', dst: false),
      TimezoneOffset(FastOffset('+51:00', -32400), abbreviation: 'HDT', dst: true),
  ...
  Timezone get arizona => const Timezone(
    'US/Arizona',
  ...
  Timezone get central => const Timezone(
    'US/Central',
  ...
  Timezone get eastIndiana => const Timezone(
    'US/East-Indiana',
  ...
  Timezone get eastern => const Timezone(
    'US/Eastern',
  ...
  Timezone get hawaii => const Timezone(
    'US/Hawaii',
  ...
  Timezone get indianaStarke => const Timezone(
    'US/Indiana-Starke',
  ...
  Timezone get michigan => const Timezone(
    'US/Michigan',
  ...
  Timezone get mountain => const Timezone(
    'US/Mountain',
  ...
  Timezone get pacific => const Timezone(
    'US/Pacific',
