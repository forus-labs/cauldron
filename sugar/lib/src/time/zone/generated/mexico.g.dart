...
class Mexico {
  ...
  /// The `Mexico/BajaNorte` location.
  Location get bajaNorte => Location(
    'Mexico/BajaNorte',
  ...
  /// The `Mexico/BajaSur` location.
  Location get bajaSur => Location(
    'Mexico/BajaSur',
  ...
  /// The `Mexico/General` location.
  Location get general => Location(
    'Mexico/General',
