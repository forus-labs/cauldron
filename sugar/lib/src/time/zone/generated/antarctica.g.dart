...
class Antarctica {
  ...
  /// The `Antarctica/Casey` location.
  Location get casey => Location(
    'Antarctica/Casey',
  ...
  /// The `Antarctica/Davis` location.
  Location get davis => Location(
    'Antarctica/Davis',
  ...
  /// The `Antarctica/DumontDUrville` location.
  Location get dumontDUrville => Location(
  ...
  /// The `Antarctica/Macquarie` location.
  Location get macquarie => Location(
  ...
  /// The `Antarctica/Mawson` location.
  Location get mawson => Location(
    'Antarctica/Mawson',
  ...
  /// The `Antarctica/McMurdo` location.
  Location get mcMurdo => Location(
    'Antarctica/McMurdo',
  ...
  /// The `Antarctica/Palmer` location.
  Location get palmer => Location(
    'Antarctica/Palmer',
  ...
  /// The `Antarctica/Rothera` location.
  Location get rothera => Location(
    'Antarctica/Rothera',
    [218246400], 
    const [
      Timezone(FastOffset('-03:00', -10800), abbreviation: '-03', dst: false),
  ...
  /// The `Antarctica/South_Pole` location.
  Location get southPole => Location(
  ...
  /// The `Antarctica/Syowa` location.
  Location get syowa => Location(
    'Antarctica/Syowa',
    [-719636812], 
    const [
      Timezone(FastOffset('+03:00', 10800), abbreviation: '+03', dst: false),
  ...
  /// The `Antarctica/Troll` location.
  Location get troll => Location(
    'Antarctica/Troll',
  ...
  /// The `Antarctica/Vostok` location.
  Location get vostok => Location(
    'Antarctica/Vostok',
    [-1325483420], 
    const [
      Timezone(FastOffset('+06:00', 21600), abbreviation: '+06', dst: false),
