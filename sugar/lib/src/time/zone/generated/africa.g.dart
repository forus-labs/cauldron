...
class Africa {
  ...
  /// The `Africa/Abidjan` location.
  Location get abidjan => Location(
    'Africa/Abidjan',
    [-1830383032], 
    const [
  ...
  /// The `Africa/Accra` location.
  Location get accra => Location(
    'Africa/Accra',
    [-1830383032], 
    const [
      Timezone(FastOffset('Z', 0), abbreviation: 'GMT', dst: false),
  ...
  /// The `Africa/Addis_Ababa` location.
  Location get addisAbaba => Location(
    'Africa/Addis_Ababa',
  ...
  /// The `Africa/Algiers` location.
  Location get algiers => Location(
    'Africa/Algiers',
  ...
  /// The `Africa/Asmara` location.
  Location get asmara => Location(
    'Africa/Asmara',
    [-1946168836, -1309746600, -1261969200, -1041388200, -865305900], 
    const [
      Timezone(FastOffset('+02:30', 9000), abbreviation: '+0230', dst: false),
  ...
  /// The `Africa/Asmera` location.
  Location get asmera => Location(
    'Africa/Asmera',
    [-1946168836, -1309746600, -1261969200, -1041388200, -865305900], 
    const [
      Timezone(FastOffset('+02:30', 9000), abbreviation: '+0230', dst: false),
  ...
  /// The `Africa/Bamako` location.
  Location get bamako => Location(
    'Africa/Bamako',
    [-1830383032], 
    const [
      Timezone(FastOffset('Z', 0), abbreviation: 'GMT', dst: false),
  ...
  /// The `Africa/Bangui` location.
  Location get bangui => Location(
    'Africa/Bangui',
    [-2035584815, -1940889600, -1767226415, -1588465800], 
    const [
      Timezone(FastOffset('Z', 0), abbreviation: 'GMT', dst: false),
      Timezone(FastOffset('+00:13:35', 815), abbreviation: 'LMT', dst: false),
      Timezone(FastOffset('+00:30', 1800), abbreviation: '+0030', dst: false),
      Timezone(FastOffset('+01:00', 3600), abbreviation: 'WAT', dst: false),
    ],
  );

  /// The `Africa/Banjul` location.
  Location get banjul => Location(
    'Africa/Banjul',
    [-1830383032], 
    const [
      Timezone(FastOffset('Z', 0), abbreviation: 'GMT', dst: false),
  ...
  /// The `Africa/Bissau` location.
  Location get bissau => Location(
    'Africa/Bissau',
    [-1830380400, 157770000], 
    const [
      Timezone(FastOffset('-01:00', -3600), abbreviation: '-01', dst: false),
      Timezone(FastOffset('Z', 0), abbreviation: 'GMT', dst: false),
    ],
  );

  /// The `Africa/Blantyre` location.
  Location get blantyre => Location(
    'Africa/Blantyre',
    [-2109291020], 
    const [
      Timezone(FastOffset('+02:00', 7200), abbreviation: 'CAT', dst: false),
    ],
  );

  /// The `Africa/Brazzaville` location.
  Location get brazzaville => Location(
    'Africa/Brazzaville',
    [-2035584815, -1940889600, -1767226415, -1588465800], 
    const [
      Timezone(FastOffset('Z', 0), abbreviation: 'GMT', dst: false),
  ...
  /// The `Africa/Bujumbura` location.
  Location get bujumbura => Location(
    'Africa/Bujumbura',
    [-2109291020], 
    const [
      Timezone(FastOffset('+02:00', 7200), abbreviation: 'CAT', dst: false),
  ...
  /// The `Africa/Cairo` location.
  Location get cairo => Location(
    'Africa/Cairo',
  ...
  /// The `Africa/Casablanca` location.
  Location get casablanca => Location(
    'Africa/Casablanca',
    ...
    const [
      Timezone(FastOffset('Z', 0), abbreviation: '+00', dst: false),
      ...
      Timezone(FastOffset('+01:00', 3600), abbreviation: '+01', dst: true),
      Timezone(FastOffset('+01:00', 3600), abbreviation: '+01', dst: false),
      Timezone(FastOffset('Z', 0), abbreviation: '+00', dst: true),
      Timezone(FastOffset('+01:00', 3600), abbreviation: '+01', dst: false),
      Timezone(FastOffset('Z', 0), abbreviation: '+00', dst: true),
      Timezone(FastOffset('+01:00', 3600), abbreviation: '+01', dst: false),
      Timezone(FastOffset('Z', 0), abbreviation: '+00', dst: true),
  ...
  /// The `Africa/Ceuta` location.
  Location get ceuta => Location(
    'Africa/Ceuta',
  ...
  /// The `Africa/Conakry` location.
  Location get conakry => Location(
    'Africa/Conakry',
    [-1830383032], 
    const [
      Timezone(FastOffset('Z', 0), abbreviation: 'GMT', dst: false),
  ...
  /// The `Africa/Dakar` location.
  Location get dakar => Location(
    'Africa/Dakar',
    [-1830383032], 
    const [
      Timezone(FastOffset('Z', 0), abbreviation: 'GMT', dst: false),
  ...
  /// The `Africa/Dar_es_Salaam` location.
  Location get darEsSalaam => Location(
  ...
  /// The `Africa/Djibouti` location.
  Location get djibouti => Location(
    'Africa/Djibouti',
    [-1946168836, -1309746600, -1261969200, -1041388200, -865305900], 
    const [
      Timezone(FastOffset('+02:30', 9000), abbreviation: '+0230', dst: false),
  ...
  /// The `Africa/Douala` location.
  Location get douala => Location(
    'Africa/Douala',
    [-2035584815, -1940889600, -1767226415, -1588465800], 
    const [
      Timezone(FastOffset('Z', 0), abbreviation: 'GMT', dst: false),
  ...
  /// The `Africa/El_Aaiun` location.
  Location get elAaiun => Location(
    'Africa/El_Aaiun',
  ...
  /// The `Africa/Freetown` location.
  Location get freetown => Location(
    'Africa/Freetown',
    [-1830383032], 
    const [
      Timezone(FastOffset('Z', 0), abbreviation: 'GMT', dst: false),
  ...
  /// The `Africa/Gaborone` location.
  Location get gaborone => Location(
    'Africa/Gaborone',
    [-2109291020], 
    const [
      Timezone(FastOffset('+02:00', 7200), abbreviation: 'CAT', dst: false),
  ...
  /// The `Africa/Harare` location.
  Location get harare => Location(
    'Africa/Harare',
    [-2109291020], 
    const [
      Timezone(FastOffset('+02:00', 7200), abbreviation: 'CAT', dst: false),
  ...
  /// The `Africa/Johannesburg` location.
  Location get johannesburg => Location(
    'Africa/Johannesburg',
    [-2458173120, -2109288600, -860976000, -845254800, -829526400, -813805200], 
    const [
      Timezone(FastOffset('+01:30', 5400), abbreviation: 'SAST', dst: false),
      Timezone(FastOffset('+02:00', 7200), abbreviation: 'SAST', dst: false),
      Timezone(FastOffset('+03:00', 10800), abbreviation: 'SAST', dst: true),
      Timezone(FastOffset('+02:00', 7200), abbreviation: 'SAST', dst: false),
      Timezone(FastOffset('+03:00', 10800), abbreviation: 'SAST', dst: true),
      Timezone(FastOffset('+02:00', 7200), abbreviation: 'SAST', dst: false),
    ],
  ...
  /// The `Africa/Juba` location.
  Location get juba => Location(
    'Africa/Juba',
    ...
    const [
      Timezone(FastOffset('+02:00', 7200), abbreviation: 'CAT', dst: false),
      Timezone(FastOffset('+03:00', 10800), abbreviation: 'CAST', dst: true),
      Timezone(FastOffset('+02:00', 7200), abbreviation: 'CAT', dst: false),
      Timezone(FastOffset('+03:00', 10800), abbreviation: 'CAST', dst: true),
      Timezone(FastOffset('+02:00', 7200), abbreviation: 'CAT', dst: false),
      Timezone(FastOffset('+03:00', 10800), abbreviation: 'CAST', dst: true),
  ...
  /// The `Africa/Kampala` location.
  Location get kampala => Location(
    'Africa/Kampala',
    [-1946168836, -1309746600, -1261969200, -1041388200, -865305900], 
    const [
      Timezone(FastOffset('+02:30', 9000), abbreviation: '+0230', dst: false),
  ...
  /// The `Africa/Khartoum` location.
  Location get khartoum => Location(
    'Africa/Khartoum',
  ...
  /// The `Africa/Kigali` location.
  Location get kigali => Location(
    'Africa/Kigali',
    [-2109291020], 
    const [
      Timezone(FastOffset('+02:00', 7200), abbreviation: 'CAT', dst: false),
  ...
  /// The `Africa/Kinshasa` location.
  Location get kinshasa => Location(
    'Africa/Kinshasa',
    [-2035584815, -1940889600, -1767226415, -1588465800], 
    const [
      Timezone(FastOffset('Z', 0), abbreviation: 'GMT', dst: false),
  ...
  /// The `Africa/Lagos` location.
  Location get lagos => Location(
    'Africa/Lagos',
    [-2035584815, -1940889600, -1767226415, -1588465800], 
    const [
      Timezone(FastOffset('Z', 0), abbreviation: 'GMT', dst: false),
  ...
  /// The `Africa/Libreville` location.
  Location get libreville => Location(
    'Africa/Libreville',
    [-2035584815, -1940889600, -1767226415, -1588465800], 
    const [
      Timezone(FastOffset('Z', 0), abbreviation: 'GMT', dst: false),
  ...
  /// The `Africa/Lome` location.
  Location get lome => Location(
    'Africa/Lome',
    [-1830383032], 
    const [
      Timezone(FastOffset('Z', 0), abbreviation: 'GMT', dst: false),
  ...
  /// The `Africa/Luanda` location.
  Location get luanda => Location(
    'Africa/Luanda',
    [-2035584815, -1940889600, -1767226415, -1588465800], 
    const [
      Timezone(FastOffset('Z', 0), abbreviation: 'GMT', dst: false),
  ...
  /// The `Africa/Lubumbashi` location.
  Location get lubumbashi => Location(
    'Africa/Lubumbashi',
    [-2109291020], 
    const [
      Timezone(FastOffset('+02:00', 7200), abbreviation: 'CAT', dst: false),
  ...
  /// The `Africa/Lusaka` location.
  Location get lusaka => Location(
    'Africa/Lusaka',
    [-2109291020], 
    const [
      Timezone(FastOffset('+02:00', 7200), abbreviation: 'CAT', dst: false),
  ...
  /// The `Africa/Malabo` location.
  Location get malabo => Location(
    'Africa/Malabo',
    [-2035584815, -1940889600, -1767226415, -1588465800], 
    const [
      Timezone(FastOffset('Z', 0), abbreviation: 'GMT', dst: false),
  ...
  /// The `Africa/Maputo` location.
  Location get maputo => Location(
    'Africa/Maputo',
    [-2109291020], 
    const [
      Timezone(FastOffset('+02:00', 7200), abbreviation: 'CAT', dst: false),
  ...
  /// The `Africa/Maseru` location.
  Location get maseru => Location(
    'Africa/Maseru',
    [-2458173120, -2109288600, -860976000, -845254800, -829526400, -813805200], 
    const [
      Timezone(FastOffset('+01:30', 5400), abbreviation: 'SAST', dst: false),
  ...
  /// The `Africa/Mbabane` location.
  Location get mbabane => Location(
    'Africa/Mbabane',
    [-2458173120, -2109288600, -860976000, -845254800, -829526400, -813805200], 
    const [
      Timezone(FastOffset('+01:30', 5400), abbreviation: 'SAST', dst: false),
  ...
  /// The `Africa/Mogadishu` location.
  Location get mogadishu => Location(
    'Africa/Mogadishu',
    [-1946168836, -1309746600, -1261969200, -1041388200, -865305900], 
    const [
      Timezone(FastOffset('+02:30', 9000), abbreviation: '+0230', dst: false),
  ...
  /// The `Africa/Monrovia` location.
  Location get monrovia => Location(
    'Africa/Monrovia',
    [-2776979812, -1604359012, 63593070], 
    const [
      Timezone(FastOffset('-00:43:08', -2588), abbreviation: 'MMT', dst: false),
      Timezone(FastOffset('-00:44:30', -2670), abbreviation: 'MMT', dst: false),
      Timezone(FastOffset('Z', 0), abbreviation: 'GMT', dst: false),
    ],
  );

  /// The `Africa/Nairobi` location.
  Location get nairobi => Location(
    'Africa/Nairobi',
    [-1946168836, -1309746600, -1261969200, -1041388200, -865305900], 
    const [
      Timezone(FastOffset('+02:30', 9000), abbreviation: '+0230', dst: false),
  ...
  /// The `Africa/Ndjamena` location.
  Location get ndjamena => Location(
    'Africa/Ndjamena',
    [-1830387612, 308703600, 321314400], 
    const [
      Timezone(FastOffset('+01:00', 3600), abbreviation: 'WAT', dst: false),
      Timezone(FastOffset('+02:00', 7200), abbreviation: 'WAST', dst: true),
      Timezone(FastOffset('+01:00', 3600), abbreviation: 'WAT', dst: false),
    ],
  );

  /// The `Africa/Niamey` location.
  Location get niamey => Location(
    'Africa/Niamey',
    [-2035584815, -1940889600, -1767226415, -1588465800], 
    const [
      Timezone(FastOffset('Z', 0), abbreviation: 'GMT', dst: false),
  ...
  /// The `Africa/Nouakchott` location.
  Location get nouakchott => Location(
    'Africa/Nouakchott',
    [-1830383032], 
    const [
      Timezone(FastOffset('Z', 0), abbreviation: 'GMT', dst: false),
  ...
  /// The `Africa/Ouagadougou` location.
  Location get ouagadougou => Location(
    'Africa/Ouagadougou',
    [-1830383032], 
    const [
      Timezone(FastOffset('Z', 0), abbreviation: 'GMT', dst: false),
  ...
  /// The `Africa/Porto-Novo` location.
  Location get portoNovo => Location(
    'Africa/Porto-Novo',
    [-2035584815, -1940889600, -1767226415, -1588465800], 
    const [
      Timezone(FastOffset('Z', 0), abbreviation: 'GMT', dst: false),
  ...
  /// The `Africa/Sao_Tome` location.
  Location get saoTome => Location(
    'Africa/Sao_Tome',
    [-2713912016, -1830384000, 1514768400, 1546304400], 
    const [
      Timezone(FastOffset('-00:36:45', -2205), abbreviation: 'LMT', dst: false),
      Timezone(FastOffset('Z', 0), abbreviation: 'GMT', dst: false),
      Timezone(FastOffset('+01:00', 3600), abbreviation: 'WAT', dst: false),
      Timezone(FastOffset('Z', 0), abbreviation: 'GMT', dst: false),
    ],
  ...
  /// The `Africa/Timbuktu` location.
  Location get timbuktu => Location(
    'Africa/Timbuktu',
    [-1830383032], 
    const [
      Timezone(FastOffset('Z', 0), abbreviation: 'GMT', dst: false),
  ...
  /// The `Africa/Tripoli` location.
  Location get tripoli => Location(
    'Africa/Tripoli',
  ...
  /// The `Africa/Tunis` location.
  Location get tunis => Location(
    'Africa/Tunis',
  ...
  /// The `Africa/Windhoek` location.
  Location get windhoek => Location(
    'Africa/Windhoek',
    ...
    const [
      Timezone(FastOffset('+01:30', 5400), abbreviation: '+0130', dst: false),
      Timezone(FastOffset('+02:00', 7200), abbreviation: 'SAST', dst: false),
      Timezone(FastOffset('+03:00', 10800), abbreviation: 'SAST', dst: true),
      Timezone(FastOffset('+02:00', 7200), abbreviation: 'SAST', dst: false),
      Timezone(FastOffset('+02:00', 7200), abbreviation: 'CAT', dst: false),
      Timezone(FastOffset('+01:00', 3600), abbreviation: 'WAT', dst: true),
      Timezone(FastOffset('+02:00', 7200), abbreviation: 'CAT', dst: false),
      Timezone(FastOffset('+01:00', 3600), abbreviation: 'WAT', dst: true),
      Timezone(FastOffset('+02:00', 7200), abbreviation: 'CAT', dst: false),
      Timezone(FastOffset('+01:00', 3600), abbreviation: 'WAT', dst: true),
