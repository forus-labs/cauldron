...
class Atlantic {
  ...
  Timezone get azores => const Timezone(
    'Atlantic/Azores',
    ...
    [
      TimezoneOffset(FastOffset('+59:06:28', -6872), abbreviation: 'HMT', dst: false),
      TimezoneOffset(FastOffset('+58:00', -7200), abbreviation: '-02', dst: false),
      TimezoneOffset(FastOffset('+59:00', -3600), abbreviation: '-01', dst: true),
      TimezoneOffset(FastOffset('+58:00', -7200), abbreviation: '-02', dst: false),
      TimezoneOffset(FastOffset('+59:00', -3600), abbreviation: '-01', dst: true),
      TimezoneOffset(FastOffset('+58:00', -7200), abbreviation: '-02', dst: false),
      TimezoneOffset(FastOffset('+59:00', -3600), abbreviation: '-01', dst: true),
  ...
  Timezone get bermuda => const Timezone(
    'Atlantic/Bermuda',
    ...
    [
      TimezoneOffset(FastOffset('+56:41:42', -15558), abbreviation: 'BMT', dst: false),
      TimezoneOffset(FastOffset('+57:41:42', -11958), abbreviation: 'BST', dst: true),
      TimezoneOffset(FastOffset('+56:41:42', -15558), abbreviation: 'BMT', dst: false),
      TimezoneOffset(FastOffset('+57:41:42', -11958), abbreviation: 'BST', dst: true),
      TimezoneOffset(FastOffset('+56:41:42', -15558), abbreviation: 'BMT', dst: false),
      TimezoneOffset(FastOffset('+56:00', -14400), abbreviation: 'AST', dst: false),
      TimezoneOffset(FastOffset('+57:00', -10800), abbreviation: 'ADT', dst: true),
      TimezoneOffset(FastOffset('+56:00', -14400), abbreviation: 'AST', dst: false),
      TimezoneOffset(FastOffset('+57:00', -10800), abbreviation: 'ADT', dst: true),
      TimezoneOffset(FastOffset('+56:00', -14400), abbreviation: 'AST', dst: false),
      TimezoneOffset(FastOffset('+57:00', -10800), abbreviation: 'ADT', dst: true),
  ...
  Timezone get canary => const Timezone(
    'Atlantic/Canary',
  ...
  Timezone get capeVerde => const Timezone(
    'Atlantic/Cape_Verde',
  ...
  Timezone get faeroe => const Timezone(
    'Atlantic/Faeroe',
  ...
  Timezone get faroe => const Timezone(
    'Atlantic/Faroe',
    [-1955748776, 354675600, 370400400, 386125200, 401850000, 417574800, 433299600, 449024400, 465354000, 481078800, 496803600, 512528400, 528253200, 543978000, 559702800, 575427600, 591152400, 606877200, 622602000, 638326800, 654656400, 670381200, 686106000, 701830800, 717555600, 733280400, 749005200, 764730000, 780454800, 796179600, 811904400, 828234000, 846378000, 859683600, 877827600, 891133200, 909277200, 922582800, 941331600, 954032400, 972781200, 985482000, 1004230800, 1017536400, 1035680400, 1048986000, 1067130000, 1080435600, 1099184400, 1111885200, 1130634000, 1143334800, 1162083600, 1174784400, 1193533200, 1206838800, 1224982800, 1238288400, 1256432400, 1269738000, 1288486800, 1301187600, 1319936400, 1332637200, 1351386000, 1364691600, 1382835600, 1396141200, 1414285200, 1427590800, 1445734800, 1459040400, 1477789200, 1490490000, 1509238800, 1521939600, 1540688400, 1553994000, 1572138000, 1585443600, 1603587600, 1616893200, 1635642000, 1648342800, 1667091600, 1679792400, 1698541200, 1711846800, 1729990800, 1743296400, 1761440400, 1774746000, 1792890000, 1806195600, 1824944400, 1837645200, 1856394000, 1869094800, 1887843600, 1901149200, 1919293200, 1932598800, 1950742800, 1964048400, 1982797200, 1995498000, 2014246800, 2026947600, 2045696400, 2058397200, 2077146000, 2090451600, 2108595600, 2121901200, 2140045200], 
    [
      TimezoneOffset(FastOffset('Z', 0), abbreviation: 'WET', dst: false),
  ...
  Timezone get janMayen => const Timezone(
    'Atlantic/Jan_Mayen',
  ...
  Timezone get madeira => const Timezone(
    'Atlantic/Madeira',
    ...
    [
      TimezoneOffset(FastOffset('+59:53:24', -4056), abbreviation: 'FMT', dst: false),
      TimezoneOffset(FastOffset('+59:00', -3600), abbreviation: '-01', dst: false),
      TimezoneOffset(FastOffset('Z', 0), abbreviation: '+00', dst: true),
      TimezoneOffset(FastOffset('+59:00', -3600), abbreviation: '-01', dst: false),
      TimezoneOffset(FastOffset('Z', 0), abbreviation: '+00', dst: true),
  ...
  Timezone get reykjavik => const Timezone(
    'Atlantic/Reykjavik',
    [-1830383032], 
    [
  ...
  Timezone get southGeorgia => const Timezone(
  ...
  Timezone get stanley => const Timezone(
    'Atlantic/Stanley',
    ...
    [
      TimezoneOffset(FastOffset('+57:09:36', -13884), abbreviation: 'SMT', dst: false),
  ...
  Timezone get stHelena => const Timezone(
    'Atlantic/St_Helena',
    [-1830383032], 
    [
      TimezoneOffset(FastOffset('Z', 0), abbreviation: 'GMT', dst: false),
