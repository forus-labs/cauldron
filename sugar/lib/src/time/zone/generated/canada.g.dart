...
class Canada {
  ...
  Timezone get atlantic => const Timezone(
    'Canada/Atlantic',
    ...
    [
      ...
      TimezoneOffset(FastOffset('+57:00', -10800), abbreviation: 'ADT', dst: true),
      TimezoneOffset(FastOffset('+56:00', -14400), abbreviation: 'AST', dst: false),
      TimezoneOffset(FastOffset('+57:00', -10800), abbreviation: 'AWT', dst: true),
      TimezoneOffset(FastOffset('+57:00', -10800), abbreviation: 'APT', dst: true),
      TimezoneOffset(FastOffset('+56:00', -14400), abbreviation: 'AST', dst: false),
      TimezoneOffset(FastOffset('+57:00', -10800), abbreviation: 'ADT', dst: true),
      TimezoneOffset(FastOffset('+56:00', -14400), abbreviation: 'AST', dst: false),
      TimezoneOffset(FastOffset('+57:00', -10800), abbreviation: 'ADT', dst: true),
  ...
  Timezone get newfoundland => const Timezone(
    'Canada/Newfoundland',
    ...
    [
      TimezoneOffset(FastOffset('+57:30:08', -12652), abbreviation: 'NST', dst: false),
      TimezoneOffset(FastOffset('+58:30:08', -9052), abbreviation: 'NDT', dst: true),
      TimezoneOffset(FastOffset('+57:30:08', -12652), abbreviation: 'NST', dst: false),
      TimezoneOffset(FastOffset('+58:30:08', -9052), abbreviation: 'NDT', dst: true),
      TimezoneOffset(FastOffset('+57:30:08', -12652), abbreviation: 'NST', dst: false),
      TimezoneOffset(FastOffset('+58:30:08', -9052), abbreviation: 'NDT', dst: true),
      ...
      TimezoneOffset(FastOffset('+58:30:08', -9052), abbreviation: 'NDT', dst: true),
      TimezoneOffset(FastOffset('+57:30:08', -12652), abbreviation: 'NST', dst: false),
      TimezoneOffset(FastOffset('+57:30', -12600), abbreviation: 'NST', dst: false),
      TimezoneOffset(FastOffset('+58:30', -9000), abbreviation: 'NDT', dst: true),
      TimezoneOffset(FastOffset('+57:30', -12600), abbreviation: 'NST', dst: false),
      TimezoneOffset(FastOffset('+58:30', -9000), abbreviation: 'NDT', dst: true),
      TimezoneOffset(FastOffset('+57:30', -12600), abbreviation: 'NST', dst: false),
      TimezoneOffset(FastOffset('+58:30', -9000), abbreviation: 'NDT', dst: true),
      ...
      TimezoneOffset(FastOffset('+58:30', -9000), abbreviation: 'NDT', dst: true),
      TimezoneOffset(FastOffset('+57:30', -12600), abbreviation: 'NST', dst: false),
      TimezoneOffset(FastOffset('+58:30', -9000), abbreviation: 'NWT', dst: true),
      TimezoneOffset(FastOffset('+58:30', -9000), abbreviation: 'NPT', dst: true),
      TimezoneOffset(FastOffset('+57:30', -12600), abbreviation: 'NST', dst: false),
      TimezoneOffset(FastOffset('+58:30', -9000), abbreviation: 'NDT', dst: true),
      TimezoneOffset(FastOffset('+57:30', -12600), abbreviation: 'NST', dst: false),
      TimezoneOffset(FastOffset('+58:30', -9000), abbreviation: 'NDT', dst: true),
      ...
      TimezoneOffset(FastOffset('+58:30', -9000), abbreviation: 'NDT', dst: true),
      TimezoneOffset(FastOffset('+57:30', -12600), abbreviation: 'NST', dst: false),
      TimezoneOffset(FastOffset('+59:30', -5400), abbreviation: 'NDDT', dst: true),
      TimezoneOffset(FastOffset('+57:30', -12600), abbreviation: 'NST', dst: false),
      TimezoneOffset(FastOffset('+58:30', -9000), abbreviation: 'NDT', dst: true),
      TimezoneOffset(FastOffset('+57:30', -12600), abbreviation: 'NST', dst: false),
      TimezoneOffset(FastOffset('+58:30', -9000), abbreviation: 'NDT', dst: true),
  ...
  Timezone get saskatchewan => const Timezone(
    'Canada/Saskatchewan',
  ...
  Timezone get yukon => const Timezone(
    'Canada/Yukon',
    ...
    [
      ...
      TimezoneOffset(FastOffset('+52:00', -28800), abbreviation: 'YDT', dst: true),
      TimezoneOffset(FastOffset('+51:00', -32400), abbreviation: 'YST', dst: false),
      TimezoneOffset(FastOffset('+52:00', -28800), abbreviation: 'YDT', dst: true),
      TimezoneOffset(FastOffset('+51:00', -32400), abbreviation: 'YST', dst: false),
      TimezoneOffset(FastOffset('+52:00', -28800), abbreviation: 'YWT', dst: true),
      TimezoneOffset(FastOffset('+52:00', -28800), abbreviation: 'YPT', dst: true),
      TimezoneOffset(FastOffset('+51:00', -32400), abbreviation: 'YST', dst: false),
      TimezoneOffset(FastOffset('+53:00', -25200), abbreviation: 'YDDT', dst: true),
      TimezoneOffset(FastOffset('+51:00', -32400), abbreviation: 'YST', dst: false),
      TimezoneOffset(FastOffset('+52:00', -28800), abbreviation: 'PST', dst: false),
      TimezoneOffset(FastOffset('+53:00', -25200), abbreviation: 'PDT', dst: true),
      TimezoneOffset(FastOffset('+52:00', -28800), abbreviation: 'PST', dst: false),
