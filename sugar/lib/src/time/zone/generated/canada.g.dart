...
class Canada {
  ...
  /// The `Canada/Atlantic` location.
  Location get atlantic => Location(
    'Canada/Atlantic',
    ...
    const [
      ...
      Timezone(FastOffset('-03:00', -10800), abbreviation: 'ADT', dst: true),
      Timezone(FastOffset('-04:00', -14400), abbreviation: 'AST', dst: false),
      Timezone(FastOffset('-03:00', -10800), abbreviation: 'AWT', dst: true),
      Timezone(FastOffset('-03:00', -10800), abbreviation: 'APT', dst: true),
      Timezone(FastOffset('-04:00', -14400), abbreviation: 'AST', dst: false),
      Timezone(FastOffset('-03:00', -10800), abbreviation: 'ADT', dst: true),
      Timezone(FastOffset('-04:00', -14400), abbreviation: 'AST', dst: false),
      Timezone(FastOffset('-03:00', -10800), abbreviation: 'ADT', dst: true),
  ...
  /// The `Canada/Newfoundland` location.
  Location get newfoundland => Location(
    'Canada/Newfoundland',
    ...
    const [
      Timezone(FastOffset('-03:30:52', -12652), abbreviation: 'NST', dst: false),
      Timezone(FastOffset('-02:30:52', -9052), abbreviation: 'NDT', dst: true),
      Timezone(FastOffset('-03:30:52', -12652), abbreviation: 'NST', dst: false),
      Timezone(FastOffset('-02:30:52', -9052), abbreviation: 'NDT', dst: true),
      Timezone(FastOffset('-03:30:52', -12652), abbreviation: 'NST', dst: false),
      Timezone(FastOffset('-02:30:52', -9052), abbreviation: 'NDT', dst: true),
      ...
      Timezone(FastOffset('-02:30:52', -9052), abbreviation: 'NDT', dst: true),
      Timezone(FastOffset('-03:30:52', -12652), abbreviation: 'NST', dst: false),
      Timezone(FastOffset('-03:30', -12600), abbreviation: 'NST', dst: false),
      Timezone(FastOffset('-02:30', -9000), abbreviation: 'NDT', dst: true),
      Timezone(FastOffset('-03:30', -12600), abbreviation: 'NST', dst: false),
      Timezone(FastOffset('-02:30', -9000), abbreviation: 'NDT', dst: true),
      Timezone(FastOffset('-03:30', -12600), abbreviation: 'NST', dst: false),
      Timezone(FastOffset('-02:30', -9000), abbreviation: 'NDT', dst: true),
      ...
      Timezone(FastOffset('-02:30', -9000), abbreviation: 'NDT', dst: true),
      Timezone(FastOffset('-03:30', -12600), abbreviation: 'NST', dst: false),
      Timezone(FastOffset('-02:30', -9000), abbreviation: 'NWT', dst: true),
      Timezone(FastOffset('-02:30', -9000), abbreviation: 'NPT', dst: true),
      Timezone(FastOffset('-03:30', -12600), abbreviation: 'NST', dst: false),
      Timezone(FastOffset('-02:30', -9000), abbreviation: 'NDT', dst: true),
      Timezone(FastOffset('-03:30', -12600), abbreviation: 'NST', dst: false),
      Timezone(FastOffset('-02:30', -9000), abbreviation: 'NDT', dst: true),
      ...
      Timezone(FastOffset('-02:30', -9000), abbreviation: 'NDT', dst: true),
      Timezone(FastOffset('-03:30', -12600), abbreviation: 'NST', dst: false),
      Timezone(FastOffset('-01:30', -5400), abbreviation: 'NDDT', dst: true),
      Timezone(FastOffset('-03:30', -12600), abbreviation: 'NST', dst: false),
      Timezone(FastOffset('-02:30', -9000), abbreviation: 'NDT', dst: true),
      Timezone(FastOffset('-03:30', -12600), abbreviation: 'NST', dst: false),
      Timezone(FastOffset('-02:30', -9000), abbreviation: 'NDT', dst: true),
  ...
  /// The `Canada/Saskatchewan` location.
  Location get saskatchewan => Location(
    'Canada/Saskatchewan',
  ...
  /// The `Canada/Yukon` location.
  Location get yukon => Location(
    'Canada/Yukon',
    ...
    const [
      ...
      Timezone(FastOffset('-08:00', -28800), abbreviation: 'YDT', dst: true),
      Timezone(FastOffset('-09:00', -32400), abbreviation: 'YST', dst: false),
      Timezone(FastOffset('-08:00', -28800), abbreviation: 'YDT', dst: true),
      Timezone(FastOffset('-09:00', -32400), abbreviation: 'YST', dst: false),
      Timezone(FastOffset('-08:00', -28800), abbreviation: 'YWT', dst: true),
      Timezone(FastOffset('-08:00', -28800), abbreviation: 'YPT', dst: true),
      Timezone(FastOffset('-09:00', -32400), abbreviation: 'YST', dst: false),
      Timezone(FastOffset('-07:00', -25200), abbreviation: 'YDDT', dst: true),
      Timezone(FastOffset('-09:00', -32400), abbreviation: 'YST', dst: false),
      Timezone(FastOffset('-08:00', -28800), abbreviation: 'PST', dst: false),
      Timezone(FastOffset('-07:00', -25200), abbreviation: 'PDT', dst: true),
      Timezone(FastOffset('-08:00', -28800), abbreviation: 'PST', dst: false),
