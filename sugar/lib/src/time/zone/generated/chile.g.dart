...
class Chile {
  ...
  /// The `Chile/Continental` location.
  Location get continental => Location(
    'Chile/Continental',
    ...
    const [
      Timezone(FastOffset('-04:42:45', -16965), abbreviation: 'SMT', dst: false),
  ...
  /// The `Chile/EasterIsland` location.
  Location get easterIsland => Location(
    'Chile/EasterIsland',
