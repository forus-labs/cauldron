...
extension Australia on Never {
  static final Timezone act = DynamicTimezone(
    'Australia/ACT',
    DynamicTimezoneSpan(-1, 36292000000, 'LMT', TimezoneSpan.range.min.value, -2364113092, dst: false),
    Int64List.fromList([
      -2364113092,
      -1672560000,
      -1665388800,
  ...
  static final Timezone adelaide = DynamicTimezone(
    'Australia/Adelaide',
    DynamicTimezoneSpan(-1, 33260000000, 'LMT', TimezoneSpan.range.min.value, -2364110060, dst: false),
    Int64List.fromList([
      -2364110060,
      -2230189200,
      -1672558200,
  ...
  static final Timezone brisbane = DynamicTimezone(
    'Australia/Brisbane',
    DynamicTimezoneSpan(-1, 36728000000, 'LMT', TimezoneSpan.range.min.value, -2366791928, dst: false),
    Int64List.fromList([
      -2366791928,
      -1672560000,
      -1665388800,
  ...
  static final Timezone brokenHill = DynamicTimezone(
    ...
    DynamicTimezoneSpan(-1, 33948000000, 'LMT', TimezoneSpan.range.min.value, -2364110748, dst: false),
    Int64List.fromList([
      -2364110748,
      -2314951200,
      -2230189200,
  ...
  static final Timezone currie = DynamicTimezone(
    'Australia/Currie',
    DynamicTimezoneSpan(-1, 35356000000, 'LMT', TimezoneSpan.range.min.value, -2345795356, dst: false),
    Int64List.fromList([
      -2345795356,
      -1680508800,
      -1665388800,
  ...
  static final Timezone darwin = DynamicTimezone(
    'Australia/Darwin',
    DynamicTimezoneSpan(-1, 31400000000, 'LMT', TimezoneSpan.range.min.value, -2364108200, dst: false),
    Int64List.fromList([
      -2364108200,
      -2230189200,
      -1672558200,
  ...
  static final Timezone eucla = DynamicTimezone(
    'Australia/Eucla',
    DynamicTimezoneSpan(-1, 30928000000, 'LMT', TimezoneSpan.range.min.value, -2337928528, dst: false),
    Int64List.fromList([
      -2337928528,
      -1672555500,
      -1665384300,
  ...
  static final Timezone lhi = DynamicTimezone(
    'Australia/LHI',
    DynamicTimezoneSpan(-1, 38180000000, 'LMT', TimezoneSpan.range.min.value, -2364114980, dst: false),
    Int64List.fromList([
      -2364114980,
      352216800,
      372785400,
  ...
  static final Timezone lindeman = DynamicTimezone(
    'Australia/Lindeman',
    DynamicTimezoneSpan(-1, 35756000000, 'LMT', TimezoneSpan.range.min.value, -2366790956, dst: false),
    Int64List.fromList([
      -2366790956,
      -1672560000,
      -1665388800,
  ...
  static final Timezone melbourne = DynamicTimezone(
    'Australia/Melbourne',
    DynamicTimezoneSpan(-1, 34792000000, 'LMT', TimezoneSpan.range.min.value, -2364111592, dst: false),
    Int64List.fromList([
      -2364111592,
      -1672560000,
      -1665388800,
  ...
  static final Timezone perth = DynamicTimezone(
    'Australia/Perth',
    DynamicTimezoneSpan(-1, 27804000000, 'LMT', TimezoneSpan.range.min.value, -2337925404, dst: false),
    Int64List.fromList([
      -2337925404,
      -1672552800,
      -1665381600,
