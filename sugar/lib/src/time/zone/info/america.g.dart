...
extension America on Never {
  static final Timezone adak = DynamicTimezone(
    'America/Adak',
    const RawOffset('+12:13:22', 44002),
    ...
    const [
      RawOffset('-11:46:38', -42398),
      RawOffset('-11:00', -39600),
      RawOffset('-10:00', -36000),
      RawOffset('-10:00', -36000),
      RawOffset('-11:00', -39600),
      RawOffset('-11:00', -39600),
      RawOffset('-10:00', -36000),
  ...
  static final Timezone anchorage = DynamicTimezone(
    'America/Anchorage',
    const RawOffset('+14:00:24', 50424),
  ...
  static final Timezone anguilla = DynamicTimezone(
    'America/Anguilla',
    const RawOffset('-04:24:25', -15865),
    [-2233035335, -873057600, -769395600, -765399600],
    const [
  ...
  static final Timezone araguaina = DynamicTimezone(
    'America/Araguaina',
    const RawOffset('-03:12:48', -11568),
  ...
  static final Timezone asuncion = DynamicTimezone(
    'America/Asuncion',
    const RawOffset('-03:50:40', -13840),
  ...
  static final Timezone atikokan = DynamicTimezone(
    'America/Atikokan',
    const RawOffset('-05:18:08', -19088),
    [-2524502512, -1946918424],
    const [
      RawOffset('-05:19:36', -19176),
  ...
  static final Timezone barbados = DynamicTimezone(
    'America/Barbados',
    const RawOffset('-03:58:29', -14309),
    [-1841256091, -874263600, -862682400, -841604400, -830714400, -820526400, -811882800, -798660000, -788904000, 234943200, 244616400, 261554400, 276066000, 293004000, 307515600, 325058400, 338706000],
    const [
      RawOffset('-04:00', -14400),
      RawOffset('-03:00', -10800),
      RawOffset('-04:00', -14400),
  ...
  static final Timezone belem = DynamicTimezone(
    'America/Belem',
    const RawOffset('-03:13:56', -11636),
    [-1767213964, -1206957600, -1191362400, -1175374800, -1159826400, -633819600, -622069200, -602283600, -591832800, -570747600, -560210400, -539125200, -531352800, -191365200, -184197600, -155163600, -150069600, -128898000, -121125600, -99954000, -89589600, -68418000, -57967200, 499748400, 511236000, 530593200, 540266400, 562129200, 571197600],
    const [
      RawOffset('-03:00', -10800),
      RawOffset('-02:00', -7200),
      RawOffset('-03:00', -10800),
  ...
  static final Timezone belize = DynamicTimezone(
    'America/Belize',
    const RawOffset('-05:52:48', -21168),
  ...
  static final Timezone boaVista = DynamicTimezone(
    'America/Boa_Vista',
    const RawOffset('-04:02:40', -14560),
  ...
  static final Timezone bogota = DynamicTimezone(
    'America/Bogota',
    const RawOffset('-04:56:16', -17776),
    [-2707671824, -1739041424, 704869200, 729057600],
    const [
      RawOffset('-04:56:16', -17776),
      RawOffset('-05:00', -18000),
      RawOffset('-04:00', -14400),
      RawOffset('-05:00', -18000),
    ],
  ...
  static final Timezone boise = DynamicTimezone(
    'America/Boise',
    const RawOffset('-07:44:49', -27889),
  ...
  static final Timezone campoGrande = DynamicTimezone(
    ...
    const RawOffset('-03:38:28', -13108),
  ...
  static final Timezone cancun = DynamicTimezone(
    'America/Cancun',
    const RawOffset('-05:47:04', -20824),
  ...
  static final Timezone caracas = DynamicTimezone(
    'America/Caracas',
    const RawOffset('-04:27:44', -16064),
    [-2524505536, -1826739140, -157750200, 1197183600, 1462086000],
    const [
      RawOffset('-04:27:40', -16060),
      RawOffset('-04:30', -16200),
      RawOffset('-04:00', -14400),
      RawOffset('-04:30', -16200),
      RawOffset('-04:00', -14400),
    ],
  ...
  static final Timezone cayenne = DynamicTimezone(
    'America/Cayenne',
    const RawOffset('-03:29:20', -12560),
    [-1846269040, -71092800],
    const [
      RawOffset('-04:00', -14400),
      RawOffset('-03:00', -10800),
  ...
  static final Timezone chicago = DynamicTimezone(
    'America/Chicago',
    const RawOffset('-05:50:36', -21036),
  ...
  static final Timezone chihuahua = DynamicTimezone(
    'America/Chihuahua',
    const RawOffset('-07:04:20', -25460),
  ...
  static final Timezone ciudadJuarez = DynamicTimezone(
    ...
    const RawOffset('-07:05:56', -25556),
  ...
  static final Timezone costaRica = DynamicTimezone(
    'America/Costa_Rica',
    const RawOffset('-05:36:13', -20173),
    [-2524501427, -1545071027, 288770400, 297234000, 320220000, 328683600, 664264800, 678344400, 695714400, 700635600],
    const [
      RawOffset('-05:36:13', -20173),
      RawOffset('-06:00', -21600),
      RawOffset('-05:00', -18000),
      RawOffset('-06:00', -21600),
      RawOffset('-05:00', -18000),
  ...
  static final Timezone creston = DynamicTimezone(
    'America/Creston',
    const RawOffset('-07:28:18', -26898),
  ...
  static final Timezone cuiaba = DynamicTimezone(
    'America/Cuiaba',
    const RawOffset('-03:44:20', -13460),
  ...
  static final Timezone dawson = DynamicTimezone(
    'America/Dawson',
    const RawOffset('-09:17:40', -33460),
  ...
  static final Timezone dawsonCreek = DynamicTimezone(
    ...
    const RawOffset('-08:00:56', -28856),
  ...
  static final Timezone denver = DynamicTimezone(
    'America/Denver',
    const RawOffset('-06:59:56', -25196),
  ...
  static final Timezone detroit = DynamicTimezone(
    'America/Detroit',
    const RawOffset('-05:32:11', -19931),
  ...
  static final Timezone edmonton = DynamicTimezone(
    'America/Edmonton',
    const RawOffset('-07:33:52', -27232),
  ...
  static final Timezone eirunepe = DynamicTimezone(
    'America/Eirunepe',
    const RawOffset('-04:39:28', -16768),
  ...
  static final Timezone elSalvador = DynamicTimezone(
    'America/El_Salvador',
    const RawOffset('-05:56:48', -21408),
    [-1546279392, 547020000, 559717200, 578469600, 591166800],
    const [
      RawOffset('-06:00', -21600),
      RawOffset('-05:00', -18000),
      RawOffset('-06:00', -21600),
  ...
  static final Timezone ensenada = DynamicTimezone(
    'America/Ensenada',
    const RawOffset('-07:48:04', -28084),
  ...
  static final Timezone fortNelson = DynamicTimezone(
    'America/Fort_Nelson',
    const RawOffset('-08:10:47', -29447),
  ...
  static final Timezone fortWayne = DynamicTimezone(
    'America/Fort_Wayne',
    const RawOffset('-05:44:38', -20678),
  ...
  static final Timezone glaceBay = DynamicTimezone(
    'America/Glace_Bay',
    const RawOffset('-03:59:48', -14388),
  ...
  static final Timezone godthab = DynamicTimezone(
    'America/Godthab',
    const RawOffset('-03:26:56', -12416),
  ...
  static final Timezone gooseBay = DynamicTimezone(
    'America/Goose_Bay',
    const RawOffset('-04:01:40', -14500),
    ...
    const [
      RawOffset('-03:30:52', -12652),
      RawOffset('-02:30:52', -9052),
      RawOffset('-03:30:52', -12652),
      RawOffset('-03:30', -12600),
  ...
  static final Timezone grandTurk = DynamicTimezone(
    'America/Grand_Turk',
    const RawOffset('-04:44:32', -17072),
  ...
  static final Timezone guatemala = DynamicTimezone(
    'America/Guatemala',
    const RawOffset('-06:02:04', -21724),
    [-1617040676, 123055200, 130914000, 422344800, 433054800, 669708000, 684219600, 1146376800, 1159678800],
    const [
      RawOffset('-06:00', -21600),
      RawOffset('-05:00', -18000),
      RawOffset('-06:00', -21600),
  ...
  static final Timezone guayaquil = DynamicTimezone(
    'America/Guayaquil',
    const RawOffset('-05:19:20', -19160),
    [-2524502440, -1230749160, 722926800, 728884800],
    const [
      RawOffset('-05:14', -18840),
      RawOffset('-05:00', -18000),
      RawOffset('-04:00', -14400),
      RawOffset('-05:00', -18000),
    ],
  ...
  static final Timezone guyana = DynamicTimezone(
    'America/Guyana',
    const RawOffset('-03:52:39', -13959),
    [-1843589241, -1730577600, 176096700, 701841600],
    const [
      RawOffset('-04:00', -14400),
      RawOffset('-03:45', -13500),
      RawOffset('-03:00', -10800),
      RawOffset('-04:00', -14400),
    ],
  );
  ...
  static final Timezone halifax = DynamicTimezone(
    'America/Halifax',
    const RawOffset('-04:14:24', -15264),
  ...
  static final Timezone havana = DynamicTimezone(
    'America/Havana',
    const RawOffset('-05:29:28', -19768),
  ...
  static final Timezone hermosillo = DynamicTimezone(
    'America/Hermosillo',
    const RawOffset('-07:23:52', -26632),
    [-1514739600, -1343066400, -1234807200, -1220292000, -1207159200, -1191344400, -873828000, -661539600, 28800, 828867600, 846403200, 860317200, 877852800, 891766800, 909302400],
    const [
      RawOffset('-07:00', -25200),
      RawOffset('-06:00', -21600),
      RawOffset('-07:00', -25200),
  ...
  static final Timezone jamaica = DynamicTimezone(
    'America/Jamaica',
    const RawOffset('-05:07:10', -18430),
  ...
  static final Timezone juneau = DynamicTimezone(
    'America/Juneau',
    const RawOffset('+15:02:19', 54139),
  ...
  static final Timezone knoxIn = DynamicTimezone(
    'America/Knox_IN',
    const RawOffset('-05:46:30', -20790),
  ...
  static final Timezone laPaz = DynamicTimezone(
    'America/La_Paz',
    const RawOffset('-04:32:36', -16356),
    [-2524505244, -1205954844, -1192307244],
    const [
      RawOffset('-04:32:36', -16356),
      RawOffset('-03:32:36', -12756),
      RawOffset('-04:00', -14400),
    ],
  );
  ...
  static final Timezone lima = DynamicTimezone(
    'America/Lima',
    const RawOffset('-05:08:12', -18492),
    [-2524503108, -1938538284, -1009825200, -1002052800, -986756400, -971035200, -955306800, -939585600, 504939600, 512712000, 536475600, 544248000, 631170000, 638942400, 757400400, 765172800],
    const [
      RawOffset('-05:08:36', -18516),
      RawOffset('-05:00', -18000),
      RawOffset('-04:00', -14400),
      RawOffset('-05:00', -18000),
      RawOffset('-04:00', -14400),
  ...
  static final Timezone losAngeles = DynamicTimezone(
    'America/Los_Angeles',
    const RawOffset('-07:52:58', -28378),
  ...
  static final Timezone louisville = DynamicTimezone(
    'America/Louisville',
    const RawOffset('-05:43:02', -20582),
  ...
  static final Timezone managua = DynamicTimezone(
    'America/Managua',
    const RawOffset('-05:45:08', -20708),
    [-2524500892, -1121105688, 105084000, 161758800, 290584800, 299134800, 322034400, 330584400, 694260000, 717310800, 725868000, 852094800, 1113112800, 1128229200, 1146384000, 1159682400],
    const [
      RawOffset('-05:45:12', -20712),
      RawOffset('-06:00', -21600),
      RawOffset('-05:00', -18000),
      RawOffset('-06:00', -21600),
      RawOffset('-05:00', -18000),
  ...
  static final Timezone manaus = DynamicTimezone(
    'America/Manaus',
    const RawOffset('-04:00:04', -14404),
  ...
  static final Timezone martinique = DynamicTimezone(
    'America/Martinique',
    const RawOffset('-04:04:20', -14660),
    [-2524506940, -1851537340, 323841600, 338958000],
    const [
      RawOffset('-04:04:20', -14660),
      RawOffset('-04:00', -14400),
      RawOffset('-03:00', -10800),
      RawOffset('-04:00', -14400),
    ],
  ...
  static final Timezone mazatlan = DynamicTimezone(
    'America/Mazatlan',
    const RawOffset('-07:05:40', -25540),
    [-1514739600, -1343066400, -1234807200, -1220292000, -1207159200, -1191344400, -873828000, -661539600, 28800, 828867600, 846403200, 860317200, 877852800, 891766800, 909302400, 923216400, 941356800, 954666000, 972806400, 989139600, 1001836800, 1018170000, 1035705600, 1049619600, 1067155200, 1081069200, 1099209600, 1112518800, 1130659200, 1143968400, 1162108800, 1175418000, 1193558400, 1207472400, 1225008000, 1238922000, 1256457600, 1270371600, 1288512000, 1301821200, 1319961600, 1333270800, 1351411200, 1365325200, 1382860800, 1396774800, 1414310400, 1428224400, 1445760000, 1459674000, 1477814400, 1491123600, 1509264000, 1522573200, 1540713600, 1554627600, 1572163200, 1586077200, 1603612800, 1617526800, 1635667200, 1648976400, 1667116800],
    const [
      RawOffset('-07:00', -25200),
      RawOffset('-06:00', -21600),
  ...
  static final Timezone menominee = DynamicTimezone(
    'America/Menominee',
    const RawOffset('-05:50:27', -21027),
  ...
  static final Timezone merida = DynamicTimezone(
    'America/Merida',
    const RawOffset('-05:58:28', -21508),
  ...
  static final Timezone metlakatla = DynamicTimezone(
    'America/Metlakatla',
    const RawOffset('+15:13:42', 54822),
  ...
  static final Timezone mexicoCity = DynamicTimezone(
    'America/Mexico_City',
    const RawOffset('-06:36:36', -23796),
  ...
  static final Timezone miquelon = DynamicTimezone(
    'America/Miquelon',
    const RawOffset('-03:44:40', -13480),
  ...
  static final Timezone moncton = DynamicTimezone(
    'America/Moncton',
    const RawOffset('-04:19:08', -15548),
  ...
  static final Timezone monterrey = DynamicTimezone(
    'America/Monterrey',
    const RawOffset('-06:41:16', -24076),
    [-1514743200, 568015200, 576057600, 594198000, 828864000, 846399600, 860313600, 877849200, 891763200, 909298800, 923212800, 941353200, 954662400, 972802800, 989136000, 1001833200, 1018166400, 1035702000, 1049616000, 1067151600, 1081065600, 1099206000, 1112515200, 1130655600, 1143964800, 1162105200, 1175414400, 1193554800, 1207468800, 1225004400, 1238918400, 1256454000, 1270368000, 1288508400, 1301817600, 1319958000, 1333267200, 1351407600, 1365321600, 1382857200, 1396771200, 1414306800, 1428220800, 1445756400, 1459670400, 1477810800, 1491120000, 1509260400, 1522569600, 1540710000, 1554624000, 1572159600, 1586073600, 1603609200, 1617523200, 1635663600, 1648972800, 1667113200],
    const [
      RawOffset('-06:00', -21600),
      RawOffset('-06:00', -21600),
  ...
  static final Timezone montreal = DynamicTimezone(
    'America/Montreal',
    const RawOffset('-05:17:32', -19052),
  ...
  static final Timezone newYork = DynamicTimezone(
    'America/New_York',
    const RawOffset('-04:56:02', -17762),
  ...
  static final Timezone nome = DynamicTimezone(
    'America/Nome',
    const RawOffset('+12:58:22', 46702),
  ...
  static final Timezone ojinaga = DynamicTimezone(
    'America/Ojinaga',
    const RawOffset('-06:57:40', -25060),
  ...
  static final Timezone paramaribo = DynamicTimezone(
    'America/Paramaribo',
    const RawOffset('-03:40:40', -13240),
    [-1861906760, -1104524348, -765317964, 465449400],
    const [
      RawOffset('-03:40:52', -13252),
      RawOffset('-03:40:36', -13236),
      RawOffset('-03:30', -12600),
      RawOffset('-03:00', -10800),
    ],
  );
  ...
  static final Timezone portoAcre = DynamicTimezone(
    'America/Porto_Acre',
    const RawOffset('-04:31:12', -16272),
  ...
  static final Timezone portoVelho = DynamicTimezone(
    'America/Porto_Velho',
    const RawOffset('-04:15:36', -15336),
    [-1767210264, -1206954000, -1191358800, -1175371200, -1159822800, -633816000, -622065600, -602280000, -591829200, -570744000, -560206800, -539121600, -531349200, -191361600, -184194000, -155160000, -150066000, -128894400, -121122000, -99950400, -89586000, -68414400, -57963600, 499752000, 511239600, 530596800, 540270000, 562132800, 571201200],
    const [
      RawOffset('-04:00', -14400),
      RawOffset('-03:00', -10800),
      RawOffset('-04:00', -14400),
  ...
  static final Timezone puntaArenas = DynamicTimezone(
    ...
    const RawOffset('-04:43:40', -17020),
  ...
  static final Timezone rainyRiver = DynamicTimezone(
    'America/Rainy_River',
    const RawOffset('-06:28:36', -23316),
  ...
  static final Timezone regina = DynamicTimezone(
    'America/Regina',
    const RawOffset('-06:58:36', -25116),
  ...
  static final Timezone santarem = DynamicTimezone(
    'America/Santarem',
    const RawOffset('-03:38:48', -13128),
  ...
  static final Timezone santoDomingo = DynamicTimezone(
    ...
    const RawOffset('-04:39:36', -16776),
    [-2524504824, -1159773600, -100119600, -89668800, -5770800, 4422600, 25678800, 33193800, 57733200, 64816200, 89182800, 96438600, 120632400, 127974600, 152082000, 972799200, 975823200],
    const [
      RawOffset('-04:40', -16800),
      RawOffset('-05:00', -18000),
      RawOffset('-04:00', -14400),
      RawOffset('-05:00', -18000),
      RawOffset('-04:30', -16200),
  ...
  static final Timezone saoPaulo = DynamicTimezone(
    'America/Sao_Paulo',
    const RawOffset('-03:06:28', -11188),
  ...
  static final Timezone sitka = DynamicTimezone(
    'America/Sitka',
    const RawOffset('+14:58:47', 53927),
  ...
  static final Timezone stJohns = DynamicTimezone(
    'America/St_Johns',
    const RawOffset('-03:30:52', -12652),
  ...
  static final Timezone swiftCurrent = DynamicTimezone(
    ...
    const RawOffset('-07:11:20', -25880),
    [-2030201320, -1632063600, -1615132800, -880210800, -769395600, -765388800, -747241200, -732729600, -715791600, -702489600, -684342000, -671040000, -652892400, -639590400, -400086000, -384364800, -337186800, -321465600, -305737200, -292435200, -273682800, -260985600, 73472400],
    const [
      RawOffset('-07:00', -25200),
      RawOffset('-06:00', -21600),
      RawOffset('-07:00', -25200),
  ...
  static final Timezone tegucigalpa = DynamicTimezone(
    'America/Tegucigalpa',
    const RawOffset('-05:48:52', -20932),
  ...
  static final Timezone thule = DynamicTimezone(
    'America/Thule',
    const RawOffset('-04:35:08', -16508),
  ...
  static final Timezone vancouver = DynamicTimezone(
    'America/Vancouver',
    const RawOffset('-08:12:28', -29548),
  ...
  static final Timezone whitehorse = DynamicTimezone(
    'America/Whitehorse',
    const RawOffset('-09:00:12', -32412),
  ...
  static final Timezone yakutat = DynamicTimezone(
    'America/Yakutat',
    const RawOffset('+14:41:05', 52865),
