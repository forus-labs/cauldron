...
extension Atlantic on Never {
  static final Timezone azores = DynamicTimezone(
    'Atlantic/Azores',
    DynamicTimezoneSpan(-1, -6160000000, 'LMT', TimezoneSpan.range.min.value, -2713904240, dst: false),
    Int64List.fromList([
      -2713904240,
      -1830376800,
      -1689548400,
  ...
  static final Timezone bermuda = DynamicTimezone(
    'Atlantic/Bermuda',
    DynamicTimezoneSpan(-1, -15558000000, 'LMT', TimezoneSpan.range.min.value, -2524506042, dst: false),
    Int64List.fromList([
      -2524506042,
      -1664307642,
      -1648932042,
  ...
  static final Timezone canary = DynamicTimezone(
    'Atlantic/Canary',
    DynamicTimezoneSpan(-1, -3696000000, 'LMT', TimezoneSpan.range.min.value, -1509663504, dst: false),
    Int64List.fromList([
      -1509663504,
      -733874400,
      323827200,
  ...
  static final Timezone capeVerde = DynamicTimezone(
    'Atlantic/Cape_Verde',
    DynamicTimezoneSpan(-1, -5644000000, 'LMT', TimezoneSpan.range.min.value, -1830376800, dst: false),
  ...
  static final Timezone faeroe = DynamicTimezone(
    'Atlantic/Faeroe',
    DynamicTimezoneSpan(-1, -1624000000, 'LMT', TimezoneSpan.range.min.value, -1955748776, dst: false),
    Int64List.fromList([
      -1955748776,
      354675600,
      370400400,
  ...
  static final Timezone madeira = DynamicTimezone(
    'Atlantic/Madeira',
    DynamicTimezoneSpan(-1, -4056000000, 'LMT', TimezoneSpan.range.min.value, -2713906344, dst: false),
    Int64List.fromList([
      -2713906344,
      -1830380400,
      -1689552000,
  ...
  static final Timezone southGeorgia = DynamicTimezone(
    ...
    DynamicTimezoneSpan(-1, -8768000000, 'LMT', TimezoneSpan.range.min.value, -2524512832, dst: false),
  ...
  static final Timezone stanley = DynamicTimezone(
    'Atlantic/Stanley',
    DynamicTimezoneSpan(-1, -13884000000, 'LMT', TimezoneSpan.range.min.value, -2524507716, dst: false),
    Int64List.fromList([
      -2524507716,
      -1824235716,
      -1018209600,
