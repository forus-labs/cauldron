...
extension Root on Never {
  ...
  static final Timezone est = FixedTimezone('EST', const RawOffset('-05:00', -18000));
  ...
  static final Timezone eire = DynamicTimezone(
    ...
    const [
      RawOffset('-00:25:21', -1521),
      RawOffset('+00:34:39', 2079),
      RawOffset('Z', 0),
      RawOffset('+01:00', 3600),
      RawOffset('Z', 0),
      RawOffset('+01:00', 3600),
  ...
  static final Timezone factory = FixedTimezone('Factory', const RawOffset('Z', 0));

  static final Timezone gb = DynamicTimezone(
    'GB',
    const RawOffset('-00:01:15', -75),
  ...
  static final Timezone gmt = FixedTimezone('GMT', const RawOffset('Z', 0));

  static final Timezone gmtPlus0 = FixedTimezone('GMT+0', const RawOffset('Z', 0));

  static final Timezone gmtMinus0 = FixedTimezone('GMT-0', const RawOffset('Z', 0));

  static final Timezone gmt0 = FixedTimezone('GMT0', const RawOffset('Z', 0));

  static final Timezone greenwich = FixedTimezone('Greenwich', const RawOffset('Z', 0));

  static final Timezone hst = FixedTimezone('HST', const RawOffset('-10:00', -36000));
  ...
  static final Timezone kwajalein = DynamicTimezone(
    'Kwajalein',
    const RawOffset('+11:09:20', 40160),
  ...
  static final Timezone mst = FixedTimezone('MST', const RawOffset('-07:00', -25200));
  ...
  static final Timezone nz = DynamicTimezone(
    'NZ',
    const RawOffset('+11:39:04', 41944),
    ...
    const [
      RawOffset('+11:30', 41400),
      RawOffset('+12:30', 45000),
      RawOffset('+11:30', 41400),
      RawOffset('+12:00', 43200),
      RawOffset('+11:30', 41400),
      RawOffset('+12:00', 43200),
  ...
  static final Timezone nzChat = DynamicTimezone(
    'NZ-CHAT',
    const RawOffset('+12:13:48', 44028),
    ...
    const [
      RawOffset('+12:15', 44100),
      RawOffset('+12:45', 45900),
      RawOffset('+13:45', 49500),
      RawOffset('+12:45', 45900),
      RawOffset('+13:45', 49500),
      RawOffset('+12:45', 45900),
      RawOffset('+13:45', 49500),
  ...
  static final Timezone uct = FixedTimezone('UCT', const RawOffset('Z', 0));

  static final Timezone utc = FixedTimezone('UTC', const RawOffset('Z', 0));

  static final Timezone universal = FixedTimezone('Universal', const RawOffset('Z', 0));

  static final Timezone wSu = DynamicTimezone(
    'W-SU',
    const RawOffset('+02:30:17', 9017),
    ...
    const [
      RawOffset('+02:30:17', 9017),
      RawOffset('+02:31:19', 9079),
      RawOffset('+03:31:19', 12679),
      RawOffset('+02:31:19', 9079),
      RawOffset('+04:31:19', 16279),
      RawOffset('+03:31:19', 12679),
      RawOffset('+04:31:19', 16279),
      RawOffset('+04:00', 14400),
      RawOffset('+03:00', 10800),
  ...
  static final Timezone zulu = FixedTimezone('Zulu', const RawOffset('Z', 0));
