...
extension Timezones on Never {
  ...
  /// The `CET` location.
  static Location get cet => Location(
    'CET',
    ...
    const [
      Timezone(FastOffset('+02:00', 7200), abbreviation: 'CEST', dst: true),
      Timezone(FastOffset('+01:00', 3600), abbreviation: 'CET', dst: false),
      Timezone(FastOffset('+02:00', 7200), abbreviation: 'CEST', dst: true),
      Timezone(FastOffset('+01:00', 3600), abbreviation: 'CET', dst: false),
      Timezone(FastOffset('+02:00', 7200), abbreviation: 'CEST', dst: true),
      Timezone(FastOffset('+01:00', 3600), abbreviation: 'CET', dst: false),
  ...
  /// The `CST6CDT` location.
  static Location get cst6cdt => Location(
    'CST6CDT',
    ...
    const [
      Timezone(FastOffset('-05:00', -18000), abbreviation: 'CDT', dst: true),
      Timezone(FastOffset('-06:00', -21600), abbreviation: 'CST', dst: false),
      Timezone(FastOffset('-05:00', -18000), abbreviation: 'CDT', dst: true),
      Timezone(FastOffset('-06:00', -21600), abbreviation: 'CST', dst: false),
      Timezone(FastOffset('-05:00', -18000), abbreviation: 'CWT', dst: true),
      Timezone(FastOffset('-05:00', -18000), abbreviation: 'CPT', dst: true),
      Timezone(FastOffset('-06:00', -21600), abbreviation: 'CST', dst: false),
      Timezone(FastOffset('-05:00', -18000), abbreviation: 'CDT', dst: true),
      Timezone(FastOffset('-06:00', -21600), abbreviation: 'CST', dst: false),
      Timezone(FastOffset('-05:00', -18000), abbreviation: 'CDT', dst: true),
  ...
  /// The `Cuba` location.
  static Location get cuba => Location(
    'Cuba',
    ...
    const [
      Timezone(FastOffset('-05:29:36', -19776), abbreviation: 'HMT', dst: false),
      Timezone(FastOffset('-05:00', -18000), abbreviation: 'CST', dst: false),
      Timezone(FastOffset('-04:00', -14400), abbreviation: 'CDT', dst: true),
      Timezone(FastOffset('-05:00', -18000), abbreviation: 'CST', dst: false),
      Timezone(FastOffset('-04:00', -14400), abbreviation: 'CDT', dst: true),
      Timezone(FastOffset('-05:00', -18000), abbreviation: 'CST', dst: false),
      Timezone(FastOffset('-04:00', -14400), abbreviation: 'CDT', dst: true),
  ...
  /// The `EET` location.
  static Location get eet => Location(
    'EET',
  ...
  /// The `Egypt` location.
  static Location get egypt => Location(
    'Egypt',
  ...
  /// The `Eire` location.
  static Location get eire => Location(
    'Eire',
    ...
    const [
      Timezone(FastOffset('-00:25:21', -1521), abbreviation: 'DMT', dst: false),
      Timezone(FastOffset('+00:34:39', 2079), abbreviation: 'IST', dst: true),
      Timezone(FastOffset('Z', 0), abbreviation: 'GMT', dst: false),
      Timezone(FastOffset('+01:00', 3600), abbreviation: 'BST', dst: true),
      Timezone(FastOffset('Z', 0), abbreviation: 'GMT', dst: false),
      Timezone(FastOffset('+01:00', 3600), abbreviation: 'BST', dst: true),
      Timezone(FastOffset('Z', 0), abbreviation: 'GMT', dst: false),
      Timezone(FastOffset('+01:00', 3600), abbreviation: 'BST', dst: true),
      ...
      Timezone(FastOffset('Z', 0), abbreviation: 'GMT', dst: false),
      Timezone(FastOffset('Z', 0), abbreviation: 'GMT', dst: false),
      Timezone(FastOffset('+01:00', 3600), abbreviation: 'IST', dst: true),
      Timezone(FastOffset('Z', 0), abbreviation: 'GMT', dst: false),
      Timezone(FastOffset('+01:00', 3600), abbreviation: 'IST', dst: true),
      Timezone(FastOffset('Z', 0), abbreviation: 'GMT', dst: false),
      Timezone(FastOffset('+01:00', 3600), abbreviation: 'IST', dst: true),
      ...
      Timezone(FastOffset('Z', 0), abbreviation: 'GMT', dst: false),
      Timezone(FastOffset('+01:00', 3600), abbreviation: 'IST', dst: true),
      Timezone(FastOffset('+01:00', 3600), abbreviation: 'IST', dst: false),
      Timezone(FastOffset('Z', 0), abbreviation: 'GMT', dst: true),
      Timezone(FastOffset('+01:00', 3600), abbreviation: 'IST', dst: false),
      Timezone(FastOffset('Z', 0), abbreviation: 'GMT', dst: true),
      Timezone(FastOffset('+01:00', 3600), abbreviation: 'IST', dst: false),
      Timezone(FastOffset('Z', 0), abbreviation: 'GMT', dst: true),
  ...
  /// The `EST` location.
  static Location get est => Location(
    'EST',
    [], 
    const [
    ],
  ...
  /// The `EST5EDT` location.
  static Location get est5edt => Location(
    'EST5EDT',
    ...
    const [
      Timezone(FastOffset('-04:00', -14400), abbreviation: 'EDT', dst: true),
      Timezone(FastOffset('-05:00', -18000), abbreviation: 'EST', dst: false),
      Timezone(FastOffset('-04:00', -14400), abbreviation: 'EDT', dst: true),
      Timezone(FastOffset('-05:00', -18000), abbreviation: 'EST', dst: false),
      Timezone(FastOffset('-04:00', -14400), abbreviation: 'EWT', dst: true),
      Timezone(FastOffset('-04:00', -14400), abbreviation: 'EPT', dst: true),
      Timezone(FastOffset('-05:00', -18000), abbreviation: 'EST', dst: false),
      Timezone(FastOffset('-04:00', -14400), abbreviation: 'EDT', dst: true),
      Timezone(FastOffset('-05:00', -18000), abbreviation: 'EST', dst: false),
      Timezone(FastOffset('-04:00', -14400), abbreviation: 'EDT', dst: true),
  ...
  static Location get factory => Location(
    'Factory',
    [], 
    const [
    ],
  ...
  /// The `GB` location.
  static Location get gb => Location(
    'GB',
    ...
    const [
      ...
      Timezone(FastOffset('Z', 0), abbreviation: 'GMT', dst: false),
      Timezone(FastOffset('+01:00', 3600), abbreviation: 'BST', dst: true),
      Timezone(FastOffset('+02:00', 7200), abbreviation: 'BDST', dst: true),
      Timezone(FastOffset('+01:00', 3600), abbreviation: 'BST', dst: true),
      Timezone(FastOffset('+02:00', 7200), abbreviation: 'BDST', dst: true),
      Timezone(FastOffset('+01:00', 3600), abbreviation: 'BST', dst: true),
      Timezone(FastOffset('+02:00', 7200), abbreviation: 'BDST', dst: true),
      ...
      Timezone(FastOffset('Z', 0), abbreviation: 'GMT', dst: false),
      Timezone(FastOffset('+01:00', 3600), abbreviation: 'BST', dst: true),
      Timezone(FastOffset('+01:00', 3600), abbreviation: 'BST', dst: false),
      Timezone(FastOffset('Z', 0), abbreviation: 'GMT', dst: false),
      Timezone(FastOffset('+01:00', 3600), abbreviation: 'BST', dst: true),
      Timezone(FastOffset('Z', 0), abbreviation: 'GMT', dst: false),
      Timezone(FastOffset('+01:00', 3600), abbreviation: 'BST', dst: true),
  ...
  /// The `GB-Eire` location.
  static Location get gbEire => Location(
    'GB-Eire',
    [-3852662325, -1691964000, -1680472800, -1664143200, -1650146400, -1633903200, -1617487200, -1601848800, -1586037600, -1570399200, -1552168800, -1538344800, -1522533600, -1507500000, -1490565600, -1473631200, -1460930400, -1442786400, -1428876000, -1410732000, -1396216800, -1379282400, -1364767200, -1348437600, -1333317600, -1315778400, -1301263200, -1284328800, -1269813600, -1253484000, -1238364000, -1221429600, -1206914400, -1189980000, -1175464800, -1159135200, -1143410400, -1126476000, -1111960800, -1095631200, -1080511200, -1063576800, -1049061600, -1032127200, -1017612000, -1001282400, -986162400, -969228000, -950479200, -942012000, -904518000, -896050800, -875487600, -864601200, -844038000, -832546800, -812588400, -798073200, -781052400, -772066800, -764805600, -748476000, -733356000, -719445600, -717030000, -706748400, -699487200, -687996000, -668037600, -654732000, -636588000, -622072800, -605743200, -590623200, -574293600, -558568800, -542239200, -527119200, -512604000, -496274400, -481154400, -464220000, -449704800, -432165600, -417650400, -401320800, -386200800, -369266400, -354751200, -337816800, -323301600, -306972000, -291852000, -276732000, -257983200, -245282400, -226533600, -213228000, -195084000, -182383200, -163634400, -150933600, -132184800, -119484000, -100735200, -88034400, -68680800, -59004000, -37242000, 57722400, 69818400, 89172000, 101268000, 120621600, 132717600, 152071200, 164167200, 183520800, 196221600, 214970400, 227671200, 246420000, 259120800, 278474400, 290570400, 309924000, 322020000, 341373600, 354675600, 372819600, 386125200, 404269200, 417574800, 435718800, 449024400, 467773200, 481078800, 499222800, 512528400, 530672400, 543978000, 562122000, 575427600, 593571600, 606877200, 625626000, 638326800, 657075600, 670381200, 688525200, 701830800, 719974800, 733280400, 751424400, 764730000, 782874000, 796179600, 814323600, 820454400, 828234000, 846378000, 859683600, 877827600, 891133200, 909277200, 922582800, 941331600, 954032400, 972781200, 985482000, 1004230800, 1017536400, 1035680400, 1048986000, 1067130000, 1080435600, 1099184400, 1111885200, 1130634000, 1143334800, 1162083600, 1174784400, 1193533200, 1206838800, 1224982800, 1238288400, 1256432400, 1269738000, 1288486800, 1301187600, 1319936400, 1332637200, 1351386000, 1364691600, 1382835600, 1396141200, 1414285200, 1427590800, 1445734800, 1459040400, 1477789200, 1490490000, 1509238800, 1521939600, 1540688400, 1553994000, 1572138000, 1585443600, 1603587600, 1616893200, 1635642000, 1648342800, 1667091600, 1679792400, 1698541200, 1711846800, 1729990800, 1743296400, 1761440400, 1774746000, 1792890000, 1806195600, 1824944400, 1837645200, 1856394000, 1869094800, 1887843600, 1901149200, 1919293200, 1932598800, 1950742800, 1964048400, 1982797200, 1995498000, 2014246800, 2026947600, 2045696400, 2058397200, 2077146000, 2090451600, 2108595600, 2121901200, 2140045200], 
    const [
      Timezone(FastOffset('Z', 0), abbreviation: 'GMT', dst: false),
  ...
  /// The `GMT` location.
  static Location get gmt => Location(
    'GMT',
    [], 
    const [
    ],
  ...
  /// The `GMT+0` location.
  static Location get gmtPlus0 => Location(
    'GMT+0',
    [], 
    const [
    ],
  ...
  /// The `GMT-0` location.
  static Location get gmtMinus0 => Location(
    'GMT-0',
    [], 
    const [
    ],
  ...
  /// The `GMT0` location.
  static Location get gmt0 => Location(
    'GMT0',
    [], 
    const [
    ],
  ...
  /// The `Greenwich` location.
  static Location get greenwich => Location(
    'Greenwich',
    [], 
    const [
    ],
  ...
  /// The `Hongkong` location.
  static Location get hongkong => Location(
    'Hongkong',
  ...
  /// The `HST` location.
  static Location get hst => Location(
    'HST',
    [], 
    const [
    ],
  ...
  static Location get iceland => Location(
    'Iceland',
    [-1830383032], 
    const [
      Timezone(FastOffset('Z', 0), abbreviation: 'GMT', dst: false),
  ...
  /// The `Iran` location.
  static Location get iran => Location(
    'Iran',
  ...
  /// The `Israel` location.
  static Location get israel => Location(
    'Israel',
  ...
  static Location get jamaica => Location(
    'Jamaica',
    ...
    const [
      Timezone(FastOffset('-05:07:10', -18430), abbreviation: 'KMT', dst: false),
      Timezone(FastOffset('-05:00', -18000), abbreviation: 'EST', dst: false),
      Timezone(FastOffset('-04:00', -14400), abbreviation: 'EDT', dst: true),
      Timezone(FastOffset('-05:00', -18000), abbreviation: 'EST', dst: false),
      Timezone(FastOffset('-04:00', -14400), abbreviation: 'EDT', dst: true),
  ...
  /// The `Japan` location.
  static Location get japan => Location(
    'Japan',
  ...
  /// The `Kwajalein` location.
  static Location get kwajalein => Location(
    'Kwajalein',
  ...
  /// The `Libya` location.
  static Location get libya => Location(
    'Libya',
  ...
  /// The `MET` location.
  static Location get met => Location(
    'MET',
    [-1693706400, -1680483600, -1663455600, -1650150000, -1632006000, -1618700400, -938905200, -857257200, -844556400, -828226800, -812502000, -796777200, -781052400, -766623600, 228877200, 243997200, 260326800, 276051600, 291776400, 307501200, 323830800, 338950800, 354675600, 370400400, 386125200, 401850000, 417574800, 433299600, 449024400, 465354000, 481078800, 496803600, 512528400, 528253200, 543978000, 559702800, 575427600, 591152400, 606877200, 622602000, 638326800, 654656400, 670381200, 686106000, 701830800, 717555600, 733280400, 749005200, 764730000, 780454800, 796179600, 811904400, 828234000, 846378000, 859683600, 877827600, 891133200, 909277200, 922582800, 941331600, 954032400, 972781200, 985482000, 1004230800, 1017536400, 1035680400, 1048986000, 1067130000, 1080435600, 1099184400, 1111885200, 1130634000, 1143334800, 1162083600, 1174784400, 1193533200, 1206838800, 1224982800, 1238288400, 1256432400, 1269738000, 1288486800, 1301187600, 1319936400, 1332637200, 1351386000, 1364691600, 1382835600, 1396141200, 1414285200, 1427590800, 1445734800, 1459040400, 1477789200, 1490490000, 1509238800, 1521939600, 1540688400, 1553994000, 1572138000, 1585443600, 1603587600, 1616893200, 1635642000, 1648342800, 1667091600, 1679792400, 1698541200, 1711846800, 1729990800, 1743296400, 1761440400, 1774746000, 1792890000, 1806195600, 1824944400, 1837645200, 1856394000, 1869094800, 1887843600, 1901149200, 1919293200, 1932598800, 1950742800, 1964048400, 1982797200, 1995498000, 2014246800, 2026947600, 2045696400, 2058397200, 2077146000, 2090451600, 2108595600, 2121901200, 2140045200], 
    const [
      Timezone(FastOffset('+02:00', 7200), abbreviation: 'MEST', dst: true),
      Timezone(FastOffset('+01:00', 3600), abbreviation: 'MET', dst: false),
      Timezone(FastOffset('+02:00', 7200), abbreviation: 'MEST', dst: true),
      Timezone(FastOffset('+01:00', 3600), abbreviation: 'MET', dst: false),
      Timezone(FastOffset('+02:00', 7200), abbreviation: 'MEST', dst: true),
      Timezone(FastOffset('+01:00', 3600), abbreviation: 'MET', dst: false),
  ...
  /// The `MST` location.
  static Location get mst => Location(
    'MST',
    [], 
    const [
    ],
  ...
  /// The `MST7MDT` location.
  static Location get mst7mdt => Location(
    'MST7MDT',
    ...
    const [
      Timezone(FastOffset('-06:00', -21600), abbreviation: 'MDT', dst: true),
      Timezone(FastOffset('-07:00', -25200), abbreviation: 'MST', dst: false),
      Timezone(FastOffset('-06:00', -21600), abbreviation: 'MDT', dst: true),
      Timezone(FastOffset('-07:00', -25200), abbreviation: 'MST', dst: false),
      Timezone(FastOffset('-06:00', -21600), abbreviation: 'MWT', dst: true),
      Timezone(FastOffset('-06:00', -21600), abbreviation: 'MPT', dst: true),
      Timezone(FastOffset('-07:00', -25200), abbreviation: 'MST', dst: false),
      Timezone(FastOffset('-06:00', -21600), abbreviation: 'MDT', dst: true),
      Timezone(FastOffset('-07:00', -25200), abbreviation: 'MST', dst: false),
      Timezone(FastOffset('-06:00', -21600), abbreviation: 'MDT', dst: true),
  ...
  /// The `Navajo` location.
  static Location get navajo => Location(
    'Navajo',
  ...
  /// The `NZ` location.
  static Location get nz => Location(
    'NZ',
  ...
  /// The `NZ-CHAT` location.
  static Location get nzChat => Location(
    'NZ-CHAT',
  ...
  /// The `Poland` location.
  static Location get poland => Location(
    'Poland',
    ...
    const [
      Timezone(FastOffset('+01:24', 5040), abbreviation: 'WMT', dst: false),
      Timezone(FastOffset('+01:00', 3600), abbreviation: 'CET', dst: false),
      Timezone(FastOffset('+02:00', 7200), abbreviation: 'CEST', dst: true),
      Timezone(FastOffset('+01:00', 3600), abbreviation: 'CET', dst: false),
      Timezone(FastOffset('+02:00', 7200), abbreviation: 'CEST', dst: true),
  ...
  /// The `Portugal` location.
  static Location get portugal => Location(
    'Portugal',
    ...
    const [
      Timezone(FastOffset('Z', 0), abbreviation: 'WET', dst: false),
      Timezone(FastOffset('+01:00', 3600), abbreviation: 'WEST', dst: true),
      Timezone(FastOffset('Z', 0), abbreviation: 'WET', dst: false),
      Timezone(FastOffset('+01:00', 3600), abbreviation: 'WEST', dst: true),
      Timezone(FastOffset('Z', 0), abbreviation: 'WET', dst: false),
      Timezone(FastOffset('+01:00', 3600), abbreviation: 'WEST', dst: true),
      ...
      Timezone(FastOffset('Z', 0), abbreviation: 'WET', dst: false),
      Timezone(FastOffset('+01:00', 3600), abbreviation: 'WEST', dst: true),
      Timezone(FastOffset('+02:00', 7200), abbreviation: 'WEMT', dst: true),
      Timezone(FastOffset('+01:00', 3600), abbreviation: 'WEST', dst: true),
      Timezone(FastOffset('Z', 0), abbreviation: 'WET', dst: false),
      Timezone(FastOffset('+01:00', 3600), abbreviation: 'WEST', dst: true),
      Timezone(FastOffset('+02:00', 7200), abbreviation: 'WEMT', dst: true),
  ...
  /// The `PRC` location.
  static Location get prc => Location(
    'PRC',
  ...
  /// The `PST8PDT` location.
  static Location get pst8pdt => Location(
    'PST8PDT',
    ...
    const [
      Timezone(FastOffset('-07:00', -25200), abbreviation: 'PDT', dst: true),
      Timezone(FastOffset('-08:00', -28800), abbreviation: 'PST', dst: false),
      Timezone(FastOffset('-07:00', -25200), abbreviation: 'PDT', dst: true),
      Timezone(FastOffset('-08:00', -28800), abbreviation: 'PST', dst: false),
      Timezone(FastOffset('-07:00', -25200), abbreviation: 'PWT', dst: true),
      Timezone(FastOffset('-07:00', -25200), abbreviation: 'PPT', dst: true),
      Timezone(FastOffset('-08:00', -28800), abbreviation: 'PST', dst: false),
      Timezone(FastOffset('-07:00', -25200), abbreviation: 'PDT', dst: true),
      Timezone(FastOffset('-08:00', -28800), abbreviation: 'PST', dst: false),
      Timezone(FastOffset('-07:00', -25200), abbreviation: 'PDT', dst: true),
  ...
  /// The `ROC` location.
  static Location get roc => Location(
    'ROC',
  ...
  /// The `ROK` location.
  static Location get rok => Location(
    'ROK',
  ...
  static Location get singapore => Location(
    'Singapore',
  ...
  /// The `Turkey` location.
  static Location get turkey => Location(
    'Turkey',
  ...
  /// The `UCT` location.
  static Location get uct => Location(
    'UCT',
    [], 
    const [
    ],
  ...
  static Location get universal => Location(
    'Universal',
    [], 
    const [
    ],
  ...
  /// The `UTC` location.
  static Location get utc => Location(
    'UTC',
    [], 
    const [
    ],
  ...
  /// The `W-SU` location.
  static Location get wSu => Location(
    'W-SU',
    ...
    const [
      Timezone(FastOffset('+02:30:17', 9017), abbreviation: 'MMT', dst: false),
      Timezone(FastOffset('+02:31:19', 9079), abbreviation: 'MMT', dst: false),
      Timezone(FastOffset('+03:31:19', 12679), abbreviation: 'MST', dst: true),
      Timezone(FastOffset('+02:31:19', 9079), abbreviation: 'MMT', dst: false),
      Timezone(FastOffset('+04:31:19', 16279), abbreviation: 'MDST', dst: true),
      Timezone(FastOffset('+03:31:19', 12679), abbreviation: 'MST', dst: true),
      Timezone(FastOffset('+04:31:19', 16279), abbreviation: 'MDST', dst: true),
      Timezone(FastOffset('+04:00', 14400), abbreviation: 'MSD', dst: true),
      Timezone(FastOffset('+03:00', 10800), abbreviation: 'MSK', dst: false),
      Timezone(FastOffset('+04:00', 14400), abbreviation: 'MSD', dst: true),
      Timezone(FastOffset('+05:00', 18000), abbreviation: '+05', dst: true),
      Timezone(FastOffset('+04:00', 14400), abbreviation: 'MSD', dst: true),
      Timezone(FastOffset('+03:00', 10800), abbreviation: 'MSK', dst: false),
      ...
      Timezone(FastOffset('+04:00', 14400), abbreviation: 'MSD', dst: true),
      Timezone(FastOffset('+03:00', 10800), abbreviation: 'MSK', dst: false),
      Timezone(FastOffset('+04:00', 14400), abbreviation: 'MSK', dst: false),
      Timezone(FastOffset('+03:00', 10800), abbreviation: 'MSK', dst: false),
    ],
  );

  /// The `WET` location.
  static Location get wet => Location(
    'WET',
    [228877200, 243997200, 260326800, 276051600, 291776400, 307501200, 323830800, 338950800, 354675600, 370400400, 386125200, 401850000, 417574800, 433299600, 449024400, 465354000, 481078800, 496803600, 512528400, 528253200, 543978000, 559702800, 575427600, 591152400, 606877200, 622602000, 638326800, 654656400, 670381200, 686106000, 701830800, 717555600, 733280400, 749005200, 764730000, 780454800, 796179600, 811904400, 828234000, 846378000, 859683600, 877827600, 891133200, 909277200, 922582800, 941331600, 954032400, 972781200, 985482000, 1004230800, 1017536400, 1035680400, 1048986000, 1067130000, 1080435600, 1099184400, 1111885200, 1130634000, 1143334800, 1162083600, 1174784400, 1193533200, 1206838800, 1224982800, 1238288400, 1256432400, 1269738000, 1288486800, 1301187600, 1319936400, 1332637200, 1351386000, 1364691600, 1382835600, 1396141200, 1414285200, 1427590800, 1445734800, 1459040400, 1477789200, 1490490000, 1509238800, 1521939600, 1540688400, 1553994000, 1572138000, 1585443600, 1603587600, 1616893200, 1635642000, 1648342800, 1667091600, 1679792400, 1698541200, 1711846800, 1729990800, 1743296400, 1761440400, 1774746000, 1792890000, 1806195600, 1824944400, 1837645200, 1856394000, 1869094800, 1887843600, 1901149200, 1919293200, 1932598800, 1950742800, 1964048400, 1982797200, 1995498000, 2014246800, 2026947600, 2045696400, 2058397200, 2077146000, 2090451600, 2108595600, 2121901200, 2140045200], 
    const [
      Timezone(FastOffset('+01:00', 3600), abbreviation: 'WEST', dst: true),
  ...
  /// The `Zulu` location.
  static Location get zulu => Location(
    'Zulu',
    [], 
    const [
    ],
