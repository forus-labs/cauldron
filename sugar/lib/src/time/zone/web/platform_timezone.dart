import 'package:sugar/src/time/zone/web/web_timezone.dart';
...
/// Although most modern browser implement it, some obsolete browsers, i.e. IE 11 does not. `Factory` will be returned on
/// a best-effort basis on unsupported/obsolete browsers.
///
