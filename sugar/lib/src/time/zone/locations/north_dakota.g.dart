...
/// A namespace that contains [Location]s and nested namespaces in `North_Dakota`.
/// 
...
class NorthDakota {
  ...
  /// A [Location] that represents `America/North_Dakota/Beulah`.
  Location get beulah => NorthDakota._beulah;

  /// A [Location] that represents `America/North_Dakota/Center`.
  Location get center => NorthDakota._center;

  /// A [Location] that represents `America/North_Dakota/New_Salem`.
  Location get newSalem => NorthDakota._newSalem;


  static final Location _beulah = Location(
  ...
  static final Location _center = Location(
  ...
  static final Location _newSalem = Location(
