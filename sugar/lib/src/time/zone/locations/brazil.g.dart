...
/// A namespace that contains [Location]s and nested namespaces in `Brazil`.
/// 
...
class Brazil {
  ...
  /// A [Location] that represents `Brazil/Acre`.
  Location get acre => Brazil._acre;

  /// A [Location] that represents `Brazil/DeNoronha`.
  Location get deNoronha => Brazil._deNoronha;

  /// A [Location] that represents `Brazil/East`.
  Location get east => Brazil._east;

  /// A [Location] that represents `Brazil/West`.
  Location get west => Brazil._west;


  static final Location _acre = Location(
    'Brazil/Acre',
  ...
  static final Location _deNoronha = Location(
    'Brazil/DeNoronha',
  ...
  static final Location _east = Location(
    'Brazil/East',
