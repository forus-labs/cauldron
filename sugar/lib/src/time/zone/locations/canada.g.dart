...
/// A namespace that contains [Location]s and nested namespaces in `Canada`.
/// 
...
class Canada {
  ...
  /// A [Location] that represents `Canada/Atlantic`.
  Location get atlantic => Canada._atlantic;

  /// A [Location] that represents `Canada/Central`.
  Location get central => Canada._central;

  /// A [Location] that represents `Canada/Eastern`.
  Location get eastern => Canada._eastern;

  /// A [Location] that represents `Canada/Mountain`.
  Location get mountain => Canada._mountain;

  /// A [Location] that represents `Canada/Newfoundland`.
  Location get newfoundland => Canada._newfoundland;

  /// A [Location] that represents `Canada/Pacific`.
  Location get pacific => Canada._pacific;

  /// A [Location] that represents `Canada/Saskatchewan`.
  Location get saskatchewan => Canada._saskatchewan;

  /// A [Location] that represents `Canada/Yukon`.
  Location get yukon => Canada._yukon;


  static final Location _atlantic = Location(
    'Canada/Atlantic',
    ...
    const [
      ...
      Timezone(RawOffset('-03:00', -10800), abbreviation: 'ADT', dst: true),
      Timezone(RawOffset('-04:00', -14400), abbreviation: 'AST', dst: false),
      Timezone(RawOffset('-03:00', -10800), abbreviation: 'AWT', dst: true),
      Timezone(RawOffset('-03:00', -10800), abbreviation: 'APT', dst: true),
      Timezone(RawOffset('-04:00', -14400), abbreviation: 'AST', dst: false),
      Timezone(RawOffset('-03:00', -10800), abbreviation: 'ADT', dst: true),
      Timezone(RawOffset('-04:00', -14400), abbreviation: 'AST', dst: false),
      Timezone(RawOffset('-03:00', -10800), abbreviation: 'ADT', dst: true),
  ...
  static final Location _newfoundland = Location(
    'Canada/Newfoundland',
    ...
    const [
      Timezone(RawOffset('-03:30:52', -12652), abbreviation: 'NST', dst: false),
      Timezone(RawOffset('-02:30:52', -9052), abbreviation: 'NDT', dst: true),
      Timezone(RawOffset('-03:30:52', -12652), abbreviation: 'NST', dst: false),
      Timezone(RawOffset('-02:30:52', -9052), abbreviation: 'NDT', dst: true),
      Timezone(RawOffset('-03:30:52', -12652), abbreviation: 'NST', dst: false),
      Timezone(RawOffset('-02:30:52', -9052), abbreviation: 'NDT', dst: true),
      ...
      Timezone(RawOffset('-02:30:52', -9052), abbreviation: 'NDT', dst: true),
      Timezone(RawOffset('-03:30:52', -12652), abbreviation: 'NST', dst: false),
      Timezone(RawOffset('-03:30', -12600), abbreviation: 'NST', dst: false),
      Timezone(RawOffset('-02:30', -9000), abbreviation: 'NDT', dst: true),
      Timezone(RawOffset('-03:30', -12600), abbreviation: 'NST', dst: false),
      Timezone(RawOffset('-02:30', -9000), abbreviation: 'NDT', dst: true),
      Timezone(RawOffset('-03:30', -12600), abbreviation: 'NST', dst: false),
      Timezone(RawOffset('-02:30', -9000), abbreviation: 'NDT', dst: true),
      ...
      Timezone(RawOffset('-02:30', -9000), abbreviation: 'NDT', dst: true),
      Timezone(RawOffset('-03:30', -12600), abbreviation: 'NST', dst: false),
      Timezone(RawOffset('-02:30', -9000), abbreviation: 'NWT', dst: true),
      Timezone(RawOffset('-02:30', -9000), abbreviation: 'NPT', dst: true),
      Timezone(RawOffset('-03:30', -12600), abbreviation: 'NST', dst: false),
      Timezone(RawOffset('-02:30', -9000), abbreviation: 'NDT', dst: true),
      Timezone(RawOffset('-03:30', -12600), abbreviation: 'NST', dst: false),
      Timezone(RawOffset('-02:30', -9000), abbreviation: 'NDT', dst: true),
      ...
      Timezone(RawOffset('-02:30', -9000), abbreviation: 'NDT', dst: true),
      Timezone(RawOffset('-03:30', -12600), abbreviation: 'NST', dst: false),
      Timezone(RawOffset('-01:30', -5400), abbreviation: 'NDDT', dst: true),
      Timezone(RawOffset('-03:30', -12600), abbreviation: 'NST', dst: false),
      Timezone(RawOffset('-02:30', -9000), abbreviation: 'NDT', dst: true),
      Timezone(RawOffset('-03:30', -12600), abbreviation: 'NST', dst: false),
      Timezone(RawOffset('-02:30', -9000), abbreviation: 'NDT', dst: true),
  ...
  static final Location _saskatchewan = Location(
    'Canada/Saskatchewan',
  ...
  static final Location _yukon = Location(
    'Canada/Yukon',
    ...
    const [
      ...
      Timezone(RawOffset('-08:00', -28800), abbreviation: 'YDT', dst: true),
      Timezone(RawOffset('-09:00', -32400), abbreviation: 'YST', dst: false),
      Timezone(RawOffset('-08:00', -28800), abbreviation: 'YDT', dst: true),
      Timezone(RawOffset('-09:00', -32400), abbreviation: 'YST', dst: false),
      Timezone(RawOffset('-08:00', -28800), abbreviation: 'YWT', dst: true),
      Timezone(RawOffset('-08:00', -28800), abbreviation: 'YPT', dst: true),
      Timezone(RawOffset('-09:00', -32400), abbreviation: 'YST', dst: false),
      Timezone(RawOffset('-07:00', -25200), abbreviation: 'YDDT', dst: true),
      Timezone(RawOffset('-09:00', -32400), abbreviation: 'YST', dst: false),
      Timezone(RawOffset('-08:00', -28800), abbreviation: 'PST', dst: false),
      Timezone(RawOffset('-07:00', -25200), abbreviation: 'PDT', dst: true),
      Timezone(RawOffset('-08:00', -28800), abbreviation: 'PST', dst: false),
