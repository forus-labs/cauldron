...
/// A namespace that contains [Location]s and nested namespaces in `Atlantic`.
/// 
...
class Atlantic {
  ...
  /// A [Location] that represents `Atlantic/Azores`.
  Location get azores => Atlantic._azores;

  /// A [Location] that represents `Atlantic/Bermuda`.
  Location get bermuda => Atlantic._bermuda;

  /// A [Location] that represents `Atlantic/Canary`.
  Location get canary => Atlantic._canary;

  /// A [Location] that represents `Atlantic/Cape_Verde`.
  Location get capeVerde => Atlantic._capeVerde;

  /// A [Location] that represents `Atlantic/Faeroe`.
  Location get faeroe => Atlantic._faeroe;

  /// A [Location] that represents `Atlantic/Faroe`.
  Location get faroe => Atlantic._faroe;

  /// A [Location] that represents `Atlantic/Jan_Mayen`.
  Location get janMayen => Atlantic._janMayen;

  /// A [Location] that represents `Atlantic/Madeira`.
  Location get madeira => Atlantic._madeira;

  /// A [Location] that represents `Atlantic/Reykjavik`.
  Location get reykjavik => Atlantic._reykjavik;

  /// A [Location] that represents `Atlantic/South_Georgia`.
  Location get southGeorgia => Atlantic._southGeorgia;

  /// A [Location] that represents `Atlantic/St_Helena`.
  Location get stHelena => Atlantic._stHelena;

  /// A [Location] that represents `Atlantic/Stanley`.
  Location get stanley => Atlantic._stanley;


  static final Location _azores = Location(
    'Atlantic/Azores',
    ...
    const [
      Timezone(RawOffset('-01:54:32', -6872), abbreviation: 'HMT', dst: false),
  ...
  static final Location _bermuda = Location(
    'Atlantic/Bermuda',
    ...
    const [
      Timezone(RawOffset('-04:19:18', -15558), abbreviation: 'BMT', dst: false),
      Timezone(RawOffset('-03:19:18', -11958), abbreviation: 'BST', dst: true),
      Timezone(RawOffset('-04:19:18', -15558), abbreviation: 'BMT', dst: false),
      Timezone(RawOffset('-03:19:18', -11958), abbreviation: 'BST', dst: true),
      Timezone(RawOffset('-04:19:18', -15558), abbreviation: 'BMT', dst: false),
      Timezone(RawOffset('-04:00', -14400), abbreviation: 'AST', dst: false),
      Timezone(RawOffset('-03:00', -10800), abbreviation: 'ADT', dst: true),
      Timezone(RawOffset('-04:00', -14400), abbreviation: 'AST', dst: false),
      Timezone(RawOffset('-03:00', -10800), abbreviation: 'ADT', dst: true),
      Timezone(RawOffset('-04:00', -14400), abbreviation: 'AST', dst: false),
      Timezone(RawOffset('-03:00', -10800), abbreviation: 'ADT', dst: true),
  ...
  static final Location _canary = Location(
    'Atlantic/Canary',
  ...
  static final Location _capeVerde = Location(
    'Atlantic/Cape_Verde',
  ...
  static final Location _faeroe = Location(
    'Atlantic/Faeroe',
  ...
  static final Location _faroe = Location(
    'Atlantic/Faroe',
    [-1955748776, 354675600, 370400400, 386125200, 401850000, 417574800, 433299600, 449024400, 465354000, 481078800, 496803600, 512528400, 528253200, 543978000, 559702800, 575427600, 591152400, 606877200, 622602000, 638326800, 654656400, 670381200, 686106000, 701830800, 717555600, 733280400, 749005200, 764730000, 780454800, 796179600, 811904400, 828234000, 846378000, 859683600, 877827600, 891133200, 909277200, 922582800, 941331600, 954032400, 972781200, 985482000, 1004230800, 1017536400, 1035680400, 1048986000, 1067130000, 1080435600, 1099184400, 1111885200, 1130634000, 1143334800, 1162083600, 1174784400, 1193533200, 1206838800, 1224982800, 1238288400, 1256432400, 1269738000, 1288486800, 1301187600, 1319936400, 1332637200, 1351386000, 1364691600, 1382835600, 1396141200, 1414285200, 1427590800, 1445734800, 1459040400, 1477789200, 1490490000, 1509238800, 1521939600, 1540688400, 1553994000, 1572138000, 1585443600, 1603587600, 1616893200, 1635642000, 1648342800, 1667091600, 1679792400, 1698541200, 1711846800, 1729990800, 1743296400, 1761440400, 1774746000, 1792890000, 1806195600, 1824944400, 1837645200, 1856394000, 1869094800, 1887843600, 1901149200, 1919293200, 1932598800, 1950742800, 1964048400, 1982797200, 1995498000, 2014246800, 2026947600, 2045696400, 2058397200, 2077146000, 2090451600, 2108595600, 2121901200, 2140045200],
    const [
      Timezone(RawOffset('Z', 0), abbreviation: 'WET', dst: false),
  ...
  static final Location _janMayen = Location(
    'Atlantic/Jan_Mayen',
  ...
  static final Location _madeira = Location(
    'Atlantic/Madeira',
    ...
    const [
      Timezone(RawOffset('-01:07:36', -4056), abbreviation: 'FMT', dst: false),
      Timezone(RawOffset('-01:00', -3600), abbreviation: '-01', dst: false),
      Timezone(RawOffset('Z', 0), abbreviation: '+00', dst: true),
      Timezone(RawOffset('-01:00', -3600), abbreviation: '-01', dst: false),
      Timezone(RawOffset('Z', 0), abbreviation: '+00', dst: true),
  ...
  static final Location _reykjavik = Location(
    'Atlantic/Reykjavik',
    [-1830383032],
    const [
  ...
  static final Location _southGeorgia = Location(
  ...
  static final Location _stHelena = Location(
    'Atlantic/St_Helena',
    [-1830383032],
    const [
      Timezone(RawOffset('Z', 0), abbreviation: 'GMT', dst: false),
  ...
  static final Location _stanley = Location(
    'Atlantic/Stanley',
    ...
    const [
      Timezone(RawOffset('-03:51:24', -13884), abbreviation: 'SMT', dst: false),
