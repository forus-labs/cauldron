...
/// A namespace that contains [Location]s and nested namespaces in `Chile`.
/// 
...
class Chile {
  ...
  /// A [Location] that represents `Chile/Continental`.
  Location get continental => Chile._continental;

  /// A [Location] that represents `Chile/EasterIsland`.
  Location get easterIsland => Chile._easterIsland;


  static final Location _continental = Location(
    'Chile/Continental',
    ...
    const [
      Timezone(RawOffset('-04:42:45', -16965), abbreviation: 'SMT', dst: false),
  ...
  static final Location _easterIsland = Location(
    'Chile/EasterIsland',
