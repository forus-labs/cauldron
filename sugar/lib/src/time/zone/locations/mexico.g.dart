...
/// A namespace that contains [Location]s and nested namespaces in `Mexico`.
/// 
...
class Mexico {
  ...
  /// A [Location] that represents `Mexico/BajaNorte`.
  Location get bajaNorte => Mexico._bajaNorte;

  /// A [Location] that represents `Mexico/BajaSur`.
  Location get bajaSur => Mexico._bajaSur;

  /// A [Location] that represents `Mexico/General`.
  Location get general => Mexico._general;


  static final Location _bajaNorte = Location(
    'Mexico/BajaNorte',
  ...
  static final Location _bajaSur = Location(
    'Mexico/BajaSur',
  ...
  static final Location _general = Location(
    'Mexico/General',
