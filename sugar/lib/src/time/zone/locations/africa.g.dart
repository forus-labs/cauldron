...
/// A namespace that contains [Location]s and nested namespaces in `Africa`.
/// 
...
class Africa {
  ...
  /// A [Location] that represents `Africa/Abidjan`.
  Location get abidjan => Africa._abidjan;

  /// A [Location] that represents `Africa/Accra`.
  Location get accra => Africa._accra;

  /// A [Location] that represents `Africa/Addis_Ababa`.
  Location get addisAbaba => Africa._addisAbaba;

  /// A [Location] that represents `Africa/Algiers`.
  Location get algiers => Africa._algiers;

  /// A [Location] that represents `Africa/Asmara`.
  Location get asmara => Africa._asmara;

  /// A [Location] that represents `Africa/Asmera`.
  Location get asmera => Africa._asmera;

  /// A [Location] that represents `Africa/Bamako`.
  Location get bamako => Africa._bamako;

  /// A [Location] that represents `Africa/Bangui`.
  Location get bangui => Africa._bangui;

  /// A [Location] that represents `Africa/Banjul`.
  Location get banjul => Africa._banjul;

  /// A [Location] that represents `Africa/Bissau`.
  Location get bissau => Africa._bissau;

  /// A [Location] that represents `Africa/Blantyre`.
  Location get blantyre => Africa._blantyre;

  /// A [Location] that represents `Africa/Brazzaville`.
  Location get brazzaville => Africa._brazzaville;

  /// A [Location] that represents `Africa/Bujumbura`.
  Location get bujumbura => Africa._bujumbura;

  /// A [Location] that represents `Africa/Cairo`.
  Location get cairo => Africa._cairo;

  /// A [Location] that represents `Africa/Casablanca`.
  Location get casablanca => Africa._casablanca;

  /// A [Location] that represents `Africa/Ceuta`.
  Location get ceuta => Africa._ceuta;

  /// A [Location] that represents `Africa/Conakry`.
  Location get conakry => Africa._conakry;

  /// A [Location] that represents `Africa/Dakar`.
  Location get dakar => Africa._dakar;

  /// A [Location] that represents `Africa/Dar_es_Salaam`.
  Location get darEsSalaam => Africa._darEsSalaam;

  /// A [Location] that represents `Africa/Djibouti`.
  Location get djibouti => Africa._djibouti;

  /// A [Location] that represents `Africa/Douala`.
  Location get douala => Africa._douala;

  /// A [Location] that represents `Africa/El_Aaiun`.
  Location get elAaiun => Africa._elAaiun;

  /// A [Location] that represents `Africa/Freetown`.
  Location get freetown => Africa._freetown;

  /// A [Location] that represents `Africa/Gaborone`.
  Location get gaborone => Africa._gaborone;

  /// A [Location] that represents `Africa/Harare`.
  Location get harare => Africa._harare;

  /// A [Location] that represents `Africa/Johannesburg`.
  Location get johannesburg => Africa._johannesburg;

  /// A [Location] that represents `Africa/Juba`.
  Location get juba => Africa._juba;

  /// A [Location] that represents `Africa/Kampala`.
  Location get kampala => Africa._kampala;

  /// A [Location] that represents `Africa/Khartoum`.
  Location get khartoum => Africa._khartoum;

  /// A [Location] that represents `Africa/Kigali`.
  Location get kigali => Africa._kigali;

  /// A [Location] that represents `Africa/Kinshasa`.
  Location get kinshasa => Africa._kinshasa;

  /// A [Location] that represents `Africa/Lagos`.
  Location get lagos => Africa._lagos;

  /// A [Location] that represents `Africa/Libreville`.
  Location get libreville => Africa._libreville;

  /// A [Location] that represents `Africa/Lome`.
  Location get lome => Africa._lome;

  /// A [Location] that represents `Africa/Luanda`.
  Location get luanda => Africa._luanda;

  /// A [Location] that represents `Africa/Lubumbashi`.
  Location get lubumbashi => Africa._lubumbashi;

  /// A [Location] that represents `Africa/Lusaka`.
  Location get lusaka => Africa._lusaka;

  /// A [Location] that represents `Africa/Malabo`.
  Location get malabo => Africa._malabo;

  /// A [Location] that represents `Africa/Maputo`.
  Location get maputo => Africa._maputo;

  /// A [Location] that represents `Africa/Maseru`.
  Location get maseru => Africa._maseru;

  /// A [Location] that represents `Africa/Mbabane`.
  Location get mbabane => Africa._mbabane;

  /// A [Location] that represents `Africa/Mogadishu`.
  Location get mogadishu => Africa._mogadishu;

  /// A [Location] that represents `Africa/Monrovia`.
  Location get monrovia => Africa._monrovia;

  /// A [Location] that represents `Africa/Nairobi`.
  Location get nairobi => Africa._nairobi;

  /// A [Location] that represents `Africa/Ndjamena`.
  Location get ndjamena => Africa._ndjamena;

  /// A [Location] that represents `Africa/Niamey`.
  Location get niamey => Africa._niamey;

  /// A [Location] that represents `Africa/Nouakchott`.
  Location get nouakchott => Africa._nouakchott;

  /// A [Location] that represents `Africa/Ouagadougou`.
  Location get ouagadougou => Africa._ouagadougou;

  /// A [Location] that represents `Africa/Porto-Novo`.
  Location get portoNovo => Africa._portoNovo;

  /// A [Location] that represents `Africa/Sao_Tome`.
  Location get saoTome => Africa._saoTome;

  /// A [Location] that represents `Africa/Timbuktu`.
  Location get timbuktu => Africa._timbuktu;

  /// A [Location] that represents `Africa/Tripoli`.
  Location get tripoli => Africa._tripoli;

  /// A [Location] that represents `Africa/Tunis`.
  Location get tunis => Africa._tunis;

  /// A [Location] that represents `Africa/Windhoek`.
  Location get windhoek => Africa._windhoek;


  static final Location _abidjan = Location(
    'Africa/Abidjan',
    [-1830383032],
    const [
  ...
  static final Location _accra = Location(
    'Africa/Accra',
    [-1830383032],
    const [
      Timezone(RawOffset('Z', 0), abbreviation: 'GMT', dst: false),
  ...
  static final Location _addisAbaba = Location(
    'Africa/Addis_Ababa',
  ...
  static final Location _algiers = Location(
    'Africa/Algiers',
  ...
  static final Location _asmara = Location(
    'Africa/Asmara',
    [-1946168836, -1309746600, -1261969200, -1041388200, -865305900],
    const [
      Timezone(RawOffset('+02:30', 9000), abbreviation: '+0230', dst: false),
  ...
  static final Location _asmera = Location(
    'Africa/Asmera',
    [-1946168836, -1309746600, -1261969200, -1041388200, -865305900],
    const [
      Timezone(RawOffset('+02:30', 9000), abbreviation: '+0230', dst: false),
  ...
  static final Location _bamako = Location(
    'Africa/Bamako',
    [-1830383032],
    const [
      Timezone(RawOffset('Z', 0), abbreviation: 'GMT', dst: false),
  ...
  static final Location _bangui = Location(
    'Africa/Bangui',
    [-2035584815, -1940889600, -1767226415, -1588465800],
    const [
      Timezone(RawOffset('Z', 0), abbreviation: 'GMT', dst: false),
      Timezone(RawOffset('+00:13:35', 815), abbreviation: 'LMT', dst: false),
      Timezone(RawOffset('+00:30', 1800), abbreviation: '+0030', dst: false),
      Timezone(RawOffset('+01:00', 3600), abbreviation: 'WAT', dst: false),
    ],
  );

  static final Location _banjul = Location(
    'Africa/Banjul',
    [-1830383032],
    const [
      Timezone(RawOffset('Z', 0), abbreviation: 'GMT', dst: false),
  ...
  static final Location _bissau = Location(
    'Africa/Bissau',
    [-1830380400, 157770000],
    const [
      Timezone(RawOffset('-01:00', -3600), abbreviation: '-01', dst: false),
      Timezone(RawOffset('Z', 0), abbreviation: 'GMT', dst: false),
    ],
  );

  static final Location _blantyre = Location(
    'Africa/Blantyre',
    [-2109291020],
    const [
      Timezone(RawOffset('+02:00', 7200), abbreviation: 'CAT', dst: false),
    ],
  );

  static final Location _brazzaville = Location(
    'Africa/Brazzaville',
    [-2035584815, -1940889600, -1767226415, -1588465800],
    const [
      Timezone(RawOffset('Z', 0), abbreviation: 'GMT', dst: false),
  ...
  static final Location _bujumbura = Location(
    'Africa/Bujumbura',
    [-2109291020],
    const [
      Timezone(RawOffset('+02:00', 7200), abbreviation: 'CAT', dst: false),
  ...
  static final Location _cairo = Location(
    'Africa/Cairo',
  ...
  static final Location _casablanca = Location(
    'Africa/Casablanca',
    ...
    const [
      Timezone(RawOffset('Z', 0), abbreviation: '+00', dst: false),
      Timezone(RawOffset('+01:00', 3600), abbreviation: '+01', dst: true),
      Timezone(RawOffset('Z', 0), abbreviation: '+00', dst: false),
      Timezone(RawOffset('+01:00', 3600), abbreviation: '+01', dst: true),
      Timezone(RawOffset('Z', 0), abbreviation: '+00', dst: false),
      Timezone(RawOffset('+01:00', 3600), abbreviation: '+01', dst: true),
      ...
      Timezone(RawOffset('+01:00', 3600), abbreviation: '+01', dst: true),
      Timezone(RawOffset('+01:00', 3600), abbreviation: '+01', dst: false),
      Timezone(RawOffset('Z', 0), abbreviation: '+00', dst: true),
      Timezone(RawOffset('+01:00', 3600), abbreviation: '+01', dst: false),
      Timezone(RawOffset('Z', 0), abbreviation: '+00', dst: true),
      Timezone(RawOffset('+01:00', 3600), abbreviation: '+01', dst: false),
      Timezone(RawOffset('Z', 0), abbreviation: '+00', dst: true),
  ...
  static final Location _ceuta = Location(
    'Africa/Ceuta',
  ...
  static final Location _conakry = Location(
    'Africa/Conakry',
    [-1830383032],
    const [
      Timezone(RawOffset('Z', 0), abbreviation: 'GMT', dst: false),
  ...
  static final Location _dakar = Location(
    'Africa/Dakar',
    [-1830383032],
    const [
      Timezone(RawOffset('Z', 0), abbreviation: 'GMT', dst: false),
  ...
  static final Location _darEsSalaam = Location(
  ...
  static final Location _djibouti = Location(
    'Africa/Djibouti',
    [-1946168836, -1309746600, -1261969200, -1041388200, -865305900],
    const [
      Timezone(RawOffset('+02:30', 9000), abbreviation: '+0230', dst: false),
  ...
  static final Location _douala = Location(
    'Africa/Douala',
    [-2035584815, -1940889600, -1767226415, -1588465800],
    const [
      Timezone(RawOffset('Z', 0), abbreviation: 'GMT', dst: false),
  ...
  static final Location _elAaiun = Location(
    'Africa/El_Aaiun',
  ...
  static final Location _freetown = Location(
    'Africa/Freetown',
    [-1830383032],
    const [
      Timezone(RawOffset('Z', 0), abbreviation: 'GMT', dst: false),
  ...
  static final Location _gaborone = Location(
    'Africa/Gaborone',
    [-2109291020],
    const [
      Timezone(RawOffset('+02:00', 7200), abbreviation: 'CAT', dst: false),
  ...
  static final Location _harare = Location(
    'Africa/Harare',
    [-2109291020],
    const [
      Timezone(RawOffset('+02:00', 7200), abbreviation: 'CAT', dst: false),
  ...
  static final Location _johannesburg = Location(
    'Africa/Johannesburg',
    [-2458173120, -2109288600, -860976000, -845254800, -829526400, -813805200],
    const [
      Timezone(RawOffset('+01:30', 5400), abbreviation: 'SAST', dst: false),
      Timezone(RawOffset('+02:00', 7200), abbreviation: 'SAST', dst: false),
      Timezone(RawOffset('+03:00', 10800), abbreviation: 'SAST', dst: true),
      Timezone(RawOffset('+02:00', 7200), abbreviation: 'SAST', dst: false),
      Timezone(RawOffset('+03:00', 10800), abbreviation: 'SAST', dst: true),
      Timezone(RawOffset('+02:00', 7200), abbreviation: 'SAST', dst: false),
    ],
  ...
  static final Location _juba = Location(
    'Africa/Juba',
    ...
    const [
      Timezone(RawOffset('+02:00', 7200), abbreviation: 'CAT', dst: false),
      Timezone(RawOffset('+03:00', 10800), abbreviation: 'CAST', dst: true),
      Timezone(RawOffset('+02:00', 7200), abbreviation: 'CAT', dst: false),
      Timezone(RawOffset('+03:00', 10800), abbreviation: 'CAST', dst: true),
      Timezone(RawOffset('+02:00', 7200), abbreviation: 'CAT', dst: false),
      Timezone(RawOffset('+03:00', 10800), abbreviation: 'CAST', dst: true),
  ...
  static final Location _kampala = Location(
    'Africa/Kampala',
    [-1946168836, -1309746600, -1261969200, -1041388200, -865305900],
    const [
      Timezone(RawOffset('+02:30', 9000), abbreviation: '+0230', dst: false),
  ...
  static final Location _khartoum = Location(
    'Africa/Khartoum',
  ...
  static final Location _kigali = Location(
    'Africa/Kigali',
    [-2109291020],
    const [
      Timezone(RawOffset('+02:00', 7200), abbreviation: 'CAT', dst: false),
  ...
  static final Location _kinshasa = Location(
    'Africa/Kinshasa',
    [-2035584815, -1940889600, -1767226415, -1588465800],
    const [
      Timezone(RawOffset('Z', 0), abbreviation: 'GMT', dst: false),
  ...
  static final Location _lagos = Location(
    'Africa/Lagos',
    [-2035584815, -1940889600, -1767226415, -1588465800],
    const [
      Timezone(RawOffset('Z', 0), abbreviation: 'GMT', dst: false),
  ...
  static final Location _libreville = Location(
    'Africa/Libreville',
    [-2035584815, -1940889600, -1767226415, -1588465800],
    const [
      Timezone(RawOffset('Z', 0), abbreviation: 'GMT', dst: false),
  ...
  static final Location _lome = Location(
    'Africa/Lome',
    [-1830383032],
    const [
      Timezone(RawOffset('Z', 0), abbreviation: 'GMT', dst: false),
  ...
  static final Location _luanda = Location(
    'Africa/Luanda',
    [-2035584815, -1940889600, -1767226415, -1588465800],
    const [
      Timezone(RawOffset('Z', 0), abbreviation: 'GMT', dst: false),
  ...
  static final Location _lubumbashi = Location(
    'Africa/Lubumbashi',
    [-2109291020],
    const [
      Timezone(RawOffset('+02:00', 7200), abbreviation: 'CAT', dst: false),
  ...
  static final Location _lusaka = Location(
    'Africa/Lusaka',
    [-2109291020],
    const [
      Timezone(RawOffset('+02:00', 7200), abbreviation: 'CAT', dst: false),
  ...
  static final Location _malabo = Location(
    'Africa/Malabo',
    [-2035584815, -1940889600, -1767226415, -1588465800],
    const [
      Timezone(RawOffset('Z', 0), abbreviation: 'GMT', dst: false),
  ...
  static final Location _maputo = Location(
    'Africa/Maputo',
    [-2109291020],
    const [
      Timezone(RawOffset('+02:00', 7200), abbreviation: 'CAT', dst: false),
  ...
  static final Location _maseru = Location(
    'Africa/Maseru',
    [-2458173120, -2109288600, -860976000, -845254800, -829526400, -813805200],
    const [
      Timezone(RawOffset('+01:30', 5400), abbreviation: 'SAST', dst: false),
  ...
  static final Location _mbabane = Location(
    'Africa/Mbabane',
    [-2458173120, -2109288600, -860976000, -845254800, -829526400, -813805200],
    const [
      Timezone(RawOffset('+01:30', 5400), abbreviation: 'SAST', dst: false),
  ...
  static final Location _mogadishu = Location(
    'Africa/Mogadishu',
    [-1946168836, -1309746600, -1261969200, -1041388200, -865305900],
    const [
      Timezone(RawOffset('+02:30', 9000), abbreviation: '+0230', dst: false),
  ...
  static final Location _monrovia = Location(
    'Africa/Monrovia',
    [-2776979812, -1604359012, 63593070],
    const [
      Timezone(RawOffset('-00:43:08', -2588), abbreviation: 'MMT', dst: false),
      Timezone(RawOffset('-00:44:30', -2670), abbreviation: 'MMT', dst: false),
      Timezone(RawOffset('Z', 0), abbreviation: 'GMT', dst: false),
    ],
  );

  static final Location _nairobi = Location(
    'Africa/Nairobi',
    [-1946168836, -1309746600, -1261969200, -1041388200, -865305900],
    const [
      Timezone(RawOffset('+02:30', 9000), abbreviation: '+0230', dst: false),
  ...
  static final Location _ndjamena = Location(
    'Africa/Ndjamena',
    [-1830387612, 308703600, 321314400],
    const [
      Timezone(RawOffset('+01:00', 3600), abbreviation: 'WAT', dst: false),
      Timezone(RawOffset('+02:00', 7200), abbreviation: 'WAST', dst: true),
      Timezone(RawOffset('+01:00', 3600), abbreviation: 'WAT', dst: false),
    ],
  );

  static final Location _niamey = Location(
    'Africa/Niamey',
    [-2035584815, -1940889600, -1767226415, -1588465800],
    const [
      Timezone(RawOffset('Z', 0), abbreviation: 'GMT', dst: false),
  ...
  static final Location _nouakchott = Location(
    'Africa/Nouakchott',
    [-1830383032],
    const [
      Timezone(RawOffset('Z', 0), abbreviation: 'GMT', dst: false),
  ...
  static final Location _ouagadougou = Location(
    'Africa/Ouagadougou',
    [-1830383032],
    const [
      Timezone(RawOffset('Z', 0), abbreviation: 'GMT', dst: false),
  ...
  static final Location _portoNovo = Location(
    'Africa/Porto-Novo',
    [-2035584815, -1940889600, -1767226415, -1588465800],
    const [
      Timezone(RawOffset('Z', 0), abbreviation: 'GMT', dst: false),
  ...
  static final Location _saoTome = Location(
    'Africa/Sao_Tome',
    [-2713912016, -1830384000, 1514768400, 1546304400],
    const [
      Timezone(RawOffset('-00:36:45', -2205), abbreviation: 'LMT', dst: false),
      Timezone(RawOffset('Z', 0), abbreviation: 'GMT', dst: false),
      Timezone(RawOffset('+01:00', 3600), abbreviation: 'WAT', dst: false),
      Timezone(RawOffset('Z', 0), abbreviation: 'GMT', dst: false),
    ],
  ...
  static final Location _timbuktu = Location(
    'Africa/Timbuktu',
    [-1830383032],
    const [
      Timezone(RawOffset('Z', 0), abbreviation: 'GMT', dst: false),
  ...
  static final Location _tripoli = Location(
    'Africa/Tripoli',
  ...
  static final Location _tunis = Location(
    'Africa/Tunis',
  ...
  static final Location _windhoek = Location(
    'Africa/Windhoek',
    ...
    const [
      Timezone(RawOffset('+01:30', 5400), abbreviation: '+0130', dst: false),
      Timezone(RawOffset('+02:00', 7200), abbreviation: 'SAST', dst: false),
      Timezone(RawOffset('+03:00', 10800), abbreviation: 'SAST', dst: true),
      Timezone(RawOffset('+02:00', 7200), abbreviation: 'SAST', dst: false),
      Timezone(RawOffset('+02:00', 7200), abbreviation: 'CAT', dst: false),
      Timezone(RawOffset('+01:00', 3600), abbreviation: 'WAT', dst: true),
      Timezone(RawOffset('+02:00', 7200), abbreviation: 'CAT', dst: false),
      Timezone(RawOffset('+01:00', 3600), abbreviation: 'WAT', dst: true),
      Timezone(RawOffset('+02:00', 7200), abbreviation: 'CAT', dst: false),
      Timezone(RawOffset('+01:00', 3600), abbreviation: 'WAT', dst: true),
