...
/// A namespace that contains [Location]s and nested namespaces in `Pacific`.
/// 
...
class Pacific {
  ...
  /// A [Location] that represents `Pacific/Apia`.
  Location get apia => Pacific._apia;

  /// A [Location] that represents `Pacific/Auckland`.
  Location get auckland => Pacific._auckland;

  /// A [Location] that represents `Pacific/Bougainville`.
  Location get bougainville => Pacific._bougainville;

  /// A [Location] that represents `Pacific/Chatham`.
  Location get chatham => Pacific._chatham;

  /// A [Location] that represents `Pacific/Chuuk`.
  Location get chuuk => Pacific._chuuk;

  /// A [Location] that represents `Pacific/Easter`.
  Location get easter => Pacific._easter;

  /// A [Location] that represents `Pacific/Efate`.
  Location get efate => Pacific._efate;

  /// A [Location] that represents `Pacific/Enderbury`.
  Location get enderbury => Pacific._enderbury;

  /// A [Location] that represents `Pacific/Fakaofo`.
  Location get fakaofo => Pacific._fakaofo;

  /// A [Location] that represents `Pacific/Fiji`.
  Location get fiji => Pacific._fiji;

  /// A [Location] that represents `Pacific/Funafuti`.
  Location get funafuti => Pacific._funafuti;

  /// A [Location] that represents `Pacific/Galapagos`.
  Location get galapagos => Pacific._galapagos;

  /// A [Location] that represents `Pacific/Gambier`.
  Location get gambier => Pacific._gambier;

  /// A [Location] that represents `Pacific/Guadalcanal`.
  Location get guadalcanal => Pacific._guadalcanal;

  /// A [Location] that represents `Pacific/Guam`.
  Location get guam => Pacific._guam;

  /// A [Location] that represents `Pacific/Honolulu`.
  Location get honolulu => Pacific._honolulu;

  /// A [Location] that represents `Pacific/Johnston`.
  Location get johnston => Pacific._johnston;

  /// A [Location] that represents `Pacific/Kanton`.
  Location get kanton => Pacific._kanton;

  /// A [Location] that represents `Pacific/Kiritimati`.
  Location get kiritimati => Pacific._kiritimati;

  /// A [Location] that represents `Pacific/Kosrae`.
  Location get kosrae => Pacific._kosrae;

  /// A [Location] that represents `Pacific/Kwajalein`.
  Location get kwajalein => Pacific._kwajalein;

  /// A [Location] that represents `Pacific/Majuro`.
  Location get majuro => Pacific._majuro;

  /// A [Location] that represents `Pacific/Marquesas`.
  Location get marquesas => Pacific._marquesas;

  /// A [Location] that represents `Pacific/Midway`.
  Location get midway => Pacific._midway;

  /// A [Location] that represents `Pacific/Nauru`.
  Location get nauru => Pacific._nauru;

  /// A [Location] that represents `Pacific/Niue`.
  Location get niue => Pacific._niue;

  /// A [Location] that represents `Pacific/Norfolk`.
  Location get norfolk => Pacific._norfolk;

  /// A [Location] that represents `Pacific/Noumea`.
  Location get noumea => Pacific._noumea;

  /// A [Location] that represents `Pacific/Pago_Pago`.
  Location get pagoPago => Pacific._pagoPago;

  /// A [Location] that represents `Pacific/Palau`.
  Location get palau => Pacific._palau;

  /// A [Location] that represents `Pacific/Pitcairn`.
  Location get pitcairn => Pacific._pitcairn;

  /// A [Location] that represents `Pacific/Pohnpei`.
  Location get pohnpei => Pacific._pohnpei;

  /// A [Location] that represents `Pacific/Ponape`.
  Location get ponape => Pacific._ponape;

  /// A [Location] that represents `Pacific/Port_Moresby`.
  Location get portMoresby => Pacific._portMoresby;

  /// A [Location] that represents `Pacific/Rarotonga`.
  Location get rarotonga => Pacific._rarotonga;

  /// A [Location] that represents `Pacific/Saipan`.
  Location get saipan => Pacific._saipan;

  /// A [Location] that represents `Pacific/Samoa`.
  Location get samoa => Pacific._samoa;

  /// A [Location] that represents `Pacific/Tahiti`.
  Location get tahiti => Pacific._tahiti;

  /// A [Location] that represents `Pacific/Tarawa`.
  Location get tarawa => Pacific._tarawa;

  /// A [Location] that represents `Pacific/Tongatapu`.
  Location get tongatapu => Pacific._tongatapu;

  /// A [Location] that represents `Pacific/Truk`.
  Location get truk => Pacific._truk;

  /// A [Location] that represents `Pacific/Wake`.
  Location get wake => Pacific._wake;

  /// A [Location] that represents `Pacific/Wallis`.
  Location get wallis => Pacific._wallis;

  /// A [Location] that represents `Pacific/Yap`.
  Location get yap => Pacific._yap;


  static final Location _apia = Location(
    'Pacific/Apia',
    ...
    const [
      Timezone(RawOffset('-11:26:56', -41216), abbreviation: 'LMT', dst: false),
      Timezone(RawOffset('-11:30', -41400), abbreviation: '-1130', dst: false),
  ...
  static final Location _auckland = Location(
    'Pacific/Auckland',
  ...
  static final Location _bougainville = Location(
    'Pacific/Bougainville',
    [-2840178136, -2366790512, -868010400, -768906000, 1419696000],
    const [
      Timezone(RawOffset('+09:48:32', 35312), abbreviation: 'PMMT', dst: false),
  ...
  static final Location _chatham = Location(
    'Pacific/Chatham',
  ...
  static final Location _chuuk = Location(
    'Pacific/Chuuk',
  ...
  static final Location _easter = Location(
    'Pacific/Easter',
    ...
    const [
      Timezone(RawOffset('-07:17:28', -26248), abbreviation: 'EMT', dst: false),
  ...
  static final Location _efate = Location(
    'Pacific/Efate',
  ...
  static final Location _enderbury = Location(
    'Pacific/Enderbury',
  ...
  static final Location _fakaofo = Location(
    'Pacific/Fakaofo',
  ...
  static final Location _fiji = Location(
    'Pacific/Fiji',
  ...
  static final Location _funafuti = Location(
    'Pacific/Funafuti',
    [-2177494324],
    const [
      Timezone(RawOffset('+12:00', 43200), abbreviation: '+12', dst: false),
  ...
  static final Location _galapagos = Location(
    'Pacific/Galapagos',
  ...
  static final Location _gambier = Location(
    'Pacific/Gambier',
    [-1806678012],
    const [
      Timezone(RawOffset('-09:00', -32400), abbreviation: '-09', dst: false),
  ...
  static final Location _guadalcanal = Location(
    'Pacific/Guadalcanal',
    [-1806748788],
    const [
      Timezone(RawOffset('+11:00', 39600), abbreviation: '+11', dst: false),
  ...
  static final Location _guam = Location(
    'Pacific/Guam',
    ...
    const [
      Timezone(RawOffset('+09:39', 34740), abbreviation: 'LMT', dst: false),
      Timezone(RawOffset('+10:00', 36000), abbreviation: 'GST', dst: false),
      Timezone(RawOffset('+09:00', 32400), abbreviation: '+09', dst: false),
      Timezone(RawOffset('+10:00', 36000), abbreviation: 'GST', dst: false),
      Timezone(RawOffset('+11:00', 39600), abbreviation: 'GDT', dst: true),
      Timezone(RawOffset('+10:00', 36000), abbreviation: 'GST', dst: false),
      Timezone(RawOffset('+11:00', 39600), abbreviation: 'GDT', dst: true),
      Timezone(RawOffset('+10:00', 36000), abbreviation: 'GST', dst: false),
      Timezone(RawOffset('+11:00', 39600), abbreviation: 'GDT', dst: true),
      ...
      Timezone(RawOffset('+11:00', 39600), abbreviation: 'GDT', dst: true),
      Timezone(RawOffset('+10:00', 36000), abbreviation: 'GST', dst: false),
      Timezone(RawOffset('+10:00', 36000), abbreviation: 'ChST', dst: false),
    ],
  );

  static final Location _honolulu = Location(
    'Pacific/Honolulu',
  ...
  static final Location _johnston = Location(
    'Pacific/Johnston',
    [-2334101314, -1157283000, -1155436200, -880198200, -769395600, -765376200, -712150200],
    const [
      Timezone(RawOffset('-10:30', -37800), abbreviation: 'HST', dst: false),
  ...
  static final Location _kanton = Location(
    'Pacific/Kanton',
    [-1020470400, 307627200, 788871600],
    const [
      Timezone(RawOffset('-12:00', -43200), abbreviation: '-12', dst: false),
  ...
  static final Location _kiritimati = Location(
    'Pacific/Kiritimati',
    [-2177415040, 307622400, 788868000],
    const [
      Timezone(RawOffset('-10:40', -38400), abbreviation: '-1040', dst: false),
      Timezone(RawOffset('-10:00', -36000), abbreviation: '-10', dst: false),
      Timezone(RawOffset('+14:00', 50400), abbreviation: '+14', dst: false),
    ],
  );

  static final Location _kosrae = Location(
    'Pacific/Kosrae',
    [-3944631116, -2177491916, -1743678000, -1606813200, -1041418800, -907408800, -770634000, -7988400, 915105600],
    const [
      Timezone(RawOffset('+10:51:56', 39116), abbreviation: 'LMT', dst: false),
      Timezone(RawOffset('+11:00', 39600), abbreviation: '+11', dst: false),
      Timezone(RawOffset('+09:00', 32400), abbreviation: '+09', dst: false),
      Timezone(RawOffset('+11:00', 39600), abbreviation: '+11', dst: false),
      Timezone(RawOffset('+10:00', 36000), abbreviation: '+10', dst: false),
  ...
  static final Location _kwajalein = Location(
    'Pacific/Kwajalein',
  ...
  static final Location _majuro = Location(
    'Pacific/Majuro',
    [-2177494324],
    const [
      Timezone(RawOffset('+12:00', 43200), abbreviation: '+12', dst: false),
  ...
  static final Location _marquesas = Location(
    'Pacific/Marquesas',
    [-1806676920],
    const [
  ...
  static final Location _midway = Location(
    'Pacific/Midway',
  ...
  static final Location _nauru = Location(
    'Pacific/Nauru',
  ...
  static final Location _niue = Location(
    'Pacific/Niue',
    [-543069620, -173623200],
    const [
      Timezone(RawOffset('-11:20', -40800), abbreviation: '-1120', dst: false),
      Timezone(RawOffset('-11:00', -39600), abbreviation: '-11', dst: false),
    ],
  );

  static final Location _norfolk = Location(
    'Pacific/Norfolk',
    ...
    const [
      Timezone(RawOffset('+11:12', 40320), abbreviation: '+1112', dst: false),
      Timezone(RawOffset('+11:30', 41400), abbreviation: '+1130', dst: false),
      Timezone(RawOffset('+12:30', 45000), abbreviation: '+1230', dst: true),
      Timezone(RawOffset('+11:30', 41400), abbreviation: '+1130', dst: false),
      Timezone(RawOffset('+11:00', 39600), abbreviation: '+11', dst: false),
      Timezone(RawOffset('+11:00', 39600), abbreviation: '+11', dst: false),
      Timezone(RawOffset('+12:00', 43200), abbreviation: '+12', dst: true),
  ...
  static final Location _noumea = Location(
    'Pacific/Noumea',
  ...
  static final Location _pagoPago = Location(
    'Pacific/Pago_Pago',
    [-2445424632, -1861879032],
    const [
      Timezone(RawOffset('-11:22:48', -40968), abbreviation: 'LMT', dst: false),
  ...
  static final Location _palau = Location(
    'Pacific/Palau',
    [-3944624276, -2177485076],
    const [
      Timezone(RawOffset('+08:57:56', 32276), abbreviation: 'LMT', dst: false),
      Timezone(RawOffset('+09:00', 32400), abbreviation: '+09', dst: false),
    ],
  );

  static final Location _pitcairn = Location(
    'Pacific/Pitcairn',
    [-2177421580, 893665800],
    const [
      Timezone(RawOffset('-08:30', -30600), abbreviation: '-0830', dst: false),
      Timezone(RawOffset('-08:00', -28800), abbreviation: '-08', dst: false),
    ],
  );

  static final Location _pohnpei = Location(
    'Pacific/Pohnpei',
    [-1806748788],
    const [
      Timezone(RawOffset('+11:00', 39600), abbreviation: '+11', dst: false),
  ...
  static final Location _ponape = Location(
    'Pacific/Ponape',
    [-1806748788],
    const [
      Timezone(RawOffset('+11:00', 39600), abbreviation: '+11', dst: false),
  ...
  static final Location _portMoresby = Location(
  ...
  static final Location _rarotonga = Location(
    'Pacific/Rarotonga',
    ...
    const [
      Timezone(RawOffset('-10:39:04', -38344), abbreviation: 'LMT', dst: false),
      Timezone(RawOffset('-10:30', -37800), abbreviation: '-1030', dst: false),
      Timezone(RawOffset('-09:30', -34200), abbreviation: '-0930', dst: true),
      Timezone(RawOffset('-10:00', -36000), abbreviation: '-10', dst: false),
      Timezone(RawOffset('-09:30', -34200), abbreviation: '-0930', dst: true),
      Timezone(RawOffset('-10:00', -36000), abbreviation: '-10', dst: false),
      Timezone(RawOffset('-09:30', -34200), abbreviation: '-0930', dst: true),
  ...
  static final Location _saipan = Location(
    'Pacific/Saipan',
    [-3944626740, -2177487540, -885549600, -802256400, -331891200, -281610000, -73728000, -29415540, -16704000, -10659600, 9907200, 21394800, 41356800, 52844400, 124819200, 130863600, 201888000, 209487660, 230659200, 241542000, 977493600],
    const [
      Timezone(RawOffset('+09:39', 34740), abbreviation: 'LMT', dst: false),
  ...
  static final Location _tahiti = Location(
    'Pacific/Tahiti',
    [-1806674504],
    const [
      Timezone(RawOffset('-10:00', -36000), abbreviation: '-10', dst: false),
  ...
  static final Location _tarawa = Location(
    'Pacific/Tarawa',
    [-2177494324],
    const [
      Timezone(RawOffset('+12:00', 43200), abbreviation: '+12', dst: false),
  ...
  static final Location _truk = Location(
    'Pacific/Truk',
    [-2840176120, -2366790512],
    const [
      Timezone(RawOffset('+09:48:32', 35312), abbreviation: 'PMMT', dst: false),
  ...
  static final Location _wake = Location(
    'Pacific/Wake',
    [-2177494324],
    const [
      Timezone(RawOffset('+12:00', 43200), abbreviation: '+12', dst: false),
  ...
  static final Location _wallis = Location(
    'Pacific/Wallis',
    [-2177494324],
    const [
      Timezone(RawOffset('+12:00', 43200), abbreviation: '+12', dst: false),
  ...
  static final Location _yap = Location(
    'Pacific/Yap',
    [-2840176120, -2366790512],
    const [
      Timezone(RawOffset('+09:48:32', 35312), abbreviation: 'PMMT', dst: false),
