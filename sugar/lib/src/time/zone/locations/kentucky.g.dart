...
/// A namespace that contains [Location]s and nested namespaces in `Kentucky`.
/// 
...
class Kentucky {
  ...
  /// A [Location] that represents `America/Kentucky/Louisville`.
  Location get louisville => Kentucky._louisville;

  /// A [Location] that represents `America/Kentucky/Monticello`.
  Location get monticello => Kentucky._monticello;


  static final Location _louisville = Location(
  ...
  static final Location _monticello = Location(
