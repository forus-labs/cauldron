...
/// A namespace that contains [Location]s and nested namespaces in `Europe`.
/// 
...
class Europe {
  ...
  /// A [Location] that represents `Europe/Amsterdam`.
  Location get amsterdam => Europe._amsterdam;

  /// A [Location] that represents `Europe/Andorra`.
  Location get andorra => Europe._andorra;

  /// A [Location] that represents `Europe/Astrakhan`.
  Location get astrakhan => Europe._astrakhan;

  /// A [Location] that represents `Europe/Athens`.
  Location get athens => Europe._athens;

  /// A [Location] that represents `Europe/Belfast`.
  Location get belfast => Europe._belfast;

  /// A [Location] that represents `Europe/Belgrade`.
  Location get belgrade => Europe._belgrade;

  /// A [Location] that represents `Europe/Berlin`.
  Location get berlin => Europe._berlin;

  /// A [Location] that represents `Europe/Bratislava`.
  Location get bratislava => Europe._bratislava;

  /// A [Location] that represents `Europe/Brussels`.
  Location get brussels => Europe._brussels;

  /// A [Location] that represents `Europe/Bucharest`.
  Location get bucharest => Europe._bucharest;

  /// A [Location] that represents `Europe/Budapest`.
  Location get budapest => Europe._budapest;

  /// A [Location] that represents `Europe/Busingen`.
  Location get busingen => Europe._busingen;

  /// A [Location] that represents `Europe/Chisinau`.
  Location get chisinau => Europe._chisinau;

  /// A [Location] that represents `Europe/Copenhagen`.
  Location get copenhagen => Europe._copenhagen;

  /// A [Location] that represents `Europe/Dublin`.
  Location get dublin => Europe._dublin;

  /// A [Location] that represents `Europe/Gibraltar`.
  Location get gibraltar => Europe._gibraltar;

  /// A [Location] that represents `Europe/Guernsey`.
  Location get guernsey => Europe._guernsey;

  /// A [Location] that represents `Europe/Helsinki`.
  Location get helsinki => Europe._helsinki;

  /// A [Location] that represents `Europe/Isle_of_Man`.
  Location get isleOfMan => Europe._isleOfMan;

  /// A [Location] that represents `Europe/Istanbul`.
  Location get istanbul => Europe._istanbul;

  /// A [Location] that represents `Europe/Jersey`.
  Location get jersey => Europe._jersey;

  /// A [Location] that represents `Europe/Kaliningrad`.
  Location get kaliningrad => Europe._kaliningrad;

  /// A [Location] that represents `Europe/Kiev`.
  Location get kiev => Europe._kiev;

  /// A [Location] that represents `Europe/Kirov`.
  Location get kirov => Europe._kirov;

  /// A [Location] that represents `Europe/Kyiv`.
  Location get kyiv => Europe._kyiv;

  /// A [Location] that represents `Europe/Lisbon`.
  Location get lisbon => Europe._lisbon;

  /// A [Location] that represents `Europe/Ljubljana`.
  Location get ljubljana => Europe._ljubljana;

  /// A [Location] that represents `Europe/London`.
  Location get london => Europe._london;

  /// A [Location] that represents `Europe/Luxembourg`.
  Location get luxembourg => Europe._luxembourg;

  /// A [Location] that represents `Europe/Madrid`.
  Location get madrid => Europe._madrid;

  /// A [Location] that represents `Europe/Malta`.
  Location get malta => Europe._malta;

  /// A [Location] that represents `Europe/Mariehamn`.
  Location get mariehamn => Europe._mariehamn;

  /// A [Location] that represents `Europe/Minsk`.
  Location get minsk => Europe._minsk;

  /// A [Location] that represents `Europe/Monaco`.
  Location get monaco => Europe._monaco;

  /// A [Location] that represents `Europe/Moscow`.
  Location get moscow => Europe._moscow;

  /// A [Location] that represents `Europe/Nicosia`.
  Location get nicosia => Europe._nicosia;

  /// A [Location] that represents `Europe/Oslo`.
  Location get oslo => Europe._oslo;

  /// A [Location] that represents `Europe/Paris`.
  Location get paris => Europe._paris;

  /// A [Location] that represents `Europe/Podgorica`.
  Location get podgorica => Europe._podgorica;

  /// A [Location] that represents `Europe/Prague`.
  Location get prague => Europe._prague;

  /// A [Location] that represents `Europe/Riga`.
  Location get riga => Europe._riga;

  /// A [Location] that represents `Europe/Rome`.
  Location get rome => Europe._rome;

  /// A [Location] that represents `Europe/Samara`.
  Location get samara => Europe._samara;

  /// A [Location] that represents `Europe/San_Marino`.
  Location get sanMarino => Europe._sanMarino;

  /// A [Location] that represents `Europe/Sarajevo`.
  Location get sarajevo => Europe._sarajevo;

  /// A [Location] that represents `Europe/Saratov`.
  Location get saratov => Europe._saratov;

  /// A [Location] that represents `Europe/Simferopol`.
  Location get simferopol => Europe._simferopol;

  /// A [Location] that represents `Europe/Skopje`.
  Location get skopje => Europe._skopje;

  /// A [Location] that represents `Europe/Sofia`.
  Location get sofia => Europe._sofia;

  /// A [Location] that represents `Europe/Stockholm`.
  Location get stockholm => Europe._stockholm;

  /// A [Location] that represents `Europe/Tallinn`.
  Location get tallinn => Europe._tallinn;

  /// A [Location] that represents `Europe/Tirane`.
  Location get tirane => Europe._tirane;

  /// A [Location] that represents `Europe/Tiraspol`.
  Location get tiraspol => Europe._tiraspol;

  /// A [Location] that represents `Europe/Ulyanovsk`.
  Location get ulyanovsk => Europe._ulyanovsk;

  /// A [Location] that represents `Europe/Uzhgorod`.
  Location get uzhgorod => Europe._uzhgorod;

  /// A [Location] that represents `Europe/Vaduz`.
  Location get vaduz => Europe._vaduz;

  /// A [Location] that represents `Europe/Vatican`.
  Location get vatican => Europe._vatican;

  /// A [Location] that represents `Europe/Vienna`.
  Location get vienna => Europe._vienna;

  /// A [Location] that represents `Europe/Vilnius`.
  Location get vilnius => Europe._vilnius;

  /// A [Location] that represents `Europe/Volgograd`.
  Location get volgograd => Europe._volgograd;

  /// A [Location] that represents `Europe/Warsaw`.
  Location get warsaw => Europe._warsaw;

  /// A [Location] that represents `Europe/Zagreb`.
  Location get zagreb => Europe._zagreb;

  /// A [Location] that represents `Europe/Zaporozhye`.
  Location get zaporozhye => Europe._zaporozhye;

  /// A [Location] that represents `Europe/Zurich`.
  Location get zurich => Europe._zurich;


  static final Location _amsterdam = Location(
    'Europe/Amsterdam',
    ...
    const [
      Timezone(RawOffset('+00:17:30', 1050), abbreviation: 'BMT', dst: false),
      Timezone(RawOffset('Z', 0), abbreviation: 'WET', dst: false),
      Timezone(RawOffset('+01:00', 3600), abbreviation: 'CET', dst: false),
      Timezone(RawOffset('+02:00', 7200), abbreviation: 'CEST', dst: true),
      Timezone(RawOffset('+01:00', 3600), abbreviation: 'CET', dst: false),
      Timezone(RawOffset('+02:00', 7200), abbreviation: 'CEST', dst: true),
      Timezone(RawOffset('+01:00', 3600), abbreviation: 'CET', dst: false),
      Timezone(RawOffset('+02:00', 7200), abbreviation: 'CEST', dst: true),
      Timezone(RawOffset('+01:00', 3600), abbreviation: 'CET', dst: false),
      Timezone(RawOffset('Z', 0), abbreviation: 'WET', dst: false),
      Timezone(RawOffset('+01:00', 3600), abbreviation: 'WEST', dst: true),
      Timezone(RawOffset('Z', 0), abbreviation: 'WET', dst: false),
      Timezone(RawOffset('+01:00', 3600), abbreviation: 'WEST', dst: true),
      Timezone(RawOffset('Z', 0), abbreviation: 'WET', dst: false),
      Timezone(RawOffset('+01:00', 3600), abbreviation: 'WEST', dst: true),
  ...
  static final Location _andorra = Location(
    'Europe/Andorra',
  ...
  static final Location _astrakhan = Location(
    'Europe/Astrakhan',
  ...
  static final Location _athens = Location(
    'Europe/Athens',
    ...
    const [
      Timezone(RawOffset('+01:34:52', 5692), abbreviation: 'AMT', dst: false),
  ...
  static final Location _belfast = Location(
    'Europe/Belfast',
    ...
    const [
      Timezone(RawOffset('Z', 0), abbreviation: 'GMT', dst: false),
      Timezone(RawOffset('+01:00', 3600), abbreviation: 'BST', dst: true),
      Timezone(RawOffset('Z', 0), abbreviation: 'GMT', dst: false),
      Timezone(RawOffset('+01:00', 3600), abbreviation: 'BST', dst: true),
      Timezone(RawOffset('Z', 0), abbreviation: 'GMT', dst: false),
      Timezone(RawOffset('+01:00', 3600), abbreviation: 'BST', dst: true),
      ...
      Timezone(RawOffset('Z', 0), abbreviation: 'GMT', dst: false),
      Timezone(RawOffset('+01:00', 3600), abbreviation: 'BST', dst: true),
      Timezone(RawOffset('+02:00', 7200), abbreviation: 'BDST', dst: true),
      Timezone(RawOffset('+01:00', 3600), abbreviation: 'BST', dst: true),
      Timezone(RawOffset('+02:00', 7200), abbreviation: 'BDST', dst: true),
      Timezone(RawOffset('+01:00', 3600), abbreviation: 'BST', dst: true),
      Timezone(RawOffset('+02:00', 7200), abbreviation: 'BDST', dst: true),
      ...
      Timezone(RawOffset('Z', 0), abbreviation: 'GMT', dst: false),
      Timezone(RawOffset('+01:00', 3600), abbreviation: 'BST', dst: true),
      Timezone(RawOffset('+01:00', 3600), abbreviation: 'BST', dst: false),
      Timezone(RawOffset('Z', 0), abbreviation: 'GMT', dst: false),
      Timezone(RawOffset('+01:00', 3600), abbreviation: 'BST', dst: true),
      Timezone(RawOffset('Z', 0), abbreviation: 'GMT', dst: false),
      Timezone(RawOffset('+01:00', 3600), abbreviation: 'BST', dst: true),
  ...
  static final Location _belgrade = Location(
    'Europe/Belgrade',
  ...
  static final Location _berlin = Location(
    'Europe/Berlin',
    ...
    const [
      ...
      Timezone(RawOffset('+01:00', 3600), abbreviation: 'CET', dst: false),
      Timezone(RawOffset('+02:00', 7200), abbreviation: 'CEST', dst: true),
      Timezone(RawOffset('+03:00', 10800), abbreviation: 'CEMT', dst: true),
      Timezone(RawOffset('+02:00', 7200), abbreviation: 'CEST', dst: true),
      Timezone(RawOffset('+01:00', 3600), abbreviation: 'CET', dst: false),
      Timezone(RawOffset('+01:00', 3600), abbreviation: 'CET', dst: false),
      Timezone(RawOffset('+02:00', 7200), abbreviation: 'CEST', dst: true),
  ...
  static final Location _bratislava = Location(
    'Europe/Bratislava',
    ...
    const [
      Timezone(RawOffset('+00:57:44', 3464), abbreviation: 'PMT', dst: false),
      Timezone(RawOffset('+01:00', 3600), abbreviation: 'CET', dst: false),
      Timezone(RawOffset('+02:00', 7200), abbreviation: 'CEST', dst: true),
      Timezone(RawOffset('+01:00', 3600), abbreviation: 'CET', dst: false),
      Timezone(RawOffset('+02:00', 7200), abbreviation: 'CEST', dst: true),
      ...
      Timezone(RawOffset('+02:00', 7200), abbreviation: 'CEST', dst: true),
      Timezone(RawOffset('+01:00', 3600), abbreviation: 'CET', dst: false),
      Timezone(RawOffset('Z', 0), abbreviation: 'GMT', dst: true),
      Timezone(RawOffset('+01:00', 3600), abbreviation: 'CET', dst: false),
      Timezone(RawOffset('+02:00', 7200), abbreviation: 'CEST', dst: true),
      Timezone(RawOffset('+01:00', 3600), abbreviation: 'CET', dst: false),
      Timezone(RawOffset('+02:00', 7200), abbreviation: 'CEST', dst: true),
  ...
  static final Location _brussels = Location(
    'Europe/Brussels',
    [-2840141850, -2450995200, -1740355200, -1693702800, -1680483600, -1663455600, -1650150000, -1632006000, -1618700400, -1613826000, -1604278800, -1585530000, -1574038800, -1552266000, -1539997200, -1520557200, -1507510800, -1490576400, -1473642000, -1459126800, -1444006800, -1427677200, -1411952400, -1396227600, -1379293200, -1364778000, -1348448400, -1333328400, -1316394000, -1301263200, -1284328800, -1269813600, -1253484000, -1238364000, -1221429600, -1206914400, -1191189600, -1175464800, -1160344800, -1143410400, -1127685600, -1111960800, -1096840800, -1080511200, -1063576800, -1049061600, -1033336800, -1017612000, -1002492000, -986162400, -969228000, -950479200, -942012000, -934668000, -857257200, -844556400, -828226800, -812502000, -799293600, -798073200, -781052400, -766623600, -745455600, -733273200, 220921200, 228877200, 243997200, 260326800, 276051600, 291776400, 307501200, 323830800, 338950800, 354675600, 370400400, 386125200, 401850000, 417574800, 433299600, 449024400, 465354000, 481078800, 496803600, 512528400, 528253200, 543978000, 559702800, 575427600, 591152400, 606877200, 622602000, 638326800, 654656400, 670381200, 686106000, 701830800, 717555600, 733280400, 749005200, 764730000, 780454800, 796179600, 811904400, 828234000, 846378000, 859683600, 877827600, 891133200, 909277200, 922582800, 941331600, 954032400, 972781200, 985482000, 1004230800, 1017536400, 1035680400, 1048986000, 1067130000, 1080435600, 1099184400, 1111885200, 1130634000, 1143334800, 1162083600, 1174784400, 1193533200, 1206838800, 1224982800, 1238288400, 1256432400, 1269738000, 1288486800, 1301187600, 1319936400, 1332637200, 1351386000, 1364691600, 1382835600, 1396141200, 1414285200, 1427590800, 1445734800, 1459040400, 1477789200, 1490490000, 1509238800, 1521939600, 1540688400, 1553994000, 1572138000, 1585443600, 1603587600, 1616893200, 1635642000, 1648342800, 1667091600, 1679792400, 1698541200, 1711846800, 1729990800, 1743296400, 1761440400, 1774746000, 1792890000, 1806195600, 1824944400, 1837645200, 1856394000, 1869094800, 1887843600, 1901149200, 1919293200, 1932598800, 1950742800, 1964048400, 1982797200, 1995498000, 2014246800, 2026947600, 2045696400, 2058397200, 2077146000, 2090451600, 2108595600, 2121901200, 2140045200],
    const [
      Timezone(RawOffset('+00:17:30', 1050), abbreviation: 'BMT', dst: false),
  ...
  static final Location _bucharest = Location(
    'Europe/Bucharest',
    ...
    const [
      Timezone(RawOffset('+01:44:24', 6264), abbreviation: 'BMT', dst: false),
      Timezone(RawOffset('+02:00', 7200), abbreviation: 'EET', dst: false),
      Timezone(RawOffset('+03:00', 10800), abbreviation: 'EEST', dst: true),
      Timezone(RawOffset('+02:00', 7200), abbreviation: 'EET', dst: false),
      Timezone(RawOffset('+03:00', 10800), abbreviation: 'EEST', dst: true),
  ...
  static final Location _budapest = Location(
    'Europe/Budapest',
  ...
  static final Location _busingen = Location(
    'Europe/Busingen',
    ...
    const [
      Timezone(RawOffset('+00:29:46', 1786), abbreviation: 'BMT', dst: false),
      Timezone(RawOffset('+01:00', 3600), abbreviation: 'CET', dst: false),
      Timezone(RawOffset('+02:00', 7200), abbreviation: 'CEST', dst: true),
      Timezone(RawOffset('+01:00', 3600), abbreviation: 'CET', dst: false),
      Timezone(RawOffset('+02:00', 7200), abbreviation: 'CEST', dst: true),
  ...
  static final Location _chisinau = Location(
    'Europe/Chisinau',
    ...
    const [
      Timezone(RawOffset('+01:55', 6900), abbreviation: 'CMT', dst: false),
      Timezone(RawOffset('+01:44:24', 6264), abbreviation: 'BMT', dst: false),
      Timezone(RawOffset('+02:00', 7200), abbreviation: 'EET', dst: false),
      Timezone(RawOffset('+03:00', 10800), abbreviation: 'EEST', dst: true),
      Timezone(RawOffset('+02:00', 7200), abbreviation: 'EET', dst: false),
      ...
      Timezone(RawOffset('+01:00', 3600), abbreviation: 'CET', dst: false),
      Timezone(RawOffset('+02:00', 7200), abbreviation: 'CEST', dst: true),
      Timezone(RawOffset('+03:00', 10800), abbreviation: 'MSK', dst: false),
      Timezone(RawOffset('+04:00', 14400), abbreviation: 'MSD', dst: true),
      Timezone(RawOffset('+03:00', 10800), abbreviation: 'MSK', dst: false),
      Timezone(RawOffset('+04:00', 14400), abbreviation: 'MSD', dst: true),
      Timezone(RawOffset('+03:00', 10800), abbreviation: 'MSK', dst: false),
      Timezone(RawOffset('+04:00', 14400), abbreviation: 'MSD', dst: true),
  ...
  static final Location _copenhagen = Location(
    'Europe/Copenhagen',
    [-2422054408, -1693706400, -1680483600, -1663455600, -1650150000, -1632006000, -1618700400, -938905200, -857257200, -844556400, -828226800, -812502000, -796777200, -781052400, -776563200, -765936000, -761180400, -757386000, -748479600, -733273200, -717631200, -714610800, -710380800, -701910000, -684975600, -670460400, -654130800, -639010800, 315529200, 323830800, 338950800, 354675600, 370400400, 386125200, 401850000, 417574800, 433299600, 449024400, 465354000, 481078800, 496803600, 512528400, 528253200, 543978000, 559702800, 575427600, 591152400, 606877200, 622602000, 638326800, 654656400, 670381200, 686106000, 701830800, 717555600, 733280400, 749005200, 764730000, 780454800, 796179600, 811904400, 828234000, 846378000, 859683600, 877827600, 891133200, 909277200, 922582800, 941331600, 954032400, 972781200, 985482000, 1004230800, 1017536400, 1035680400, 1048986000, 1067130000, 1080435600, 1099184400, 1111885200, 1130634000, 1143334800, 1162083600, 1174784400, 1193533200, 1206838800, 1224982800, 1238288400, 1256432400, 1269738000, 1288486800, 1301187600, 1319936400, 1332637200, 1351386000, 1364691600, 1382835600, 1396141200, 1414285200, 1427590800, 1445734800, 1459040400, 1477789200, 1490490000, 1509238800, 1521939600, 1540688400, 1553994000, 1572138000, 1585443600, 1603587600, 1616893200, 1635642000, 1648342800, 1667091600, 1679792400, 1698541200, 1711846800, 1729990800, 1743296400, 1761440400, 1774746000, 1792890000, 1806195600, 1824944400, 1837645200, 1856394000, 1869094800, 1887843600, 1901149200, 1919293200, 1932598800, 1950742800, 1964048400, 1982797200, 1995498000, 2014246800, 2026947600, 2045696400, 2058397200, 2077146000, 2090451600, 2108595600, 2121901200, 2140045200],
    const [
      Timezone(RawOffset('+01:00', 3600), abbreviation: 'CET', dst: false),
  ...
  static final Location _dublin = Location(
    'Europe/Dublin',
    ...
    const [
      Timezone(RawOffset('-00:25:21', -1521), abbreviation: 'DMT', dst: false),
      Timezone(RawOffset('+00:34:39', 2079), abbreviation: 'IST', dst: true),
      Timezone(RawOffset('Z', 0), abbreviation: 'GMT', dst: false),
      Timezone(RawOffset('+01:00', 3600), abbreviation: 'BST', dst: true),
      Timezone(RawOffset('Z', 0), abbreviation: 'GMT', dst: false),
      Timezone(RawOffset('+01:00', 3600), abbreviation: 'BST', dst: true),
      ...
      Timezone(RawOffset('Z', 0), abbreviation: 'GMT', dst: false),
      Timezone(RawOffset('Z', 0), abbreviation: 'GMT', dst: false),
      Timezone(RawOffset('+01:00', 3600), abbreviation: 'IST', dst: true),
      Timezone(RawOffset('Z', 0), abbreviation: 'GMT', dst: false),
      Timezone(RawOffset('+01:00', 3600), abbreviation: 'IST', dst: true),
      Timezone(RawOffset('Z', 0), abbreviation: 'GMT', dst: false),
      Timezone(RawOffset('+01:00', 3600), abbreviation: 'IST', dst: true),
      ...
      Timezone(RawOffset('Z', 0), abbreviation: 'GMT', dst: false),
      Timezone(RawOffset('+01:00', 3600), abbreviation: 'IST', dst: true),
      Timezone(RawOffset('+01:00', 3600), abbreviation: 'IST', dst: false),
      Timezone(RawOffset('Z', 0), abbreviation: 'GMT', dst: true),
      Timezone(RawOffset('+01:00', 3600), abbreviation: 'IST', dst: false),
      Timezone(RawOffset('Z', 0), abbreviation: 'GMT', dst: true),
      Timezone(RawOffset('+01:00', 3600), abbreviation: 
, 323830800, 338950800, 354675600, 370400400, 386125200, 401850000, 417574800, 433299600, 449024400, 465354000, 481078800, 496803600, 512528400, 528253200, 543978000, 559702800, 575427600, 591152400, 606877200, 622602000, 638326800, 654656400, 670381200, 686106000, 701830800, 717555600, 733280400, 749005200, 764730000, 780454800, 796179600, 811904400, 828234000, 846378000, 859683600, 877827600, 891133200, 909277200, 922582800, 941331600, 954032400, 972781200, 985482000, 1004230800, 1017536400, 1035680400, 1048986000, 1067130000, 1080435600, 1099184400, 1111885200, 1130634000, 1143334800, 1162083600, 1174784400, 1193533200, 1206838800, 1224982800, 1238288400, 1256432400, 1269738000, 1288486800, 1301187600, 1319936400, 1332637200, 1351386000, 1364691600, 1382835600, 1396141200, 1414285200, 1427590800, 1445734800, 1459040400, 1477789200, 1490490000, 1509238800, 1521939600, 1540688400, 1553994000, 1572138000, 1585443600, 1603587600, 1616893200, 1635642000, 1648342800, 1667091600, 1679792400, 1698541200, 1711846800, 1729990800, 1743296400, 1761440400, 1774746000, 1792890000, 1806195600, 1824944400, 1837645200, 1856394000, 1869094800, 1887843600, 1901149200, 1919293200, 1932598800, 1950742800, 1964048400, 1982797200, 1995498000, 2014246800, 2026947600, 2045696400, 2058397200, 2077146000, 2090451600, 2108595600, 2121901200, 2140045200],
    const [
      Timezone(RawOffset('+00:17:30', 1050), abbreviation: 'BMT', dst: false),
  ...
  static final Location _madrid = Location(
    'Europe/Madrid',
  ...
  static final Location _malta = Location(
    'Europe/Malta',
  ...
  static final Location _mariehamn = Location(
    'Europe/Mariehamn',
    [-2890258789, -1535938789, -875671200, -859773600, 354672000, 370396800, 386121600, 401846400, 417574800, 433299600, 449024400, 465354000, 481078800, 496803600, 512528400, 528253200, 543978000, 559702800, 575427600, 591152400, 606877200, 622602000, 638326800, 654656400, 670381200, 686106000, 701830800, 717555600, 733280400, 749005200, 764730000, 780454800, 796179600, 811904400, 828234000, 846378000, 859683600, 877827600, 891133200, 909277200, 922582800, 941331600, 954032400, 972781200, 985482000, 1004230800, 1017536400, 1035680400, 1048986000, 1067130000, 1080435600, 1099184400, 1111885200, 1130634000, 1143334800, 1162083600, 1174784400, 1193533200, 1206838800, 1224982800, 1238288400, 1256432400, 1269738000, 1288486800, 1301187600, 1319936400, 1332637200, 1351386000, 1364691600, 1382835600, 1396141200, 1414285200, 1427590800, 1445734800, 1459040400, 1477789200, 1490490000, 1509238800, 1521939600, 1540688400, 1553994000, 1572138000, 1585443600, 1603587600, 1616893200, 1635642000, 1648342800, 1667091600, 1679792400, 1698541200, 1711846800, 1729990800, 1743296400, 1761440400, 1774746000, 1792890000, 1806195600, 1824944400, 1837645200, 1856394000, 1869094800, 1887843600, 1901149200, 1919293200, 1932598800, 1950742800, 1964048400, 1982797200, 1995498000, 2014246800, 2026947600, 2045696400, 2058397200, 2077146000, 2090451600, 2108595600, 2121901200, 2140045200],
    const [
      Timezone(RawOffset('+01:39:49', 5989), abbreviation: 'HMT', dst: false),
  ...
  static final Location _minsk = Location(
    'Europe/Minsk',
    ...
    const [
      Timezone(RawOffset('+01:50', 6600), abbreviation: 'MMT', dst: false),
      Timezone(RawOffset('+02:00', 7200), abbreviation: 'EET', dst: false),
      Timezone(RawOffset('+03:00', 10800), abbreviation: 'MSK', dst: false),
      Timezone(RawOffset('+02:00', 7200), abbreviation: 'CEST', dst: true),
      Timezone(RawOffset('+01:00', 3600), abbreviation: 'CET', dst: false),
  ...
  static final Location _monaco = Location(
    'Europe/Monaco',
    ...
    const [
      Timezone(RawOffset('+00:09:21', 561), abbreviation: 'PMT', dst: false),
      Timezone(RawOffset('Z', 0), abbreviation: 'WET', dst: false),
      Timezone(RawOffset('+01:00', 3600), abbreviation: 'WEST', dst: true),
      Timezone(RawOffset('Z', 0), abbreviation: 'WET', dst: false),
      Timezone(RawOffset('+01:00', 3600), abbreviation: 'WEST', dst: true),
  ...
  static final Location _moscow = Location(
    'Europe/Moscow',
    ...
    const [
      Timezone(RawOffset('+02:30:17', 9017), abbreviation: 'MMT', dst: false),
      Timezone(RawOffset('+02:31:19', 9079), abbreviation: 'MMT', dst: false),
      Timezone(RawOffset('+03:31:19', 12679), abbreviation: 'MST', dst: true),
      Timezone(RawOffset('+02:31:19', 9079), abbreviation: 'MMT', dst: false),
      Timezone(RawOffset('+04:31:19', 16279), abbreviation: 'MDST', dst: true),
      Timezone(RawOffset('+03:31:19', 12679), abbreviation: 'MST', dst: true),
      Timezone(RawOffset('+04:31:19', 16279), abbreviation: 'MDST', dst: true),
      Timezone(RawOffset('+04:00', 14400), abbreviation: 'MSD', dst: true),
      Timezone(RawOffset('+03:00', 10800), abbreviation: 'MSK', dst: false),
  ...
  static final Location _oslo = Location(
    'Europe/Oslo',
    [-2422054408, -1693706400, -1680483600, -1663455600, -1650150000, -1632006000, -1618700400, -938905200, -857257200, -844556400, -828226800, -812502000, -796777200, -781052400, -776563200, -765936000, -761180400, -757386000, -748479600, -733273200, -717631200, -714610800, -710380800, -701910000, -684975600, -670460400, -654130800, -639010800, 315529200, 323830800, 338950800, 354675600, 370400400, 386125200, 401850000, 417574800, 433299600, 449024400, 465354000, 481078800, 496803600, 512528400, 528253200, 543978000, 559702800, 575427600, 591152400, 606877200, 622602000, 638326800, 654656400, 670381200, 686106000, 701830800, 717555600, 733280400, 749005200, 764730000, 780454800, 796179600, 811904400, 828234000, 846378000, 859683600, 877827600, 891133200, 909277200, 922582800, 941331600, 954032400, 972781200, 985482000, 1004230800, 1017536400, 1035680400, 1048986000, 1067130000, 1080435600, 1099184400, 1111885200, 1130634000, 1143334800, 1162083600, 1174784400, 1193533200, 1206838800, 1224982800, 1238288400, 1256432400, 1269738000, 1288486800, 1301187600, 1319936400, 1332637200, 1351386000, 1364691600, 1382835600, 1396141200, 1414285200, 1427590800, 1445734800, 1459040400, 1477789200, 1490490000, 1509238800, 1521939600, 1540688400, 1553994000, 1572138000, 1585443600, 1603587600, 1616893200, 1635642000, 1648342800, 1667091600, 1679792400, 1698541200, 1711846800, 1729990800, 1743296400, 1761440400, 1774746000, 1792890000, 1806195600, 1824944400, 1837645200, 1856394000, 1869094800, 1887843600, 1901149200, 1919293200, 1932598800, 1950742800, 1964048400, 1982797200, 1995498000, 2014246800, 2026947600, 2045696400, 2058397200, 2077146000, 2090451600, 2108595600, 2121901200, 2140045200],
    const [
      Timezone(RawOffset('+01:00', 3600), abbreviation: 'CET', dst: false),
  ...
  static final Location _paris = Location(
    'Europe/Paris',
    [-2486592561, -1855958961, -1689814800, -1680397200, -1665363600, -1648342800, -1635123600, -1616893200, -1604278800, -1585443600, -1574038800, -1552266000, -1539997200, -1520557200, -1507510800, -1490576400, -1470618000, -1459126800, -1444006800, -1427677200, -1411952400, -1396227600, -1379293200, -1364778000, -1348448400, -1333328400, -1316394000, -1301274000, -1284339600, -1269824400, -1253494800, -1238374800, -1221440400, -1206925200, -1191200400, -1175475600, -1160355600, -1143421200, -1127696400, -1111971600, -1096851600, -1080522000, -1063587600, -1049072400, -1033347600, -1017622800, -1002502800, -986173200, -969238800, -950490000, -942012000, -932436000, -857257200, -844556400, -828226800, -812502000, -800071200, -796266000, -781052400, -766623600, 196819200, 212540400, 228877200, 243997200, 260326800, 276051600, 291776400, 307501200, 323830800, 338950800, 354675600, 370400400, 386125200, 401850000, 417574800, 433299600, 449024400, 465354000, 481078800, 496803600, 512528400, 528253200, 543978000, 559702800, 575427600, 591152400, 606877200, 622602000, 638326800, 654656400, 670381200, 686106000, 701830800, 717555600, 733280400, 749005200, 764730000, 780454800, 796179600, 811904400, 828234000, 846378000, 859683600, 877827600, 891133200, 909277200, 922582800, 941331600, 954032400, 972781200, 985482000, 1004230800, 1017536400, 1035680400, 1048986000, 1067130000, 1080435600, 1099184400, 1111885200, 1130634000, 1143334800, 1162083600, 1174784400, 1193533200, 1206838800, 1224982800, 1238288400, 1256432400, 1269738000, 1288486800, 1301187600, 1319936400, 1332637200, 1351386000, 1364691600, 1382835600, 1396141200, 1414285200, 1427590800, 1445734800, 1459040400, 1477789200, 1490490000, 1509238800, 1521939600, 1540688400, 1553994000, 1572138000, 1585443600, 1603587600, 1616893200, 1635642000, 1648342800, 1667091600, 1679792400, 1698541200, 1711846800, 1729990800, 1743296400, 1761440400, 1774746000, 1792890000, 1806195600, 1824944400, 1837645200, 1856394000, 1869094800, 1887843600, 1901149200, 1919293200, 1932598800, 1950742800, 1964048400, 1982797200, 1995498000, 2014246800, 2026947600, 2045696400, 2058397200, 2077146000, 2090451600, 2108595600, 2121901200, 2140045200],
    const [
      Timezone(RawOffset('+00:09:21', 561), abbreviation: 'PMT', dst: false),
  ...
  static final Location _podgorica = Location(
    'Europe/Podgorica',
    [-2713915320, -905824800, -857257200, -844556400, -828226800, -812502000, -796777200, -788922000, -777942000, -766623600, 407199600, 417574800, 433299600, 449024400, 465354000, 481078800, 496803600, 512528400, 528253200, 543978000, 559702800, 575427600, 591152400, 606877200, 622602000, 638326800, 654656400, 670381200, 686106000, 701830800, 717555600, 733280400, 749005200, 764730000, 780454800, 796179600, 811904400, 828234000, 846378000, 859683600, 877827600, 891133200, 909277200, 922582800, 941331600, 954032400, 972781200, 985482000, 1004230800, 1017536400, 1035680400, 1048986000, 1067130000, 1080435600, 1099184400, 1111885200, 1130634000, 1143334800, 1162083600, 1174784400, 1193533200, 1206838800, 1224982800, 1238288400, 1256432400, 1269738000, 1288486800, 1301187600, 1319936400, 1332637200, 1351386000, 1364691600, 1382835600, 1396141200, 1414285200, 1427590800, 1445734800, 1459040400, 1477789200, 1490490000, 1509238800, 1521939600, 1540688400, 1553994000, 1572138000, 1585443600, 1603587600, 1616893200, 1635642000, 1648342800, 1667091600, 1679792400, 1698541200, 1711846800, 1729990800, 1743296400, 1761440400, 1774746000, 1792890000, 1806195600, 1824944400, 1837645200, 1856394000, 1869094800, 1887843600, 1901149200, 1919293200, 1932598800, 1950742800, 1964048400, 1982797200, 1995498000, 2014246800, 2026947600, 2045696400, 2058397200, 2077146000, 2090451600, 2108595600, 2121901200, 2140045200],
    const [
      Timezone(RawOffset('+01:00', 3600), abbreviation: 'CET', dst: false),
  ...
  static final Location _prague = Location(
    'Europe/Prague',
    [-3786829064, -2469401864, -1693706400, -1680483600, -1663455600, -1650150000, -1632006000, -1618700400, -938905200, -857257200, -844556400, -828226800, -812502000, -796777200, -781052400, -777866400, -765327600, -746578800, -733359600, -728517600, -721260000, -716425200, -701910000, -684975600, -670460400, -654217200, -639010800, 283993200, 291776400, 307501200, 323830800, 338950800, 354675600, 370400400, 386125200, 401850000, 417574800, 433299600, 449024400, 465354000, 481078800, 496803600, 512528400, 528253200, 543978000, 559702800, 575427600, 591152400, 606877200, 622602000, 638326800, 654656400, 670381200, 686106000, 701830800, 717555600, 733280400, 749005200, 764730000, 780454800, 796179600, 811904400, 828234000, 846378000, 859683600, 877827600, 891133200, 909277200, 922582800, 941331600, 954032400, 972781200, 985482000, 1004230800, 1017536400, 1035680400, 1048986000, 1067130000, 1080435600, 1099184400, 1111885200, 1130634000, 1143334800, 1162083600, 1174784400, 1193533200, 1206838800, 1224982800, 1238288400, 1256432400, 1269738000, 1288486800, 1301187600, 1319936400, 1332637200, 1351386000, 1364691600, 1382835600, 1396141200, 1414285200, 1427590800, 1445734800, 1459040400, 1477789200, 1490490000, 1509238800, 1521939600, 1540688400, 1553994000, 1572138000, 1585443600, 1603587600, 1616893200, 1635642000, 1648342800, 1667091600, 1679792400, 1698541200, 1711846800, 1729990800, 1743296400, 1761440400, 1774746000, 1792890000, 1806195600, 1824944400, 1837645200, 1856394000, 1869094800, 1887843600, 1901149200, 1919293200, 1932598800, 1950742800, 1964048400, 1982797200, 1995498000, 2014246800, 2026947600, 2045696400, 2058397200, 2077146000, 2090451600, 2108595600, 2121901200, 2140045200],
    const [
      Timezone(RawOffset('+00:57:44', 3464), abbreviation: 'PMT', dst: false),
  ...
  static final Location _riga = Location(
    'Europe/Riga',
    ...
    const [
      Timezone(RawOffset('+01:36:34', 5794), abbreviation: 'RMT', dst: false),
      Timezone(RawOffset('+02:36:34', 9394), abbreviation: 'LST', dst: true),
      Timezone(RawOffset('+01:36:34', 5794), abbreviation: 'RMT', dst: false),
      Timezone(RawOffset('+02:36:34', 9394), abbreviation: 'LST', dst: true),
      Timezone(RawOffset('+01:36:34', 5794), abbreviation: 'RMT', dst: false),
      Timezone(RawOffset('+02:00', 7200), abbreviation: 'EET', dst: false),
  ...
  static final Location _rome = Location(
    'Europe/Rome',
    ...
    const [
      Timezone(RawOffset('+00:49:56', 2996), abbreviation: 'RMT', dst: false),
      Timezone(RawOffset('+01:00', 3600), abbreviation: 'CET', dst: false),
      Timezone(RawOffset('+02:00', 7200), abbreviation: 'CEST', dst: true),
      Timezone(RawOffset('+01:00', 3600), abbreviation: 'CET', dst: false),
      Timezone(RawOffset('+02:00', 7200), abbreviation: 'CEST', dst: true),
  ...
  static final Location _samara = Location(
    'Europe/Samara',
  ...
  static final Location _sanMarino = Location(
    'Europe/San_Marino',
    [-3252098996, -2403565200, -1690765200, -1680487200, -1664758800, -1648951200, -1635123600, -1616896800, -1604278800, -1585533600, -1571014800, -1555293600, -932432400, -857257200, -844556400, -830311200, -828226800, -812502000, -807156000, -798073200, -781052400, -766717200, -750898800, -733359600, -719456400, -701917200, -689209200, -670460400, -114051600, -103168800, -81997200, -71715600, -50547600, -40266000, -18493200, -8211600, 12956400, 23238000, 43801200, 54687600, 75855600, 86742000, 107910000, 118191600, 138754800, 149641200, 170809200, 181090800, 202258800, 212540400, 233103600, 243990000, 265158000, 276044400, 296607600, 307494000, 315529200, 323830800, 338950800, 354675600, 370400400, 386125200, 401850000, 417574800, 433299600, 449024400, 465354000, 481078800, 496803600, 512528400, 528253200, 543978000, 559702800, 575427600, 591152400, 606877200, 622602000, 638326800, 654656400, 670381200, 686106000, 701830800, 717555600, 733280400, 749005200, 764730000, 780454800, 796179600, 811904400, 828234000, 846378000, 859683600, 877827600, 891133200, 909277200, 922582800, 941331600, 954032400, 972781200, 985482000, 1004230800, 1017536400, 1035680400, 1048986000, 1067130000, 1080435600, 1099184400, 1111885200, 1130634000, 1143334800, 1162083600, 1174784400, 1193533200, 1206838800, 1224982800, 1238288400, 1256432400, 1269738000, 1288486800, 1301187600, 1319936400, 1332637200, 1351386000, 1364691600, 1382835600, 1396141200, 1414285200, 1427590800, 1445734800, 1459040400, 1477789200, 1490490000, 1509238800, 1521939600, 1540688400, 1553994000, 1572138000, 1585443600, 1603587600, 1616893200, 1635642000, 1648342800, 1667091600, 1679792400, 1698541200, 1711846800, 1729990800, 1743296400, 1761440400, 1774746000, 1792890000, 1806195600, 1824944400, 1837645200, 1856394000, 1869094800, 1887843600, 1901149200, 1919293200, 1932598800, 1950742800, 1964048400, 1982797200, 1995498000, 2014246800, 2026947600, 2045696400, 2058397200, 2077146000, 2090451600, 2108595600, 2121901200, 2140045200],
    const [
      Timezone(RawOffset('+00:49:56', 2996), abbreviation: 'RMT', dst: false),
  ...
  static final Location _sarajevo = Location(
    'Europe/Sarajevo',
    [-2713915320, -905824800, -857257200, -844556400, -828226800, -812502000, -796777200, -788922000, -777942000, -766623600, 407199600, 417574800, 433299600, 449024400, 465354000, 481078800, 496803600, 512528400, 528253200, 543978000, 559702800, 575427600, 591152400, 606877200, 622602000, 638326800, 654656400, 670381200, 686106000, 701830800, 717555600, 733280400, 749005200, 764730000, 780454800, 796179600, 811904400, 828234000, 846378000, 859683600, 877827600, 891133200, 909277200, 922582800, 941331600, 954032400, 972781200, 985482000, 1004230800, 1017536400, 1035680400, 1048986000, 1067130000, 1080435600, 1099184400, 1111885200, 1130634000, 1143334800, 1162083600, 1174784400, 1193533200, 1206838800, 1224982800, 1238288400, 1256432400, 1269738000, 1288486800, 1301187600, 1319936400, 1332637200, 1351386000, 1364691600, 1382835600, 1396141200, 1414285200, 1427590800, 1445734800, 1459040400, 1477789200, 1490490000, 1509238800, 1521939600, 1540688400, 1553994000, 1572138000, 1585443600, 1603587600, 1616893200, 1635642000, 1648342800, 1667091600, 1679792400, 1698541200, 1711846800, 1729990800, 1743296400, 1761440400, 1774746000, 1792890000, 1806195600, 1824944400, 1837645200, 1856394000, 1869094800, 1887843600, 1901149200, 1919293200, 1932598800, 1950742800, 1964048400, 1982797200, 1995498000, 2014246800, 2026947600, 2045696400, 2058397200, 2077146000, 2090451600, 2108595600, 2121901200, 2140045200],
    const [
      Timezone(RawOffset('+01:00', 3600), abbreviation: 'CET', dst: false),
  ...
  static final Location _saratov = Location(
    'Europe/Saratov',
  ...
  static final Location _simferopol = Location(
    'Europe/Simferopol',
    ...
    const [
      Timezone(RawOffset('+02:16', 8160), abbreviation: 'SMT', dst: false),
      Timezone(RawOffset('+02:00', 7200), abbreviation: 'EET', dst: false),
      Timezone(RawOffset('+03:00', 10800), abbreviation: 'MSK', dst: false),
      Timezone(RawOffset('+02:00', 7200), abbreviation: 'CEST', dst: true),
      Timezone(RawOffset('+01:00', 3600), abbreviation: 'CET', dst: false),
  ...
  static final Location _skopje = Location(
    'Europe/Skopje',
    [-2713915320, -905824800, -857257200, -844556400, -828226800, -812502000, -796777200, -788922000, -777942000, -766623600, 407199600, 417574800, 433299600, 449024400, 465354000, 481078800, 496803600, 512528400, 528253200, 543978000, 559702800, 575427600, 591152400, 606877200, 622602000, 638326800, 654656400, 670381200, 686106000, 701830800, 717555600, 733280400, 749005200, 764730000, 780454800, 796179600, 811904400, 828234000, 846378000, 859683600, 877827600, 891133200, 909277200, 922582800, 941331600, 954032400, 972781200, 985482000, 1004230800, 1017536400, 1035680400, 1048986000, 1067130000, 1080435600, 1099184400, 1111885200, 1130634000, 1143334800, 1162083600, 1174784400, 1193533200, 1206838800, 1224982800, 1238288400, 1256432400, 1269738000, 1288486800, 1301187600, 1319936400, 1332637200, 1351386000, 1364691600, 1382835600, 1396141200, 1414285200, 1427590800, 1445734800, 1459040400, 1477789200, 1490490000, 1509238800, 1521939600, 1540688400, 1553994000, 1572138000, 1585443600, 1603587600, 1616893200, 1635642000, 1648342800, 1667091600, 1679792400, 1698541200, 1711846800, 1729990800, 1743296400, 1761440400, 1774746000, 1792890000, 1806195600, 1824944400, 1837645200, 1856394000, 1869094800, 1887843600, 1901149200, 1919293200, 1932598800, 1950742800, 1964048400, 1982797200, 1995498000, 2014246800, 2026947600, 2045696400, 2058397200, 2077146000, 2090451600, 2108595600, 2121901200, 2140045200],
    const [
      Timezone(RawOffset('+01:00', 3600), abbreviation: 'CET', dst: false),
  ...
  static final Location _sofia = Location(
    'Europe/Sofia',
  ...
  static final Location _stockholm = Location(
    'Europe/Stockholm',
    [-2422054408, -1693706400, -1680483600, -1663455600, -1650150000, -1632006000, -1618700400, -938905200, -857257200, -844556400, -828226800, -812502000, -796777200, -781052400, -776563200, -765936000, -761180400, -757386000, -748479600, -733273200, -717631200, -714610800, -710380800, -701910000, -684975600, -670460400, -654130800, -639010800, 315529200, 323830800, 338950800, 354675600, 370400400, 386125200, 401850000, 417574800, 433299600, 449024400, 465354000, 481078800, 496803600, 512528400, 528253200, 543978000, 559702800, 575427600, 591152400, 606877200, 622602000, 638326800, 654656400, 670381200, 686106000, 701830800, 717555600, 733280400, 749005200, 764730000, 780454800, 796179600, 811904400, 828234000, 846378000, 859683600, 877827600, 891133200, 909277200, 922582800, 941331600, 954032400, 972781200, 985482000, 1004230800, 1017536400, 1035680400, 1048986000, 1067130000, 1080435600, 1099184400, 1111885200, 1130634000, 1143334800, 1162083600, 1174784400, 1193533200, 1206838800, 1224982800, 1238288400, 1256432400, 1269738000, 1288486800, 1301187600, 1319936400, 1332637200, 1351386000, 1364691600, 1382835600, 1396141200, 1414285200, 1427590800, 1445734800, 1459040400, 1477789200, 1490490000, 1509238800, 1521939600, 1540688400, 1553994000, 1572138000, 1585443600, 1603587600, 1616893200, 1635642000, 1648342800, 1667091600, 1679792400, 1698541200, 1711846800, 1729990800, 1743296400, 1761440400, 1774746000, 1792890000, 1806195600, 1824944400, 1837645200, 1856394000, 1869094800, 1887843600, 1901149200, 1919293200, 1932598800, 1950742800, 1964048400, 1982797200, 1995498000, 2014246800, 2026947600, 2045696400, 2058397200, 2077146000, 2090451600, 2108595600, 2121901200, 2140045200],
    const [
      Timezone(RawOffset('+01:00', 3600), abbreviation: 'CET', dst: false),
  ...
  static final Location _tallinn = Location(
    'Europe/Tallinn',
    ...
    const [
      Timezone(RawOffset('+01:39', 5940), abbreviation: 'TMT', dst: false),
      Timezone(RawOffset('+01:00', 3600), abbreviation: 'CET', dst: false),
      Timezone(RawOffset('+02:00', 7200), abbreviation: 'CEST', dst: true),
      Timezone(RawOffset('+01:00', 3600), abbreviation: 'CET', dst: false),
      Timezone(RawOffset('+01:39', 5940), abbreviation: 'TMT', dst: false),
  ...
  static final Location _tirane = Location(
    'Europe/Tirane',
  ...
  static final Location _tiraspol = Location(
    'Europe/Tiraspol',
    [-2840147720, -1637114100, -1213148664, -1187056800, -1175479200, -1159754400, -1144029600, -1127700000, -1111975200, -1096250400, -1080525600, -1064800800, -1049076000, -1033351200, -1017626400, -1001901600, -986176800, -970452000, -954727200, -927165600, -898138800, -857257200, -844556400, -828226800, -812502000, -800157600, 354920400, 370728000, 386456400, 402264000, 417992400, 433800000, 449614800, 465346800, 481071600, 496796400, 512521200, 528246000, 543970800, 559695600, 575420400, 591145200, 606870000, 622594800, 638319600, 641944800, 654652800, 670377600, 686102400, 694216800, 701820000, 717541200, 733269600, 748990800, 764719200, 780440400, 796168800, 811890000, 828223200, 846363600, 859680000, 877824000, 891129600, 909273600, 922579200, 941328000, 954028800, 972777600, 985478400, 1004227200, 1017532800, 1035676800, 1048982400, 1067126400, 1080432000, 1099180800, 1111881600, 1130630400, 1143331200, 1162080000, 1174780800, 1193529600, 1206835200, 1224979200, 1238284800, 1256428800, 1269734400, 1288483200, 1301184000, 1319932800, 1332633600, 1351382400, 1364688000, 1382832000, 1396137600, 1414281600, 1427587200, 1445731200, 1459036800, 1477785600, 1490486400, 1509235200, 1521936000, 1540684800, 1553990400, 1572134400, 1585440000, 1603584000, 1616889600, 1635638400, 1648339200, 1667088000, 1679788800, 1698537600, 1711843200, 1729987200, 1743292800, 1761436800, 1774742400, 1792886400, 1806192000, 1824940800, 1837641600, 1856390400, 1869091200, 1887840000, 1901145600, 1919289600, 1932595200, 1950739200, 1964044800, 1982793600, 1995494400, 2014243200, 2026944000, 2045692800, 2058393600, 2077142400, 2090448000, 2108592000, 2121897600, 2140041600],
    const [
      Timezone(RawOffset('+01:55', 6900), abbreviation: 'CMT', dst: false),
  ...
  static final Location _ulyanovsk = Location(
    'Europe/Ulyanovsk',
    [-1593820800, -1247540400, 354916800, 370724400, 386452800, 402260400, 417988800, 433796400, 449611200, 465343200, 481068000, 496792800, 512517600, 528242400, 543967200, 559692000, 575416800, 591141600, 606866400, 622594800, 638319600, 654649200, 670374000, 686102400, 695779200, 701823600, 717548400, 733273200, 748998000, 764722800, 780447600, 796172400, 811897200, 828226800, 846370800, 859676400, 877820400, 891126000, 909270000, 922575600, 941324400, 954025200, 972774000, 985474800, 1004223600, 1017529200, 1035673200, 1048978800, 1067122800, 1080428400, 1099177200, 1111878000, 1130626800, 1143327600, 1162076400, 1174777200, 1193526000, 1206831600, 1224975600, 1238281200, 1256425200, 1269730800, 1288479600, 1301180400, 1414274400, 1459033200],
    const [
      Timezone(RawOffset('+03:00', 10800), abbreviation: '+03', dst: false),
      ...
      Timezone(RawOffset('+03:00', 10800), abbreviation: '+03', dst: false),
      Timezone(RawOffset('+03:00', 10800), abbreviation: '+03', dst: true),
      Timezone(RawOffset('+02:00', 7200), abbreviation: '+02', dst: false),
      Timezone(RawOffset('+03:00', 10800), abbreviation: '+03', dst: false),
      Timezone(RawOffset('+04:00', 14400), abbreviation: '+04', dst: true),
      Timezone(RawOffset('+03:00', 10800), abbreviation: '+03', dst: false),
      Timezone(RawOffset('+04:00', 14400), abbreviation: '+04', dst: true),
  ...
  static final Location _uzhgorod = Location(
    'Europe/Uzhgorod',
    [-2840148124, -1441159324, -1247536800, -892522800, -857257200, -844556400, -828226800, -825382800, 354920400, 370728000, 386456400, 402264000, 417992400, 433800000, 449614800, 465346800, 481071600, 496796400, 512521200, 528246000, 543970800, 559695600, 575420400, 591145200, 606870000, 622594800, 638319600, 646783200, 686102400, 701827200, 717552000, 733276800, 749001600, 764726400, 780451200, 796176000, 811900800, 828230400, 831934800, 846378000, 859683600, 877827600, 891133200, 909277200, 922582800, 941331600, 954032400, 972781200, 985482000, 1004230800, 1017536400, 1035680400, 1048986000, 1067130000, 1080435600, 1099184400, 1111885200, 1130634000, 1143334800, 1162083600, 1174784400, 1193533200, 1206838800, 1224982800, 1238288400, 1256432400, 1269738000, 1288486800, 1301187600, 1319936400, 1332637200, 1351386000, 1364691600, 1382835600, 1396141200, 1414285200, 1427590800, 1445734800, 1459040400, 1477789200, 1490490000, 1509238800, 1521939600, 1540688400, 1553994000, 1572138000, 1585443600, 1603587600, 1616893200, 1635642000, 1648342800, 1667091600, 1679792400, 1698541200, 1711846800, 1729990800, 1743296400, 1761440400, 1774746000, 1792890000, 1806195600, 1824944400, 1837645200, 1856394000, 1869094800, 1887843600, 1901149200, 1919293200, 1932598800, 1950742800, 1964048400, 1982797200, 1995498000, 2014246800, 2026947600, 2045696400, 2058397200, 2077146000, 2090451600, 2108595600, 2121901200, 2140045200],
    const [
      Timezone(RawOffset('+02:02:04', 7324), abbreviation: 'KMT', dst: false),
  ...
  static final Location _vaduz = Location(
    'Europe/Vaduz',
    [-3675198848, -2385246586, -904435200, -891129600, -872985600, -859680000, 354675600, 370400400, 386125200, 401850000, 417574800, 433299600, 449024400, 465354000, 481078800, 496803600, 512528400, 528253200, 543978000, 559702800, 575427600, 591152400, 606877200, 622602000, 638326800, 654656400, 670381200, 686106000, 701830800, 717555600, 733280400, 749005200, 764730000, 780454800, 796179600, 811904400, 828234000, 846378000, 859683600, 877827600, 891133200, 909277200, 922582800, 941331600, 954032400, 972781200, 985482000, 1004230800, 1017536400, 1035680400, 1048986000, 1067130000, 1080435600, 1099184400, 1111885200, 1130634000, 1143334800, 1162083600, 1174784400, 1193533200, 1206838800, 1224982800, 1238288400, 1256432400, 1269738000, 1288486800, 1301187600, 1319936400, 1332637200, 1351386000, 1364691600, 1382835600, 1396141200, 1414285200, 1427590800, 1445734800, 1459040400, 1477789200, 1490490000, 1509238800, 1521939600, 1540688400, 1553994000, 1572138000, 1585443600, 1603587600, 1616893200, 1635642000, 1648342800, 1667091600, 1679792400, 1698541200, 1711846800, 1729990800, 1743296400, 1761440400, 1774746000, 1792890000, 1806195600, 1824944400, 1837645200, 1856394000, 1869094800, 1887843600, 1901149200, 1919293200, 1932598800, 1950742800, 1964048400, 1982797200, 1995498000, 2014246800, 2026947600, 2045696400, 2058397200, 2077146000, 2090451600, 2108595600, 2121901200, 2140045200],
    const [
      Timezone(RawOffset('+00:29:46', 1786), abbreviation: 'BMT', dst: false),
  ...
  static final Location _vatican = Location(
    'Europe/Vatican',
    [-3252098996, -2403565200, -1690765200, -1680487200, -1664758800, -1648951200, -1635123600, -1616896800, -1604278800, -1585533600, -1571014800, -1555293600, -932432400, -857257200, -844556400, -830311200, -828226800, -812502000, -807156000, -798073200, -781052400, -766717200, -750898800, -733359600, -719456400, -701917200, -689209200, -670460400, -114051600, -103168800, -81997200, -71715600, -50547600, -40266000, -18493200, -8211600, 12956400, 23238000, 43801200, 54687600, 75855600, 86742000, 107910000, 118191600, 138754800, 149641200, 170809200, 181090800, 202258800, 212540400, 233103600, 243990000, 265158000, 276044400, 296607600, 307494000, 315529200, 323830800, 338950800, 354675600, 370400400, 386125200, 401850000, 417574800, 433299600, 449024400, 465354000, 481078800, 496803600, 512528400, 528253200, 543978000, 559702800, 575427600, 591152400, 606877200, 622602000, 638326800, 654656400, 670381200, 686106000, 701830800, 717555600, 733280400, 749005200, 764730000, 780454800, 796179600, 811904400, 828234000, 846378000, 859683600, 877827600, 891133200, 909277200, 922582800, 941331600, 954032400, 972781200, 985482000, 1004230800, 1017536400, 1035680400, 1048986000, 1067130000, 1080435600, 1099184400, 1111885200, 1130634000, 1143334800, 1162083600, 1174784400, 1193533200, 1206838800, 1224982800, 1238288400, 1256432400, 1269738000, 1288486800, 1301187600, 1319936400, 1332637200, 1351386000, 1364691600, 1382835600, 1396141200, 1414285200, 1427590800, 1445734800, 1459040400, 1477789200, 1490490000, 1509238800, 1521939600, 1540688400, 1553994000, 1572138000, 1585443600, 1603587600, 1616893200, 1635642000, 1648342800, 1667091600, 1679792400, 1698541200, 1711846800, 1729990800, 1743296400, 1761440400, 1774746000, 1792890000, 1806195600, 1824944400, 1837645200, 1856394000, 1869094800, 1887843600, 1901149200, 1919293200, 1932598800, 1950742800, 1964048400, 1982797200, 1995498000, 2014246800, 2026947600, 2045696400, 2058397200, 2077146000, 2090451600, 2108595600, 2121901200, 2140045200],
    const [
      Timezone(RawOffset('+00:49:56', 2996), abbreviation: 'RMT', dst: false),
  ...
  static final Location _vienna = Location(
    'Europe/Vienna',
  ...
  static final Location _vilnius = Location(
    'Europe/Vilnius',
    ...
    const [
      Timezone(RawOffset('+01:24', 5040), abbreviation: 'WMT', dst: false),
      Timezone(RawOffset('+01:35:36', 5736), abbreviation: 'KMT', dst: false),
      Timezone(RawOffset('+01:00', 3600), abbreviation: 'CET', dst: false),
      Timezone(RawOffset('+02:00', 7200), abbreviation: 'EET', dst: false),
      Timezone(RawOffset('+01:00', 3600), abbreviation: 'CET', dst: false),
      Timezone(RawOffset('+03:00', 10800), abbreviation: 'MSK', dst: false),
  ...
  static final Location _volgograd = Location(
    'Europe/Volgograd',
  ...
  static final Location _warsaw = Location(
    'Europe/Warsaw',
  ...
  static final Location _zagreb = Location(
    'Europe/Zagreb',
    [-2713915320, -905824800, -857257200, -844556400, -828226800, -812502000, -796777200, -788922000, -777942000, -766623600, 407199600, 417574800, 433299600, 449024400, 465354000, 481078800, 496803600, 512528400, 528253200, 543978000, 559702800, 575427600, 591152400, 606877200, 622602000, 638326800, 654656400, 670381200, 686106000, 701830800, 717555600, 733280400, 749005200, 764730000, 780454800, 796179600, 811904400, 828234000, 846378000, 859683600, 877827600, 891133200, 909277200, 922582800, 941331600, 954032400, 972781200, 985482000, 1004230800, 1017536400, 1035680400, 1048986000, 1067130000, 1080435600, 1099184400, 1111885200, 1130634000, 1143334800, 1162083600, 1174784400, 1193533200, 1206838800, 1224982800, 1238288400, 1256432400, 1269738000, 1288486800, 1301187600, 1319936400, 1332637200, 1351386000, 1364691600, 1382835600, 1396141200, 1414285200, 1427590800, 1445734800, 1459040400, 1477789200, 1490490000, 1509238800, 1521939600, 1540688400, 1553994000, 1572138000, 1585443600, 1603587600, 1616893200, 1635642000, 1648342800, 1667091600, 1679792400, 1698541200, 1711846800, 1729990800, 1743296400, 1761440400, 1774746000, 1792890000, 1806195600, 1824944400, 1837645200, 1856394000, 1869094800, 1887843600, 1901149200, 1919293200, 1932598800, 1950742800, 1964048400, 1982797200, 1995498000, 2014246800, 2026947600, 2045696400, 2058397200, 2077146000, 2090451600, 2108595600, 2121901200, 2140045200],
    const [
      Timezone(RawOffset('+01:00', 3600), abbreviation: 'CET', dst: false),
  ...
  static final Location _zaporozhye = Location(
    'Europe/Zaporozhye',
    [-2840148124, -1441159324, -1247536800, -892522800, -857257200, -844556400, -828226800, -825382800, 354920400, 370728000, 386456400, 402264000, 417992400, 433800000, 449614800, 465346800, 481071600, 496796400, 512521200, 528246000, 543970800, 559695600, 575420400, 591145200, 606870000, 622594800, 638319600, 646783200, 686102400, 701827200, 717552000, 733276800, 749001600, 764726400, 780451200, 796176000, 811900800, 828230400, 831934800, 846378000, 859683600, 877827600, 891133200, 909277200, 922582800, 941331600, 954032400, 972781200, 985482000, 1004230800, 1017536400, 1035680400, 1048986000, 1067130000, 1080435600, 1099184400, 1111885200, 1130634000, 1143334800, 1162083600, 1174784400, 1193533200, 1206838800, 1224982800, 1238288400, 1256432400, 1269738000, 1288486800, 1301187600, 1319936400, 1332637200, 1351386000, 1364691600, 1382835600, 1396141200, 1414285200, 1427590800, 1445734800, 1459040400, 1477789200, 1490490000, 1509238800, 1521939600, 1540688400, 1553994000, 1572138000, 1585443600, 1603587600, 1616893200, 1635642000, 1648342800, 1667091600, 1679792400, 1698541200, 1711846800, 1729990800, 1743296400, 1761440400, 1774746000, 1792890000, 1806195600, 1824944400, 1837645200, 1856394000, 1869094800, 1887843600, 1901149200, 1919293200, 1932598800, 1950742800, 1964048400, 1982797200, 1995498000, 2014246800, 2026947600, 2045696400, 2058397200, 2077146000, 2090451600, 2108595600, 2121901200, 2140045200],
    const [
      Timezone(RawOffset('+02:02:04', 7324), abbreviation: 'KMT', dst: false),
  ...
  static final Location _zurich = Location(
    'Europe/Zurich',
    [-3675198848, -2385246586, -904435200, -891129600, -872985600, -859680000, 354675600, 370400400, 386125200, 401850000, 417574800, 433299600, 449024400, 465354000, 481078800, 496803600, 512528400, 528253200, 543978000, 559702800, 575427600, 591152400, 606877200, 622602000, 638326800, 654656400, 670381200, 686106000, 701830800, 717555600, 733280400, 749005200, 764730000, 780454800, 796179600, 811904400, 828234000, 846378000, 859683600, 877827600, 891133200, 909277200, 922582800, 941331600, 954032400, 972781200, 985482000, 1004230800, 1017536400, 1035680400, 1048986000, 1067130000, 1080435600, 1099184400, 1111885200, 1130634000, 1143334800, 1162083600, 1174784400, 1193533200, 1206838800, 1224982800, 1238288400, 1256432400, 1269738000, 1288486800, 1301187600, 1319936400, 1332637200, 1351386000, 1364691600, 1382835600, 1396141200, 1414285200, 1427590800, 1445734800, 1459040400, 1477789200, 1490490000, 1509238800, 1521939600, 1540688400, 1553994000, 1572138000, 1585443600, 1603587600, 1616893200, 1635642000, 1648342800, 1667091600, 1679792400, 1698541200, 1711846800, 1729990800, 1743296400, 1761440400, 1774746000, 1792890000, 1806195600, 1824944400, 1837645200, 1856394000, 1869094800, 1887843600, 1901149200, 1919293200, 1932598800, 1950742800, 1964048400, 1982797200, 1995498000, 2014246800, 2026947600, 2045696400, 2058397200, 2077146000, 2090451600, 2108595600, 2121901200, 2140045200],
    const [
      Timezone(RawOffset('+00:29:46', 1786), abbreviation: 'BMT', dst: false),
