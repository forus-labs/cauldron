...
extension Minutes on Never {
  ...
  @useResult static int from(int hour, [int minute = 0]) => hour * Duration.minutesPerHour + minute;
}
...
extension Seconds on Never {
  ...
  @useResult static int from(int hour, [int minute = 0, int second = 0]) =>
...
extension Milliseconds on Never {
  ...
  @useResult static int from(int hour, [int minute = 0, int second = 0, int millisecond = 0]) =>
...
extension Microseconds on Never {
  ...
  @useResult static int from(int hour, [int minute = 0, int second = 0, int millisecond = 0, int microsecond = 0]) =>
