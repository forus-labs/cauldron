...
class Time with Relational<Time> implements Comparable<Time> {
  ...
  @Between(0, 24) final int hour;
  @Between(0, 60) final int minute;
  @Between(0, 60) final int second;
  @Between(0, 1000) final int millisecond;
  @Between(0, 1000) final int microsecond;
  int _inMicroseconds;
