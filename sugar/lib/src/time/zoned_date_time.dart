...
final class ZonedDateTime extends DateTimeBase {
  ...
  factory ZonedDateTime.now([Timezone? timezone]) {
    ...
    return ZonedDateTime._(timezone, now);
  }
  ...
  ZonedDateTime._(this.timezone, this.epochMicroseconds)
      : super._(
          DateTime.fromMicrosecondsSinceEpoch(
              epochMicroseconds +
                  timezone.offset(at: epochMicroseconds).inMicroseconds,
              isUtc: true),
        );
  ...
  String toString() => _string ??=
      '${_native.toDateString()}T${_native.toTimeString()}$offset[${timezone.name}]';
  ...
  /// The timezone offset at this date-time.
  @useResult
  Offset get offset => timezone.offset(at: epochMicroseconds);
}
