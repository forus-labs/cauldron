...
void main() {
  ...
  group('intersection(...)', () {
    group('max', () {
      test('closed open lesser greater', () => expect(const Max.closed(3).intersection(const Max.open(4)), const Max.closed(3)));

      test('open closed lesser greater', () => expect(const Max.open(3).intersection(const Max.closed(4)), const Max.open(3)));

      test('both open lesser greater', () => expect(const Max.open(3).intersection(const Max.open(4)), const Max.open(3)));

      test('both closed lesser greater', () => expect(const Max.closed(3).intersection(const Max.closed(4)), const Max.closed(3)));


      test('closed open greater lesser', () => expect(const Max.closed(4).intersection(const Max.open(3)), const Max.open(3)));

      test('open closed greater lesser', () => expect(const Max.open(4).intersection(const Max.closed(3)), const Max.closed(3)));

      test('both open greater lesser', () => expect(const Max.open(4).intersection(const Max.open(3)), const Max.open(3)));

      test('both closed greater lesser', () => expect(const Max.closed(4).intersection(const Max.closed(3)), const Max.closed(3)));
      ...
      test('both closed same', () => expect(const Max.closed(4).intersection(const Max.closed(4)), const Max.closed(4)));
    });

    test('interval intersection', () => expect(const Max.closed(5).intersection(Interval.open(4, 6)), Interval.openClosed(4, 5)));
