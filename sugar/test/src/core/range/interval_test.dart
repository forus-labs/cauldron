...
void main() {
  group('Interval', () {
    ...
    group('iterate(...)', () {
      test(
        'closed-open ascending, increasing',
        () => expect(Interval.closedOpen(1, 5).iterate(by: (e) => e + 1), [1, 2, 3, 4]),
      );

      test('closed-open ascending, decreasing', () => expect(Interval.closedOpen(1, 5).iterate(by: (e) => e - 1), [1]));

      test(
        'closed-open descending, decreasing',
        () => expect(Interval.closedOpen(1, 5).iterate(by: (e) => e - 1, ascending: false), [4, 3, 2, 1]),
      );

      test(
        'closed-open descending, increasing',
        () => expect(Interval.closedOpen(1, 5).iterate(by: (e) => e + 1, ascending: false), []),
      );

      test(
        'closed ascending, increasing',
        () => expect(Interval.closed(1, 5).iterate(by: (e) => e + 1), [1, 2, 3, 4, 5]),
      );

      test('closed ascending, decreasing', () => expect(Interval.closed(1, 5).iterate(by: (e) => e - 1), [1]));

      test(
        'closed descending, decreasing',
        () => expect(Interval.closed(1, 5).iterate(by: (e) => e - 1, ascending: false), [5, 4, 3, 2, 1]),
      );

      test(
        'closed descending, increasing',
        () => expect(Interval.closed(1, 5).iterate(by: (e) => e + 1, ascending: false), [5]),
      );

      test(
        'open-closed ascending, increasing',
        () => expect(Interval.openClosed(1, 5).iterate(by: (e) => e + 1), [2, 3, 4, 5]),
      );

      test('open-closed ascending, decreasing', () => expect(Interval.openClosed(1, 5).iterate(by: (e) => e - 1), []));

      test(
        'open-closed descending, decreasing',
        () => expect(Interval.openClosed(1, 5).iterate(by: (e) => e - 1, ascending: false), [5, 4, 3, 2]),
      );

      test(
        'open-closed descending, increasing',
        () => expect(Interval.openClosed(1, 5).iterate(by: (e) => e + 1, ascending: false), [5]),
      );
      ...
      test(
        'open descending, decreasing',
        () => expect(Interval.open(1, 5).iterate(by: (e) => e - 1, ascending: false), [4, 3, 2]),
      );

      test(
        'open descending, increasing',
        () => expect(Interval.open(1, 5).iterate(by: (e) => e + 1, ascending: false), []),
      );
    });
    ...
    group('intersection(...)', () {
      test(
        'min intersection',
        () => expect(Interval.closed(3, 5).intersection(const Min.open(4)), Interval.openClosed(4, 5)),
      );
      ...
      test(
        ...
        () => expect(Interval.closed(3, 5).intersection(Interval.open(4, 6)), Interval.openClosed(4, 5)),
      );
      ...
      test(
        'max intersection',
        () => expect(Interval.closed(3, 5).intersection(const Max.open(4)), Interval.closedOpen(3, 4)),
      );
      ...
      test(
        'all intersection',
        () => expect(Interval.closed(3, 5).intersection(const Unbound()), Interval.closed(3, 5)),
      );
    });
    ...
    group('besides(...)', () {
      ...
      test(
        'open besides greater closed interval',
        () => expect(Interval.open(1, 3).besides(Interval.closed(3, 5)), true),
      );

      test(
        'open not besides greater closed interval',
        () => expect(Interval.open(1, 3).besides(Interval.closed(5, 7)), false),
      );

      test(
        'open not besides greater open interval',
        () => expect(Interval.open(1, 3).besides(Interval.open(3, 7)), false),
      );

      test(
        'open besides lesser closed interval',
        () => expect(Interval.open(1, 3).besides(Interval.closed(0, 1)), true),
      );

      test(
        'open not besides lesser closed interval',
        () => expect(Interval.open(1, 3).besides(Interval.closed(-2, 0)), false),
      );

      test(
        'open not besides lesser open interval',
        () => expect(Interval.open(1, 3).besides(Interval.open(-2, 1)), false),
      );

      test(
        'closed besides greater open interval',
        () => expect(Interval.closed(1, 3).besides(Interval.open(3, 5)), true),
      );

      test(
        'closed not besides greater open interval',
        () => expect(Interval.closed(1, 3).besides(Interval.open(5, 7)), false),
      );

      test(
        'closed not besides greater closed interval',
        () => expect(Interval.closed(1, 3).besides(Interval.closed(3, 7)), false),
      );

      test(
        'closed besides lesser open interval',
        () => expect(Interval.closed(1, 3).besides(Interval.open(0, 1)), true),
      );

      test(
        'closed not besides lesser open interval',
        () => expect(Interval.closed(1, 3).besides(Interval.open(-2, 0)), false),
      );

      test(
        'closed not besides lesser closed interval',
        () => expect(Interval.closed(1, 3).besides(Interval.closed(-2, 1)), false),
      );
    ...
    group('encloses(...)', () {
      ...
      test(
        'partially enclose lesser range',
        () => expect(Interval.closed(1, 5).encloses(Interval.closed(-4, 2)), false),
      );
      ...
      test(
        'partially enclose lesser range',
        () => expect(Interval.closed(1, 5).encloses(Interval.closed(3, 7)), false),
      );
    ...
    for (final interval in [Interval.closedOpen(1, 1), Interval.openClosed(1, 1)]) {
      test('empty', () => expect(interval.empty, true));
    }

    for (final interval in [Interval.closedOpen(1, 3), Interval.open(1, 2), Interval.closed(1, 1)]) {
  ...
  group('Gaps', () {
    group('minMax(...)', () {
      test(
        'open closed gap',
        () => expect(Gaps.minMax(const Min.open(3), const Max.closed(1)), Interval.openClosed(1, 3)),
      );

      test(
        'closed open gap',
        () => expect(Gaps.minMax(const Min.closed(3), const Max.open(1)), Interval.closedOpen(1, 3)),
      );
    ...
    group('minInterval(...)', () {
      test(
        'open closed gap',
        () => expect(Gaps.minInterval(const Min.open(3), Interval.closed(-1, 1)), Interval.openClosed(1, 3)),
      );

      test(
        'closed open gap',
        () => expect(Gaps.minInterval(const Min.closed(3), Interval.open(-1, 1)), Interval.closedOpen(1, 3)),
      );
    ...
    group('maxInterval(...)', () {
      test(
        'open closed gap',
        () => expect(Gaps.maxInterval(const Max.closed(1), Interval.open(3, 5)), Interval.openClosed(1, 3)),
      );

      test(
        'closed open gap',
        () => expect(Gaps.maxInterval(const Max.open(1), Interval.closed(3, 5)), Interval.closedOpen(1, 3)),
      );
    ...
    group('intervalInterval(...)', () {
      group('lower greater', () {
        test(
          'open closed',
          () => expect(Gaps.intervalInterval(Interval.closed(1, 3), Interval.open(5, 7)), Interval.openClosed(3, 5)),
        );

        test(
          'closed open',
          () => expect(Gaps.intervalInterval(Interval.open(1, 3), Interval.closed(5, 7)), Interval.closedOpen(3, 5)),
        );

        test('no gap', () => expect(Gaps.intervalInterval(Interval.open(1, 6), Interval.closed(5, 7)), null));

        test(
          'touching, both closed',
          () => expect(Gaps.intervalInterval(Interval.closed(1, 3), Interval.closed(3, 5)), null),
        );

        test(
          'touching, both open',
          () => expect(Gaps.intervalInterval(Interval.open(1, 3), Interval.open(3, 5)), Interval.closed(3, 3)),
        );

        test(
          'touching, open closed',
          () => expect(Gaps.intervalInterval(Interval.open(1, 3), Interval.closed(3, 5)), Interval.closedOpen(3, 3)),
        );

        test(
          'touching, closed open',
          () => expect(Gaps.intervalInterval(Interval.closed(1, 3), Interval.open(3, 5)), Interval.openClosed(3, 3)),
        );
      });
      ...
      group('greater lower', () {
        test(
          'open closed gap',
          () => expect(Gaps.intervalInterval(Interval.open(5, 7), Interval.closed(1, 3)), Interval.openClosed(3, 5)),
        );

        test(
          'closed open gap',
          () => expect(Gaps.intervalInterval(Interval.closed(5, 7), Interval.open(1, 3)), Interval.closedOpen(3, 5)),
        );
        ...
        test(
          'touching, both closed',
          () => expect(Gaps.intervalInterval(Interval.closed(3, 5), Interval.closed(1, 3)), null),
        );

        test(
          'touching, both open',
          () => expect(Gaps.intervalInterval(Interval.open(3, 5), Interval.open(1, 3)), Interval.closed(3, 3)),
        );

        test(
          'touching, open closed',
          () => expect(Gaps.intervalInterval(Interval.open(3, 5), Interval.closed(1, 3)), Interval.openClosed(3, 3)),
        );

        test(
          'touching, closed open',
          () => expect(Gaps.intervalInterval(Interval.closed(3, 5), Interval.open(1, 3)), Interval.closedOpen(3, 3)),
        );
      });
    });
  });
  ...
  group('Intersections', () {
    group('minMax(...)', () {
      test(
        'open closed intersection',
        () => expect(Intersections.minMax(const Min.open(1), const Max.closed(3)), Interval.openClosed(1, 3)),
      );

      test(
        'closed open intersection',
        () => expect(Intersections.minMax(const Min.closed(1), const Max.open(3)), Interval.closedOpen(1, 3)),
      );
    ...
    group('minInterval(...)', () {
      test(
        'open closed intersection',
        () => expect(Intersections.minInterval(const Min.open(1), Interval.closed(-1, 3)), Interval.openClosed(1, 3)),
      );

      test(
        'closed open intersection',
        () => expect(Intersections.minInterval(const Min.closed(1), Interval.open(-1, 3)), Interval.closedOpen(1, 3)),
      );
    ...
    group('maxInterval(...)', () {
      test(
        'open closed intersection',
        () => expect(Intersections.maxInterval(const Max.closed(3), Interval.open(1, 5)), Interval.openClosed(1, 3)),
      );

      test(
        'closed open intersection',
        () => expect(Intersections.maxInterval(const Max.open(3), Interval.closed(1, 5)), Interval.closedOpen(1, 3)),
      );
    ...
    group('intervalInterval(...)', () {
      group('lower greater', () {
        test(
          'open closed',
          () => expect(
            Intersections.intervalInterval(Interval.closed(1, 5), Interval.open(3, 7)),
            Interval.openClosed(3, 5),
          ),
        );
        ...
        test(
          'closed open',
          () => expect(
            Intersections.intervalInterval(Interval.open(1, 5), Interval.closed(3, 7)),
        ...
        test(
          'touching, both closed',
          () => expect(
            Intersections.intervalInterval(Interval.closed(1, 3), Interval.closed(3, 5)),
            Interval.closed(3, 3),
          ),
        );
        ...
        test(
          'touching, both open',
          () => expect(Intersections.intervalInterval(Interval.open(1, 3), Interval.open(3, 5)), null),
        );

        test(
          'touching, open closed',
          () => expect(Intersections.intervalInterval(Interval.open(1, 3), Interval.closed(3, 5)), null),
        );

        test(
          'touching, closed open',
          () => expect(Intersections.intervalInterval(Interval.closed(1, 3), Interval.open(3, 5)), null),
        );
      });
      ...
      group('greater lower', () {
        test(
          'open closed gap',
          () => expect(
            Intersections.intervalInterval(Interval.open(3, 7), Interval.closed(1, 5)),
            Interval.openClosed(3, 5),
          ),
        );
        ...
        test(
          'closed open gap',
          () => expect(
            Intersections.intervalInterval(Interval.closed(3, 7), Interval.open(1, 5)),
            Interval.closedOpen(3, 5),
          ),
        );
        ...
        test(
          'touching, both closed',
          () => expect(
            Intersections.intervalInterval(Interval.closed(3, 5), Interval.closed(1, 3)),
            Interval.closed(3, 3),
          ),
        );
        ...
        test(
          'touching, both open',
          () => expect(Intersections.intervalInterval(Interval.open(3, 5), Interval.open(1, 3)), null),
        );

        test(
          'touching, open closed',
          () => expect(Intersections.intervalInterval(Interval.open(3, 5), Interval.closed(1, 3)), null),
        );

        test(
          'touching, closed open',
          () => expect(Intersections.intervalInterval(Interval.closed(3, 5), Interval.open(1, 3)), null),
        );
      });
    });
  });
