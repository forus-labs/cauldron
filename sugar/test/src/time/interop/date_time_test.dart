...
void main() {
  test(
      'fromDaysSinceEpoch(...)',
      () => expect(
          DateTimes.fromDaysSinceEpoch(10000), DateTime.utc(1997, 5, 19)));
  ...
  group('plus(...)', () {
    ...
    test(
        'nothing',
        () => expect(DateTime(1, 2, 3, 4, 5, 6, 7, 8).plus(),
  ...
  group('minus(...)', () {
    ...
    test(
        'nothing',
        () => expect(DateTime(1, 2, 3, 4, 5, 6, 7, 8).minus(),
            DateTime(1, 2, 3, 4, 5, 6, 7, 8)));
  });
  ...
  group('+', () {
    ...
    test(
        'nothing',
        () => expect(DateTime(1, 2, 3, 4, 5, 6, 7, 8) + const Period(),
            DateTime(1, 2, 3, 4, 5, 6, 7, 8)));
  });
  ...
  group('-', () {
    ...
    test(
        'nothing',
        () => expect(DateTime.utc(1, 2, 3, 4, 5, 6, 7, 8) - const Period(),
            DateTime.utc(1, 2, 3, 4, 5, 6, 7, 8)));
  });
  ...
  for (final (date, unit, truncated) in [
    ...
    (
      DateTime(1, 1, 1, 1, 1, 3, 2),
      TimeUnit.seconds,
      DateTime(1, 1, 1, 1, 1, 5)
    ),
    (
      DateTime(1, 1, 1, 1, 1, 7, 2),
      TimeUnit.seconds,
      DateTime(1, 1, 1, 1, 1, 5)
    ),
    (
      DateTime(1, 1, 1, 1, 1, 1, 3, 2),
      TimeUnit.milliseconds,
      DateTime(1, 1, 1, 1, 1, 1, 5)
    ),
    (
      DateTime(1, 1, 1, 1, 1, 1, 7, 2),
      TimeUnit.milliseconds,
      DateTime(1, 1, 1, 1, 1, 1, 5)
    ),
    (
      DateTime(1, 1, 1, 1, 1, 1, 1, 3),
      TimeUnit.microseconds,
      DateTime(1, 1, 1, 1, 1, 1, 1, 5)
    ),
    (
      DateTime(1, 1, 1, 1, 1, 1, 1, 7),
      TimeUnit.microseconds,
      DateTime(1, 1, 1, 1, 1, 1, 1, 5)
    ),
  ]) {
  ...
  for (final (date, unit, truncated) in [
    ...
    (
      DateTime(1, 1, 1, 1, 1, 2, 9),
      TimeUnit.seconds,
      DateTime(1, 1, 1, 1, 1, 5)
    ),
    (
      DateTime(1, 1, 1, 1, 1, 4, 9),
      TimeUnit.seconds,
      DateTime(1, 1, 1, 1, 1, 5)
    ),
    (
      DateTime(1, 1, 1, 1, 1, 1, 2, 9),
      TimeUnit.milliseconds,
      DateTime(1, 1, 1, 1, 1, 1, 5)
    ),
    (
      DateTime(1, 1, 1, 1, 1, 1, 4, 9),
      TimeUnit.milliseconds,
      DateTime(1, 1, 1, 1, 1, 1, 5)
    ),
    (
      DateTime(1, 1, 1, 1, 1, 1, 1, 2),
      TimeUnit.microseconds,
      DateTime(1, 1, 1, 1, 1, 1, 1, 5)
    ),
    (
      DateTime(1, 1, 1, 1, 1, 1, 1, 4),
      TimeUnit.microseconds,
      DateTime(1, 1, 1, 1, 1, 1, 1, 5)
    ),
  ]) {
  ...
  for (final (date, unit, truncated) in [
    ...
    (
      DateTime(1, 1, 1, 1, 1, 6, 2),
      TimeUnit.seconds,
      DateTime(1, 1, 1, 1, 1, 5)
    ),
    (
      DateTime(1, 1, 1, 1, 1, 9, 2),
      TimeUnit.seconds,
      DateTime(1, 1, 1, 1, 1, 5)
    ),
    (
      DateTime(1, 1, 1, 1, 1, 1, 6, 2),
      TimeUnit.milliseconds,
      DateTime(1, 1, 1, 1, 1, 1, 5)
    ),
    (
      DateTime(1, 1, 1, 1, 1, 1, 9, 2),
      TimeUnit.milliseconds,
      DateTime(1, 1, 1, 1, 1, 1, 5)
    ),
    (
      DateTime(1, 1, 1, 1, 1, 1, 1, 6),
      TimeUnit.microseconds,
      DateTime(1, 1, 1, 1, 1, 1, 1, 5)
    ),
    (
      DateTime(1, 1, 1, 1, 1, 1, 1, 9),
      TimeUnit.microseconds,
      DateTime(1, 1, 1, 1, 1, 1, 1, 5)
    ),
  ]) {
  ...
  group('toLocalDate', () {
    test(
        'local',
        () => expect(DateTime(2023, 10, 11, 12, 30).toLocalDate(),
            LocalDate(2023, 10, 11)));

    test(
        'utc',
        () => expect(DateTime.utc(2023, 10, 11, 12, 30).toLocalDate(),
            LocalDate(2023, 10, 11)));
  });
  ...
  group('toLocalTime()', () {
    test(
        'local',
        () => expect(
            DateTime(2023, 10, 11, 12, 30).toLocalTime(), LocalTime(12, 30)));

    test(
        'utc',
        () => expect(DateTime.utc(2023, 10, 11, 12, 30).toLocalTime(),
            LocalTime(12, 30)));
  });
  ...
  group('toLocalDateTime()', () {
    test(
        'local',
        () => expect(DateTime(2023, 10, 11, 12, 30).toLocalDateTime(),
            LocalDateTime(2023, 10, 11, 12, 30)));

    test(
        'utc',
        () => expect(DateTime.utc(2023, 10, 11, 12, 30).toLocalDateTime(),
            LocalDateTime(2023, 10, 11, 12, 30)));
  });
  ...
  group('toOffsetTime()', () {
    test('local', () {
      ...
      expect(
          date.toOffsetTime(),
          OffsetTime(
              Offset.fromMicroseconds(date.timeZoneOffset.inMicroseconds),
              12,
              30));
    });
  ...
  group('toZonedDateTime()', () {
    test('local', () {
      ...
      expect(
          ...
          ZonedDateTime.from(Timezone(defaultPlatformTimezoneProvider()), 2023,
              10, 11, 12, 30));
    });

    test('utc', () {
      final date = DateTime.utc(2023, 10, 11, 12, 30);
      expect(date.toZonedDateTime(),
          ZonedDateTime('Etc/UTC', 2023, 10, 11, 12, 30));
    });
  });

  group('toDateString()', () {
    test('pads year',
        () => expect(DateTime(0999, 12, 15, 1).toDateString(), '0999-12-15'));

    test('pads month',
        () => expect(DateTime(2023, 4, 15, 1).toDateString(), '2023-04-15'));

    test('pads day',
        () => expect(DateTime(2023, 12, 5, 1).toDateString(), '2023-12-05'));
  });
  ...
  group('weekOfYear', () {
    test('last week of previous year',
        () => expect(DateTime(2023).weekOfYear, 52));
    ...
    test('short year last week',
        () => expect(DateTime(2023, 12, 31).weekOfYear, 52));
  ...
  group('dayOfYear(...)', () {
    ...
    test('leap year before February',
        () => expect(DateTime(2020, 2, 20).dayOfYear, 51));

    test('leap year after February',
        () => expect(DateTime(2020, 3, 20).dayOfYear, 80));

    test('leap year last day',
        () => expect(DateTime(2020, 12, 31).dayOfYear, 366));
    ...
    test('non-leap year last day',
        () => expect(DateTime(2021, 12, 31).dayOfYear, 365));
  });
  ...
  group('firstDayOfWeek', () {
    test(
        'current date',
        () => expect(
            DateTime(2023, 5, 8, 1).firstDayOfWeek, DateTime(2023, 5, 8)));

    test(
        'last day of week',
        () => expect(
            DateTime(2023, 5, 14, 1).firstDayOfWeek, DateTime(2023, 5, 8)));

    test(
        'across months',
        () =>
            expect(DateTime(2023, 6, 2).firstDayOfWeek, DateTime(2023, 5, 29)));
  });
  ...
  group('lastDayOfWeek', () {
    test(
        'current date',
        () => expect(
            DateTime(2023, 5, 8, 1).lastDayOfWeek, DateTime(2023, 5, 14)));

    test(
        'last day of week',
        () => expect(
            DateTime(2023, 5, 14, 1).lastDayOfWeek, DateTime(2023, 5, 14)));

    test(
        'across months',
        () =>
            expect(DateTime(2023, 5, 29).lastDayOfWeek, DateTime(2023, 6, 4)));
  });
  ...
  group('firstDayOfMonth', () {
    test(
        'current date',
        () =>
            expect(DateTime(2023, 5, 1, 1).firstDayOfMonth, DateTime(2023, 5)));

    test('last day of the month',
        () => expect(DateTime(2023, 5, 31).firstDayOfMonth, DateTime(2023, 5)));
  });
  ...
  group('lastDayOfMonth', () {
    test(
        'current date',
        () => expect(
            DateTime(2023, 2, 28).lastDayOfMonth, DateTime(2023, 2, 28)));

    test('first day of the month',
        () => expect(DateTime(2023, 2).lastDayOfMonth, DateTime(2023, 2, 28)));

    test('leap year',
        () => expect(DateTime(2020, 2).lastDayOfMonth, DateTime(2020, 2, 29)));
  });
  ...
  test('daysSinceEpoch',
      () => expect(DateTime.utc(2023, 5, 2).daysSinceEpoch, 19479));

  test(
      'millisecondsSinceMidnight',
      () => expect(
          DateTime(2023, 5, 2, 1, 2, 3, 4, 5).millisecondsSinceMidnight,
          3723004));

  test(
      'microsecondsSinceMidnight',
      () => expect(
          DateTime(2023, 5, 2, 1, 2, 3, 4, 5).microsecondsSinceMidnight,
          3723004005));
}
