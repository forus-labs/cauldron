...
void main() {
  group('initial timezone', () {
    ...
    final span = timezone.span(at: DateTime.utc(1700).microsecondsSinceEpoch);

    test('abbreviation', () => expect(span.abbreviation, 'LMT'));

    test('start', () => expect(span.start, TimezoneSpan.range.min.value));

    test('end', () => expect(span.end, -2051202469000000));
  ...
  group('non-DST timezone span', () {
    ...
    final span = ZonedDateTime('America/Detroit', 2023, 12, 12, 4).span;

    test('abbreviation', () => expect(span.abbreviation, 'EST'));

    test('dst', () => expect(span.dst, false));

    test('offset', () => expect(span.offset, Offset(-5)));
  });

  group('DST timezone span', () {
    // https://www.timeanddate.com/time/change/usa/detroit?year=2023
    final span = ZonedDateTime('America/Detroit', 2023, 5, 12, 4).span;

    test('abbreviation', () => expect(span.abbreviation, 'EDT'));

    test('dst', () => expect(span.dst, true));
    ...
    group('America/Detroit DST (negative offset)', () {
      ...
      group('EST/EDT transition', () {
        test('2 months before transition', () {
          ...
          expect(datetime, ZonedDateTime.fromEpochMicroseconds(Timezone(detroit), datetime.epochMicroseconds));
          expect(datetime.toString(), '2023-01-12T04:00-05:00[America/Detroit]');
        });
        ...
        test('1 hour before transition', () {
          ...
          expect(datetime, ZonedDateTime.fromEpochMicroseconds(Timezone(detroit), datetime.epochMicroseconds));
          expect(datetime.toString(), '2023-03-12T01:00-05:00[America/Detroit]');
        });
        ...
        test('1 hour after transition', () {
          ...
          expect(datetime, ZonedDateTime.fromEpochMicroseconds(Timezone(detroit), datetime.epochMicroseconds));
          expect(datetime.toString(), '2023-03-12T04:00-04:00[America/Detroit]');
        });
        ...
        test('2 months after transition', () {
          ...
          expect(datetime, ZonedDateTime.fromEpochMicroseconds(Timezone(detroit), datetime.epochMicroseconds));
          expect(datetime.toString(), '2023-05-12T04:00-04:00[America/Detroit]');
        });
      });
      ...
      group('EST/EDT transition', () {
        test('2 months before transition', () {
          ...
          expect(datetime, ZonedDateTime.fromEpochMicroseconds(Timezone(detroit), datetime.epochMicroseconds));
          expect(datetime.toString(), '2023-09-05T01:00-04:00[America/Detroit]');
        });
        ...
        test('1 hour before transition', () {
          ...
          expect(datetime, ZonedDateTime.fromEpochMicroseconds(Timezone(detroit), datetime.epochMicroseconds));
          expect(datetime.toString(), '2023-11-05T00:00-04:00[America/Detroit]');
        });
        ...
        test('lower transition', () {
          ...
          expect(datetime, ZonedDateTime.fromEpochMicroseconds(Timezone(detroit), datetime.epochMicroseconds));
          expect(datetime.toString(), '2023-11-05T01:00-04:00[America/Detroit]');
        });
        ...
        test('upper transition', () {
          ...
          expect(datetime, ZonedDateTime.fromEpochMicroseconds(Timezone(detroit), datetime.epochMicroseconds));
          expect(datetime.toString(), '2023-11-05T02:00-05:00[America/Detroit]');
        });
        ...
        test('1 hour after transition', () {
          ...
          expect(datetime, ZonedDateTime.fromEpochMicroseconds(Timezone(detroit), datetime.epochMicroseconds));
          expect(datetime.toString(), '2023-11-05T03:00-05:00[America/Detroit]');
        });
        ...
        test('2 months after transition', () {
          ...
          expect(datetime, ZonedDateTime.fromEpochMicroseconds(Timezone(detroit), datetime.epochMicroseconds));
          expect(datetime.toString(), '2024-01-05T02:00-05:00[America/Detroit]');
        });
      });
    });
    ...
    group('Europe/Berlin DST (positive offset)', () {
      ...
      group('EST/EDT transition', () {
        test('2 months before transition', () {
          ...
          expect(datetime, ZonedDateTime.fromEpochMicroseconds(Timezone(berlin), datetime.epochMicroseconds));
